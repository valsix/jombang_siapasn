...
class Info_dispen_satker_json extends REST_Controller {
    ...
    function index_get() {
        ...
        if($reqToken == md5('valsixdispen'))
        {
            ...
            $set = new InfoKhusus;
            $aColumns = array("ID", "ID_PARENT", "NAMA", "NAMA_JABATAN", "ESELON_ID", "ESELON", "SATUAN_KERJA_INDUK", "MASA_BERLAKU_AWAL", "MASA_BERLAKU_AKHIR", "STATUS_NAMA");
            $statement= $statementsatuankerja;
            $set->selectByParamsSatker(array(), -1, -1, $statement);
            // echo $set->query;exit();
