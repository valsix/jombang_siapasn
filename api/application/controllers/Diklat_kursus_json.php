...
class Diklat_kursus_json extends REST_Controller {
	...
	function index_get() {
        ...
        $this->load->model('base/DiklatKursus');
        ...
        else
        {
            ...
            $aColumns = array("DIKLAT_KURSUS_ID","PEGAWAI_ID","TIPE_KURSUS_ID","TEMPAT","PENYELENGGARA","ANGKATAN","TAHUN","TANGGAL_MULAI","TANGGAL_SELESAI","NO_SERTIFIKAT","TANGGAL_SERTIFIKAT","JUMLAH_JAM","NAMA","REF_JENIS_KURSUS_ID","REF_JENIS_KURSUS_DATA","JENIS_KURSUS_NAMA","TIPE_DIKLAT_NAMA","REF_INSTANSI_ID","REF_INSTANSI_INFO","RUMPUN_ID","RUMPUN_NAMA","NILAI_REKAM_JEJAK","STATUS_LULUS","LAST_USER","LAST_DATE","LAST_LEVEL","STATUS", "TEMP_VALIDASI_ID", "TEMP_VALIDASI_HAPUS_ID", "VALIDASI", "VALIDATOR", "PERUBAHAN_DATA", "TIPE_PERUBAHAN_DATA", "TANGGAL_VALIDASI");
