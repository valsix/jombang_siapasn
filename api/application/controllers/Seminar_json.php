...
class Seminar_json extends REST_Controller {
	...
	function index_get() {
        ...
        {
            $set = new Seminar;
            $aColumns = array("SEMINAR_ID","PEGAWAI_ID","TEMPAT","PENYELENGGARA","TANGGAL_MULAI","TANGGAL_SELESAI","NO_PIAGAM","TANGGAL_PIAGAM","STATUS","NAMA","LAST_USER","LAST_DATE","LAST_LEVEL");
