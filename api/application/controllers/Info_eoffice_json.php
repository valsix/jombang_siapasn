    ...
    function index_get() {
        ...
        else
        {
           //echo $reqSatuanKerjaId;exit();
            ...
            $set = new Pegawai;
            $aColumns = array("pegawai_id", "nip", "nama_lengkap", "temlahir", "tgllahir", "lulus", "jurusan", "lembaga", "tmtpang", "tmtcpns", "tmtpns", "tmtjab", "nss", "unit", "dudukpeg", "usia", "masakerja", "jenis_jabatan", "nama_eselon", "agama", "kawin", "tingkat", "kelamin", "pendidikan", "gol", "nama_dukpeg", "pangkat", "nama_jabatan", "nama_statuspeg", "unitkerja", "tmt_pensiun");
