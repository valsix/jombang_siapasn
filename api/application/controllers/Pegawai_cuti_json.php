...
class Pegawai_cuti_json extends REST_Controller {
	...
	function index_get() {
        ...
        {
            $set = new Cuti;
            $aColumns = array("CUTI_ID","PEGAWAI_ID","JENIS_CUTI","NO_SURAT","TANGGAL_PERMOHONAN","TANGGAL_SURAT","LAMA","TANGGAL_MULAI","TANGGAL_SELESAI","KETERANGAN","CUTI_KETERANGAN","STATUS","LAST_USER","LAST_DATE","LAST_LEVEL","JENIS_CUTI_NAMA", "TEMP_VALIDASI_ID", "TEMP_VALIDASI_HAPUS_ID", "VALIDASI", "VALIDATOR", "PERUBAHAN_DATA", "TIPE_PERUBAHAN_DATA", "TANGGAL_VALIDASI");
