...
class Data_utama_json extends REST_Controller {
	...
	function index_get() {
        ...
        {
            $set = new Pegawai;
            $aColumns = array("PEGAWAI_ID","STATUS","SATUAN_KERJA_NAMA_DETIL","SATUAN_KERJA_ID","JENIS_PEGAWAI_ID","JENIS_PEGAWAI_NAMA",
                "BPJS","BPJS_TANGGAL","NPWP_TANGGAL","EMAIL_KANTOR","REKENING_NAMA","GAJI_POKOK","TUNJANGAN","TUNJANGAN_KELUARGA",
                "GAJI_BERSIH","STATUS_MUTASI","TMT_MUTASI","INSTANSI_SEBELUM","JENIS_PEGAWAI_ID","TIPE_PEGAWAI_ID","STATUS_PEGAWAI",
                "PEGAWAI_STATUS_NAMA","PEGAWAI_KEDUDUKAN_TMT","PEGAWAI_KEDUDUKAN_NAMA","NIP_LAMA","NIP_BARU","NAMA","GELAR_DEPAN",
                "GELAR_BELAKANG","TEMPAT_LAHIR","TANGGAL_LAHIR","JENIS_KELAMIN","STATUS_KAWIN","GOLONGAN_DARAH","EMAIL",
                "ALAMAT","ALAMAT_KETERANGAN","RT","RW","KODEPOS","TELEPON","HP","KARTU_PEGAWAI","ASKES","TASPEN","NPWP",
                "NIK","NO_REKENING","SK_KONVERSI_NIP","BANK_ID","AGAMA_ID","NO_URUT","NO_KK","NO_RAK_BERKAS","TELEPON_KANTOR",
                "FACEBOOK","TWITTER","WHATSAPP","TELEGRAM","KETERANGAN_1","KETERANGAN_2","PROPINSI_ID","PROPINSI_NAMA",
    ...
    function index_post() {
        ...
        else
        {
            ...
            $this->load->model('base-new/Mertua');
