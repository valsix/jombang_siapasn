...
class Mertua_json extends REST_Controller {
	...
	function index_get() {
        ...
        {
            $set = new Mertua;
            $aColumns = array("MERTUA_ID","PEGAWAI_ID","JENIS_KELAMIN","NAMA","TEMPAT_LAHIR","TANGGAL_LAHIR","PEKERJAAN","ALAMAT","KODEPOS","TELEPON","LAST_DATE","LAST_LEVEL","PROPINSI_ID","PROPINSI_NAMA","KABUPATEN_ID","KABUPATEN_NAMA","KECAMATAN_ID","KECAMATAN_NAMA","DESA_ID","DESA_NAMA", "TEMP_VALIDASI_ID", "TEMP_VALIDASI_HAPUS_ID", "VALIDASI", "VALIDATOR", "PERUBAHAN_DATA", "TIPE_PERUBAHAN_DATA", "TANGGAL_VALIDASI");
