...
class Pegawai_file_json extends REST_Controller {
	...
	function index_get() {
        ...
        {
            $set = new PegawaiFile;
            $aColumns = array("PEGAWAI_FILE_ID","PEGAWAI_ID","RIWAYAT_TABLE","RIWAYAT_FIELD","RIWAYAT_ID","FILE_KUALITAS_ID","PATH","STATUS_VERIFIKASI","KETERANGAN","STATUS","KATEGORI_FILE_ID","LAST_USER","LAST_DATE","LAST_LEVEL","PATH_NAMA");
