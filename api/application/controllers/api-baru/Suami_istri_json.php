...
class Suami_istri_json extends REST_Controller {
	...
	function index_get() {
        ...
        $this->load->model('base-new/SuamiIstri');
        ...
        {
            $set = new SuamiIstri;
            $aColumns = array("NAMA","TANGGAL_LAHIR","TEMPAT_LAHIR","KARTU","TANGGAL_KAWIN","NO_AKTA_NIKAH","NIP_PNS","PEKERJAAN","STATUS_S_I_NAMA","STATUS","LAST_LEVEL","SUAMI_ISTRI_ID","PEGAWAI_ID", "NIK","SURAT_NIKAH", "PENDIDIKAN_ID", "PENDIDIKAN_NAMA"
            );
