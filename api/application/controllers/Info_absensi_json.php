...
class Info_absensi_json extends REST_Controller {
    ...
    function index_get() {
        ...
        if($reqPegawaiId == "" || empty($tanggalmulai) || empty($tanggalakhir))
        {
        ...
        {
            $total = 0;
            $aColumns = array("PEGAWAI_ID", "NIP_BARU", "NAMA_LENGKAP", "TANGGAL", "HARI", "MASUK", "JAM_MASUK", "PULANG", "JAM_PULANG", "EX_MASUK", "TERLAMBAT", "PULANG_CEPAT");
            ...
            // $statementsatuankerja= " AND A.PEGAWAI_ID IN (8300) ";
            ...
            $set= new Absensi();
            $set->selectByDataPegawai(array(), -1, -1, $infotanggaldetil, $statementsatuankerja, "ORDER BY A.ESELON_ID ASC, A.PANGKAT_ID DESC, A.PANGKAT_RIWAYAT_TMT ASC");
            while ($set->nextRow())
            {
