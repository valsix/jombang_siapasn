...
class penghargaan_json extends REST_Controller {
	...
	function index_get() {
        ...
        {
            $set = new Penghargaan;
            $aColumns = array("PENGHARGAAN_ID","PEGAWAI_ID","PEJABAT_PENETAP_ID","PEJABAT_PENETAP","NAMA","NAMA_NAMA","NO_SK","TANGGAL_SK","TAHUN","LAST_USER","LAST_DATE","LAST_LEVEL","STATUS","PEJABAT_PENETAP_NAMA" , "TEMP_VALIDASI_ID", "TEMP_VALIDASI_HAPUS_ID", "VALIDASI", "VALIDATOR", "PERUBAHAN_DATA", "TIPE_PERUBAHAN_DATA", "TANGGAL_VALIDASI");
