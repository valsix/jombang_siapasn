...
class Surat_tanda_lulus_json extends REST_Controller {
	...
	function index_get() {
        ...
        else
        {
            ...
            $aColumns = array("SURAT_TANDA_LULUS_ID","PEGAWAI_ID","JENIS_ID","NO_STLUD","TANGGAL_STLUD","TANGGAL_MULAI","TANGGAL_AKHIR","NILAI_NPR","NILAI_NT","PENDIDIKAN_RIWAYAT_ID","PENDIDIKAN_ID","STATUS","LAST_USER","LAST_DATE","LAST_LEVEL","JENIS_ID","STATUS","LAST_USER","LAST_DATE");
