...
class kursus_json extends REST_Controller {
	...
	function index_get() {
        ...
        {
            $set = new Kursus;
            $aColumns = array("KURSUS_ID","PEGAWAI_ID","TEMPAT","PENYELENGGARA","TANGGAL_SELESAI","TANGGAL_MULAI","NO_PIAGAM","STATUS","TANGGAL_PIAGAM","NAMA","LAST_USER","LAST_DATE","LAST_LEVEL");
