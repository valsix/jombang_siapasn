...
***************************************************************************************************** */
  ...
  ***/
  ...
  class PegawaiNewFile extends Entity{ 
    ...
    **/
    ...
    function noketinsert()
    {
        ...
        (
            ...
            , '".$this->getField("CREATE_USER")."'
            , '".$this->getField("PRIORITAS")."'
            , ".$this->getField("TEMP_VALIDASI_BELUM_ID")."
        )
        ";  
        $this->id = $this->getField("PEGAWAI_FILE_ID");
        $this->query = $str;
    ...
    function noketupdate()
    {
        ...
        SET    
            ...
            , PRIORITAS= '".$this->getField("PRIORITAS")."'
            , PATH_ASLI= '".$this->getField("PATH_ASLI")."'
            , TEMP_VALIDASI_BELUM_ID= ".$this->getField("TEMP_VALIDASI_BELUM_ID")."
        WHERE PEGAWAI_FILE_ID = ".$this->getField("PEGAWAI_FILE_ID")."
        "; 
        $this->query = $str;
        // echo $str;exit();
    ...
    **/ 
    ...
    function selectfileuser($paramsArray=array(),$limit=-1,$from=-1, $userid, $statement='',$order=' ORDER BY A.URUT')
    {
        $str = "
        SELECT
            NULL STATUS, B2.NAMA KATEGORI_FILE_NAMA
            , A.*
