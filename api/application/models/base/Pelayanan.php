...
***************************************************************************************************** */
  ...
  ***/
  ...
  class Pelayanan extends Entity{ 
    ...
    **/
    ...
    function selectByParamsKarisKarsu($paramsArray=array(),$limit=-1,$from=-1, $statement='', $order='ORDER BY A.PEGAWAI_ID ASC')
	{
		$str = "
    ...
    //FUNCTION copy dari Karis Karsu buat coba Karpeg, Pensiun .::Rendy::.
    function selectByParamsKarpeg($paramsArray=array(),$limit=-1,$from=-1, $statement='', $order='ORDER BY A.PEGAWAI_ID ASC')
	{
		$str = "
			SELECT A.PEGAWAI_ID, A.SATUAN_KERJA_ID, A.NIP_BARU
				, SMP.SURAT_MASUK_PEGAWAI_ID, SMP.SURAT_MASUK_BKD_ID, SMP.SURAT_MASUK_UPT_ID
    ...
    function selectByParamsPensiun($paramsArray=array(),$limit=-1,$from=-1, $statement='', $order='ORDER BY A.PEGAWAI_ID ASC')
	{
		$str = "
			SELECT A.PEGAWAI_ID, A.SATUAN_KERJA_ID, A.NIP_BARU
				, SMP.SURAT_MASUK_PEGAWAI_ID, SMP.SURAT_MASUK_BKD_ID, SMP.SURAT_MASUK_UPT_ID
    ...
    function selectByParamsKenaikanPangkat($paramsArray=array(),$limit=-1,$from=-1, $statement='', $order='ORDER BY A.PEGAWAI_ID ASC')
	{
		$str = "
			SELECT A.PEGAWAI_ID, A.SATUAN_KERJA_ID, A.NIP_BARU
				, SMP.SURAT_MASUK_PEGAWAI_ID, SMP.SURAT_MASUK_BKD_ID, SMP.SURAT_MASUK_UPT_ID
    ...
    function selectByParamsIzinBelajar($paramsArray=array(),$limit=-1,$from=-1, $statement='', $order='ORDER BY A.PEGAWAI_ID ASC')
	{
		$str = "
			SELECT A.PEGAWAI_ID, A.SATUAN_KERJA_ID, A.NIP_BARU
				, SMP.SURAT_MASUK_PEGAWAI_ID, SMP.SURAT_MASUK_BKD_ID, SMP.SURAT_MASUK_UPT_ID
    ...
    //END FUNCTION copy dari Karis Karsu buat coba Karpeg, Pensiun, Kenaikan Pangkat, Izin Belajar .::Rendy::.
