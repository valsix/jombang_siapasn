...
$arrData= array(
	array("label"=>"KLARIFIKASI ID", "width"=>"", "display"=>"1")
	, array("label"=>"NAMA / NIP", "width"=>"", "display"=>"")
	, array("label"=>"TANGAL MASUK", "width"=>"", "display"=>"")
	, array("label"=>"JENIS KLARIFIKASI", "width"=>"", "display"=>"")
	, array("label"=>"STATUS", "width"=>"", "display"=>"")
	, array("label"=>"UBAH ASK", "width"=>"", "display"=>"")
	, array("label"=>"KETERANGAN", "width"=>"", "display"=>"")
	, array("label"=>"ALASAN DITOLAK", "width"=>"", "display"=>"")
	, array("label"=>"BUKTI PENDUKUNG", "width"=>"", "display"=>"")
);
...
<title>Klarifikasi Masuk Pulang</title>
<base href="<?=base_url()?>">
...
<script type="text/javascript" charset="utf-8">
	var oTable; 
	var json= "klarifikasi_json/masukpulang"; var form= "klarifikasi_masuk_pulang_add";
    $(document).ready( function () {
		...
		oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			"bServerSide": true,
			"FixedColumns": true,
			"sAjaxSource": "main/"+json+"/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqKhususDinas=<?=$reqKhususDinas?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>&reqStatus=<?=$reqStatus?>",
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("main/"+json+"/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqKhususDinas="+reqKhususDinas+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus+"&reqPencarian="+reqCariFilter);
		});
...
<div id="wadah">
    <div class="judul-halaman">
    	<span>Monitoring Klarifikasi Masuk Pulang</span>
