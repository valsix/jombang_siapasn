...
$jenis= "klarifikasi_kalkulasi_ulang";
...
else
{
	...
	while($set->nextRow())
	{
		...
		$arrdata[$index]["TANGGAL_MULAI_DETIK"]= $set->getField("TANGGAL_MULAI_DETIK");
		$arrdata[$index]["TANGGAL_SELESAI"]= dateToPageCheck($set->getField("TANGGAL_SELESAI"));
		$arrdata[$index]["TANGGAL_SELESAI_DETIK"]= $set->getField("TANGGAL_SELESAI_DETIK");
		...
		$arrdata[$index]["KODE"]= $set->getField("KODE");
		$index++;
	}
	...
	if($jumlahpegawai > 0)
	{
		...
		$reqTanggalAwalDetik= $arrdata[0]["TANGGAL_MULAI_DETIK"];
		$reqTanggalAkhir= $arrdata[0]["TANGGAL_SELESAI"];
		$reqTanggalAkhirDetik= $arrdata[0]["TANGGAL_SELESAI_DETIK"];
		...
		$reqJenisKlarifikasi= $arrdata[0]["KODE"];
	}
...
<title>Tambah Kalkulasi Ulang</title>	
<base href="<?=base_url()?>">
...
$(function(){
	...
	$('#ff').form({
		url:'main/klarifikasi_json/kalkulasiulangadd',
		onSubmit:function(){
...
<body class="bg-permohonan">
	<div class="area-permohonan">
		<div class="judul-monitoring"><span>Form Kalkulasi Ulang</span></div>
				...
				<thead>
					<tr>
	                    ...
	                    <td>
	                    	...
	                    	Jam <input style="width: 80px" required class="easyui-validatebox" type="text" name="reqTanggalAwalDetik" id="reqTanggalAwalDetik" maxlength="8" onKeyDown="return format_detik(event,'reqTanggalAwalDetik');" value="<?=$reqTanggalAwalDetik?>" autocomplete="off" <?=$disabled?> />
	                    </td>
	                    <td>User Terakhir</td>
	                    <td style="width: 1%">:</td>
	                    <td style="width: 30%">
	                ...
	                <tr>
	                    ...
	                    <td>
	                    	...
	                    	Jam <input style="width: 80px" required class="easyui-validatebox" type="text" name="reqTanggalAkhirDetik" id="reqTanggalAkhirDetik" maxlength="8" onKeyDown="return format_detik(event,'reqTanggalAkhirDetik');" value="<?=$reqTanggalAkhirDetik?>" autocomplete="off" <?=$disabled?> />
	                    </td>
	                ...
	                <tr>
                        ...
                        <td>:</td>
                        <td>
                            <select name="reqJenisKlarifikasi" id="reqJenisKlarifikasi" <?=$disabled?> >
                            	<?
                            	...
                            	?>
                            		<option value="<?=$infoid?>" <? if($reqJenisKlarifikasi == $infoid) { ?> selected="selected" <? } ?> >
                            			<?=$infonama?>
                            		</option>
                            	<?
                            	}
