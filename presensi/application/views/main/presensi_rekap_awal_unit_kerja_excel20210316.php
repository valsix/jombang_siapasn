...
$jumlahdata= $set->getCountByParamsRekapAwalUnitKerja(array(), $reqPeriode, $searchJson.$statementdetil);
$set->selectByParamsRekapAwalUnitKerja(array(), -1, -1, $reqPeriode, $statementdetil, $searchJson.$statement, $sOrder);
//echo $set->query;exit;
