...
$arrData= array(
	array("label"=>"KLARIFIKASI ID", "width"=>"")
	, array("label"=>"NAMA / NIP", "width"=>"")
	, array("label"=>"MULAI TUGAS BELAJAR", "width"=>"")
	, array("label"=>"SELESAI TUGAS BELAJAR", "width"=>"")
...
<title>Klarifikasi Tugas Belajar</title>
<base href="<?=base_url()?>">
...
<script type="text/javascript" charset="utf-8">
	var oTable;
	var json= "klarifikasi_json/tugasbelajar"; var form= "klarifikasi_tugas_belajar_add";
    $(document).ready( function () {
		...
		oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			<?
			for($col=1; $col<count($arrData); $col++)
			{
				if($col == 1){}
				else
					echo ",";
...
<div id="wadah">
    <div class="judul-halaman">
    	<span>Monitoring Klarifikasi Tugas Belajar</span>
