...
{
	$reqMode = "update";
	$set->selectByParamsJamShift(array("A.KERJA_JAM_SHIFT_ID"=>$reqId));
	// echo $set->query;exit();
	$set->firstRow();
...
$(function(){
	...
	$('#ff').form({
		url:'main/jadwal_json/kerjashift_add',
		onSubmit:function(){
...
<body class="bg-permohonan">
	<div class="area-permohonan">
		<div class="judul-monitoring"><span>Form Jadwal Jam Shift</span></div>
            ...
            <div class="tab-content">
                <div id="tab-general" class="tab-pane fade in active">
					<table class="table">
						<thead>
							<tr>
			                    <td>Nama Jam Shift</td>
			                    <td>:</td>
			                    <td>
			                    	<input type="text" id="reqNamaJamKerja" name="reqNamaJamKerja" class="easyui-validatebox" style="width:50%;" value="<?=$reqNamaJamKerja?>" />
			                    </td>
			                </tr>
			                <tr>
			                	<td>Berlaku Untuk</td>
		                        <td>:</td>
		                        <td>
		                        	<input type="text" id="reqSatuanKerjaId" class="easyui-combotree" name="reqSatuanKerjaId" data-options="width:'500'
		                            , panelHeight:'120'
		                            , valueField:'id'
		                            , textField:'text'
		                            , url:'siap/satuan_kerja_json/combotree/'
		                            , prompt:'Tentukan Pemesan...'," value="<?=$reqSatuanKerjaId?>"
		                            />
		                        </td>
			                </tr>
			                <tr>
			                	...
			                	<td>:</td>
			                	<td>
			                		<input class="easyui-datetimebox" name="reqMulaiBerlaku" data-options="required:true, showSeconds:true" style="width:155px" value="<?=$reqMulaiBerlaku?>" />
			                		s/d
			                		<input class="easyui-datetimebox" name="reqAkhirBerlaku" data-options="required:true, showSeconds:true" style="width:155px" value="<?=$reqAkhirBerlaku?>" />
			                	</td>
			                </tr>
						</thead>
					</table>
					...
					<table class="table">
						<thead>
			                <tr>
			                    ...
			                    <td colspan="4">
			                    	<input type="text" id="reqMasukNormal" name="reqMasukNormal" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqMasukNormal');" maxlength="8" value="<?=$reqMasukNormal?>" />
			                    </td>
			                    <td style="width: 10%">Status A/S/K</td>
		                        <td style="width: 10px">:</td>
		                        <td>
		                            <select name="reqAskNormal" id="reqAskNormal">
			                    ...
			                    <td>:</td>
			                    <td>
			                    	<input type="text" id="reqAkhirAskNormal" name="reqAkhirAskNormal" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqAkhirAskNormal');" maxlength="8" value="<?=$reqAkhirAskNormal?>" />
			                    </td>
			                </tr>
			                <tr>
			                    <td>
			                    ...
			                    <td>:</td>
			                    <td style="width: 10%">
			                    	<input type="text" id="reqMulaiMasukNormal" name="reqMulaiMasukNormal" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqMulaiMasukNormal');" maxlength="8" value="<?=$reqMulaiMasukNormal?>" />
			                    </td>
			                    <td style="width: 10%">
			                    ...
			                    <td style="width: 10px">:</td>
			                    <td style="width: 10%">
			                    	<input type="text" id="reqAkhirMasukNormal" name="reqAkhirMasukNormal" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqAkhirMasukNormal');" maxlength="8" value="<?=$reqAkhirMasukNormal?>" />
			                    </td>
			                    <td>Status Cek</td>
		                        <td>:</td>
		                        <td colspan="4">
		                            <select name="reqStatusCekNormal" id="reqStatusCekNormal">
		                            	<option value="">Tidak Aktif</option>
			                ...
			                <tr>
			                    ...
			                    <td>:</td>
			                    <td colspan="4">
			                    	<input type="text" id="reqKeluarNormal" name="reqKeluarNormal" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqKeluarNormal');" maxlength="8" value="<?=$reqKeluarNormal?>" />
			                    </td>
			                    <td>
			                    ...
			                    <td>:</td>
			                    <td>
			                    	<input type="text" id="reqAwalCekNormal" name="reqAwalCekNormal" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqAwalCekNormal');" maxlength="8" value="<?=$reqAwalCekNormal?>" />
			                    </td>
			                    <td>
			                    ...
			                    <td>:</td>
			                    <td>
			                    	<input type="text" id="reqAkhirCekNormal" name="reqAkhirCekNormal" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqAkhirCekNormal');" maxlength="8" value="<?=$reqAkhirCekNormal?>" />
			                    </td>
			                </tr>
			                <tr>
			                    <td>
			                    ...
			                    <td>:</td>
			                    <td>
			                    	<input type="text" id="reqMulaiKeluarNormal" name="reqMulaiKeluarNormal" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqMulaiKeluarNormal');" maxlength="8" value="<?=$reqMulaiKeluarNormal?>" />
			                    </td>
			                    <td>
			                    ...
			                    <td>:</td>
			                    <td>
			                    	<input type="text" id="reqAkhirKeluarNormal" name="reqAkhirKeluarNormal" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqAkhirKeluarNormal');" maxlength="8" value="<?=$reqAkhirKeluarNormal?>" />
			                    </td>
			                    <td>Keluar Ganti Hari</td>
		                        <td>:</td>
		                        <td>
		                            <select name="reqKeluarGantiHariNormal" id="reqKeluarGantiHariNormal">
					...
					<table class="table">
						<thead>
			                <tr>
			                    ...
			                    <td style="width: 10px">:</td>
			                    <td>
			                    	<input type="text" id="reqMasukRamadhan" name="reqMasukRamadhan" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqMasukRamadhan');" maxlength="8" value="<?=$reqMasukRamadhan?>" />
			                    </td>
			                    <td style="width: 10%">Status A/S/K</td>
		                        <td style="width: 10px">:</td>
		                        <td>
		                            <select name="reqAskRamadhan" id="reqAskRamadhan">
		                            	<option value="">Tidak Aktif</option>
			                    ...
			                    <td>:</td>
			                    <td>
			                    	<input type="text" id="reqAkhirAskRamadhan" name="reqAkhirAskRamadhan" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqAkhirAskRamadhan');" maxlength="8" value="<?=$reqAkhirAskRamadhan?>" />
			                    </td>
			                </tr>
			                <tr>
			                    <td>
			                    ...
			                    <td>:</td>
			                    <td style="width: 10%">
			                    	<input type="text" id="reqMulaiMasukRamadhan" name="reqMulaiMasukRamadhan" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqMulaiMasukRamadhan');" maxlength="8" value="<?=$reqMulaiMasukRamadhan?>" />
			                    </td>
			                    <td style="width: 10%">
				                    Akhir Masuk <span class="infolabel"><br/>(hh:mm:ss)</span>
				                </td>
			                    <td style="width: 10px">:</td>
			                    <td style="width: 10%">
			                    	<input type="text" id="reqAkhirMasukRamadhan" name="reqAkhirMasukRamadhan" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqAkhirMasukRamadhan');" maxlength="8" value="<?=$reqAkhirMasukRamadhan?>" />
			                    </td>
			                    <td>Status Cek</td>
		                        <td>:</td>
		                        <td>
		                            <select name="reqStatusCekRamadhan" id="reqStatusCekRamadhan">
		                            	<option value="">Tidak Aktif</option>
		                        ...
		                        <td>:</td>
		                        <td>
		                            <select name="reqKeluarGantiHariRamadhan" id="reqKeluarGantiHariRamadhan">
		                            	<option value="">Tidak</option>
			                ...
			                <tr>
			                    ...
			                    <td>:</td>
			                    <td colspan="4">
			                    	<input type="text" id="reqKeluarRamadhan" name="reqKeluarRamadhan" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqKeluarRamadhan');" maxlength="8" value="<?=$reqKeluarRamadhan?>" />
			                    </td>
			                    <td>
				                    Awal Cek <span class="infolabel"><br/>(hh:mm:ss)</span>
				                </td>
			                    <td>:</td>
			                    <td>
			                    	<input type="text" id="reqAwalCekRamadhan" name="reqAwalCekRamadhan" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqAwalCekRamadhan');" maxlength="8" value="<?=$reqAwalCekRamadhan?>" />
			                    </td>
			                    <td>
				                    Akhir Cek <span class="infolabel"><br/>(hh:mm:ss)</span>
				                </td>
			                    <td>:</td>
			                    <td>
			                    	<input type="text" id="reqAkhirCekRamadhan" name="reqAkhirCekRamadhan" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqAkhirCekRamadhan');" maxlength="8" value="<?=$reqAkhirCekRamadhan?>" />
			                    </td>
			                </tr>
			                <tr>
			                    <td>
			                    ...
			                    <td>:</td>
			                    <td>
			                    	<input type="text" id="reqMulaiKeluarRamadhan" name="reqMulaiKeluarRamadhan" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqMulaiKeluarRamadhan');" maxlength="8" value="<?=$reqMulaiKeluarRamadhan?>" />
			                    </td>
			                    <td>
				                    Akhir Keluar <span class="infolabel"><br/>(hh:mm:ss)</span>
				                </td>
			                    <td>:</td>
			                    <td>
			                    	<input type="text" id="reqAkhirKeluarRamadhan" name="reqAkhirKeluarRamadhan" size="8" class="easyui-validatebox" onkeydown="return format_detik(event,'reqAkhirKeluarRamadhan');" maxlength="8" value="<?=$reqAkhirKeluarRamadhan?>" />
			                    </td>
		                        <td>Berlaku</td>
		                        <td>:</td>
		                        <td colspan="4">
    ...
    <script type="text/javascript">
	    ...
	    function setinfovalidasi()
	    {
    		...
    		if(reqNamaJamKerja == "" || reqSatuanKerjaId == "")
    		{
