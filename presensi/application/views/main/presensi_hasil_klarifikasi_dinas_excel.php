...
$jumlahdata= $set->getCountByParamsHasilKlarifikasi(array(), $reqPeriode, $searchJson.$statementdetil);
$set->selectByParamsHasilKlarifikasi(array(), -1, -1, $reqPeriode, $statementdetil, $searchJson.$statement, $sOrder);
//echo $set->query;exit;
