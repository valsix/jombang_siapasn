...
<title>Klarifikasi Pakta Integritas</title>
<base href="<?=base_url()?>">
...
<script type="text/javascript" charset="utf-8">
	var oTable; 
	var json= "klarifikasi_json/paktaintegritas"; var form= "klarifikasi_pakta_integritas_add";
...
<div id="wadah">
    <div class="judul-halaman">
    	<span>Monitoring Klarifikasi Pakta Integritas</span>
