...
$arrData= array(
	array("label"=>"NO. TANGGAL SURAT", "width"=>"100")
	, array("label"=>"NIP / NAMA", "width"=>"")
	, array("label"=>"MULAI", "width"=>"")
	, array("label"=>"SELESAI", "width"=>"")
	, array("label"=>"LAMA", "width"=>"")
	, array("label"=>"STATUS", "width"=>"")
	, array("label"=>"UBAH ASK", "width"=>"")
	, array("label"=>"KETERANGAN", "width"=>"")
	, array("label"=>"ALASAN DITOLAK", "width"=>"")
	, array("label"=>"BUKTI PENDUKUNG", "width"=>"")
);
...
<title>Klarifikasi Diklat</title>
<base href="<?=base_url()?>">
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
		...
		oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			"bServerSide": true,
			"FixedColumns": true,
			"sAjaxSource": "main/klarifikasi_json/diklat/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqKhususDinas=<?=$reqKhususDinas?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
		...
		$("#btnAdd,#btnEdit").on("click", function () {
			...
			if(tempLihat == 1)
				document.location.href = "app/loadUrl/main/klarifikasi_diklat_add?reqId="+anSelectedId;
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("main/klarifikasi_json/diklat/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqKhususDinas="+reqKhususDinas+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus+"&reqPencarian="+reqCariFilter);
		});
...
<div id="wadah">
    <div class="judul-halaman">
    	<span>Monitoring Klarifikasi Diklat</span>
