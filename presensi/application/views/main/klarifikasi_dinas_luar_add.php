...
$(function(){
	...
	$('#ff').form({
		url:'main/klarifikasi_json/dinasluaradd',
		onSubmit:function(){
...
<body class="bg-permohonan">
	<div class="area-permohonan">
		<div class="judul-monitoring"><span>Form Klarifikasi Dinas Luar</span></div>

		<form id="ff" method="post" novalidate enctype="multipart/form-data">
			<table class="table">
				<thead>
					<tr>
	                    <td>Tanggal Mulai DL</td>
	                    <td>:</td>
	                    <td colspan="4">
