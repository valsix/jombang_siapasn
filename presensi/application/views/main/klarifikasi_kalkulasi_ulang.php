...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
		...
		oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			"bServerSide": true,
			"FixedColumns": true,
			"sAjaxSource": "main/klarifikasi_json/kalkulasiulang/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqKhususDinas=<?=$reqKhususDinas?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
		...
		$("#btnAdd,#btnEdit").on("click", function () {
			...
			if(tempLihat == 1)
				document.location.href = "app/loadUrl/main/klarifikasi_kalkulasi_ulang_add?reqId="+anSelectedId;
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("main/klarifikasi_json/kalkulasiulang/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqKhususDinas="+reqKhususDinas+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus+"&reqPencarian="+reqCariFilter);
		});
...
<div id="wadah">
    <div class="judul-halaman">
    	<span>Monitoring Kalkulasi Ulang</span>
