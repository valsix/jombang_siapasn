...
<body class="body-pjb">
                ...
                <div class="area-tombol-logout">
                    ...
                    <div class="area-tombol">
                        ...
                        <div class="notifikasi-faq-logout">
                            ...
                            <a href="#" title="FAQ/Help" class="faq" target="mainFrame"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
		            	...
		            	else
		            	{
		            		for($index_detil=0; $index_detil < count($arrayKey); $index_detil++)
		            		{
		            			...
		            			if($tempAkses == "D")
		            				continue;
		            ?>
		            			<li><a href="<?=$tempLinkFile?>" class="menu-item" target="mainFrame"><?=$tempNama?></a></li>
		            <?
		            		}
		            	}
			        }
					...
					else
					{
						for($index_detil=0; $index_detil < count($arrayKey); $index_detil++)
						{
							...
							else
							{
								...
								{
					?>
								<li><a href="#"><?=$tempNama?> <span class="caret"></span></a>
	...
	function infosetpegawai(id){
		$("iframe#mainFrame")[0].contentWindow.infosetpegawai(id);
	}
