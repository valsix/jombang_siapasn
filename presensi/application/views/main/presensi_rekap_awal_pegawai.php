...
$arrData= array(
	...
	, array("label"=>"Nama", "width"=>"120", "display"=>"")
	, array("label"=>"Jabatan", "width"=>"150", "display"=>"")
	, array("label"=>"Unit Kerja", "width"=>"", "display"=>"")
);
...
<title>Rekap Awal Per Pegawai</title>
<base href="<?=base_url()?>">
...
<script type="text/javascript" charset="utf-8">
	var oTable;
	var json= "presensi_rekap_json/rekapawalpegawai";
    ...
    $(document).ready( function () {
		...
		oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			"bServerSide": true,
			// "FixedColumns": true,
			"sAjaxSource": "main/"+json+"/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqKhususDinas=<?=$reqKhususDinas?>",
	    ...
	    $("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("main/"+json+"/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqKhususDinas="+reqKhususDinas+"&reqStatus="+reqStatus+"&reqPencarian="+reqCariFilter);
		});

		$("#reqSatuanKerjaId,#reqStatus,#reqKhususDinas").change(function() {
			setCariInfo();
		});
...
<div id="wadah">
    <div class="judul-halaman">
    	<span>Rekap Awal Per Pegawai</span>
	...
	<div id="parameter-tambahan">
    	<ul>
        	...
        	<li><a class="btn btn-danger btn-xs" id="btnlihat" title="Lihat"><i class="fa fa-edit"></i> Lihat</a></li>
