...
$arrData= array(
	array("label"=>"NAMA JAM SHIFT", "width"=>"200", "display"=>"")
	...
	, array("label"=>"GANTI HARI", "width"=>"", "display"=>"")
...
<script type="text/javascript" charset="utf-8">
	var oTable; 
	var json= "jadwal_json/jamshift"; var form= "jadwal_jam_shift_add";
...
<div id="wadah">
    <div class="judul-halaman">
    	<span>Monitoring Jadwal Jam Shift</span>
    </div>
