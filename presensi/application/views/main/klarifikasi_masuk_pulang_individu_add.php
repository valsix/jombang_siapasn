...
$jenis= "klarifikasi_masuk_pulang_individu";
...
else
{
	...
	while($set->nextRow())
	{
		...
		$arrdata[$index]["JENIS_FM"]= $set->getField("JENIS_FM");
		$index++;
	}
...
$(function(){
	...
	$('#ff').form({
		url:'main/klarifikasi_json/masukpulangindividu_add',
		onSubmit:function(){
...
<body class="bg-permohonan">
	<div class="area-permohonan">
		<div class="judul-monitoring"><span>Form Klarifikasi Masuk Pulang Force Majeur Individu</span></div>
