...
<title>Penjadwalan Libur / AWFH</title>
<base href="<?=base_url()?>">
...
<script type="text/javascript" charset="utf-8">
	var oTable;
	var json= "jadwal_json/jamkerjaawfhpegawai"; 
...
<div id="wadah">
    ...
    <div id="parameter-tambahan">
    	<ul>
        	...
        	<li><a class="btn btn-warning btn-xs" id="btnEdit" title="Atur AWFH"><i class="fa fa-pencil-square-o"></i> Atur AWFH</a></li>
            <li>
            	Bulan :
