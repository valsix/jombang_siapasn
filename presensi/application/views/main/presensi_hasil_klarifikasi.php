...
<script type="text/javascript" charset="utf-8">
	var oTable;
	var json= "presensi_rekap_json/hasilklarifikasi";
    ...
    $(document).ready( function () {
	    ...
	    $("#btnCari").on("click", function () {
			...
			if(tipereload == "1")
			{
				document.location.href = "app/loadUrl/main/presensi_hasil_klarifikasi?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqKhususDinas="+reqKhususDinas+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun;
			}
			else
			{
		...
		$('#btnrekapawal,#btnrekapawaltpp,#btnrekapawaldetail,#btnrekapawaldetailtpp,#btnrekapawaldinas,#btnrekapawaldetaildinas').on('click', function () {
	    	var reqSatuanKerjaId= reqKhususDinas= reqBulan= reqTahun= reqCariFilter= "";
			// reqCariFilter= $("#reqCariFilter").val();
			reqCariFilter= $('#example_filter input').val();
			reqBulan= $("#reqBulan").val();
			...
			reqStatusTpp="";
			if(btninfoid == "btnrekapawaltpp" || btninfoid == "btnrekapawaldetailtpp")
				reqStatusTpp= "1";

			opUrl= "app/loadUrl/main/presensi_hasil_klarifikasi_excel?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqKhususDinas="+reqKhususDinas+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&reqMode="+reqMode+"&reqModeDinas="+reqModeDinas+"&reqStatusTpp="+reqStatusTpp;
...
<div id="wadah">
    <div class="judul-halaman">
    	<span>Hasil Klarifikasi Per Unit Kerja (<?=getNamePeriode($reqPeriode)?>)</span>
	...
	<div id="parameter-tambahan">
    	<ul>
        	...
        	<!--<li><a class="btn btn-danger btn-xs" id="btnfinalisasi" title="Finalisasi"><i class="fa fa-edit"></i> Finalisasi</a></li>-->
        	<li>
            	<div class="dropdown">
                    <button class="btn btn-info btn-xs dropdown-toggle" type="button" data-toggle="dropdown">Export
                    <span class="caret"></span></button>
                    <ul class="dropdown-menu">
                        <li><a title="Rekap Awal" id="btnrekapawal">Hasil Klarifikasi</a></li>
                        <li><a title="Rekap Awal TPP" id="btnrekapawaltpp">Hasil Klarifikasi TPP</a></li>
                        <li><a title="Rekap Awal Detail" id="btnrekapawaldetail">Hasil Klarifikasi Detail</a></li>
                        <li><a title="Rekap Awal Detail TPP" id="btnrekapawaldetailtpp">Hasil Klarifikasi Detail TPP</a></li>
                        <?
                        if($infostatuskhususdinas == "1")
						{
						?>
						<li><a title="Rekap Awal Dinas" id="btnrekapawaldinas">Hasil Klarifikasi Dinas</a></li>
                        <li><a title="Rekap Awal Detail Dinas" id="btnrekapawaldetaildinas">Hasil Klarifikasi Detail Dinas</a></li>
						<?
						}
						?>
                    </ul>
