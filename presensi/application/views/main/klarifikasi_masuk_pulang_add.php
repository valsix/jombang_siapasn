...
$jenis= "klarifikasi_masuk_pulang";

// $statement= " AND A.KODE IN ('HMA','HPL','LMBR','HMA-HPL','IMT','IPC','IMT-IPC')";
...
$(function(){
	...
	$('#ff').form({
		url:'main/klarifikasi_json/masukpulang_add',
		onSubmit:function(){
...
function ambildatavalidabsensi()
{
	...
	{
		var s_url= "main/klarifikasi_json/masukpulang_option?reqPegawaiId="+reqPegawaiId+"&reqTanggal="+reqTanggal;
...
<body class="bg-permohonan">
	<div class="area-permohonan">
		<div class="judul-monitoring"><span>Form Klarifikasi Masuk Pulang</span></div>
