...
$arrData= array(
	...
	, array("label"=>"MULAI IZIN", "width"=>"", "display"=>"")
	, array("label"=>"SELESAI IZIN", "width"=>"", "display"=>"")
	, array("label"=>"LAMA IZIN (HARI)", "width"=>"", "display"=>"")
...
<title>Klarifikasi Izin Sakit Sementara</title>
<base href="<?=base_url()?>">
...
<script type="text/javascript" charset="utf-8">
	var oTable;
	var json= "klarifikasi_json/ijinsakit"; var form= "klarifikasi_ijin_sakit_add";
...
<div id="wadah">
    <div class="judul-halaman">
    	<span>Monitoring Klarifikasi Izin Sakit</span>
