...
$arrData= array(
	...
	, array("label"=>"ID", "width"=>"", "display"=>"")
	, array("label"=>"Nama", "width"=>"", "display"=>"")
	, array("label"=>"NIP Baru", "width"=>"", "display"=>"")
	, array("label"=>"Tanggal", "width"=>"", "display"=>"")
	, array("label"=>"Waktu", "width"=>"", "display"=>"")
	, array("label"=>"Tipe Awal", "width"=>"", "display"=>"")
	, array("label"=>"Tipe Revisi", "width"=>"", "display"=>"")
...
<title>Klarifikasi Ganti Status Log</title>
<base href="<?=base_url()?>">
...
<script type="text/javascript" charset="utf-8">
	var oTable; 
	var json= "klarifikasi_json/gantistatus"; var form= "klarifikasi_ganti_status_add";
...
<div id="wadah">
    <div class="judul-halaman">
    	<span>Monitoring Klarifikasi Ganti Status Log</span>
