...
$arrData= array(
	array("label"=>"Tanggal Awal", "width"=>"", "display"=>"")
	, array("label"=>"Tanggal Akhir", "width"=>"", "display"=>"")
	, array("label"=>"Status", "width"=>"80", "display"=>"")
);
...
<script type="text/javascript" charset="utf-8">
	var oTable;
	var json= "jadwal_json/jadwalramadhan";
	var form= "jadwal_ramadhan_add";
...
<style type="text/css">
	table tr th:nth-child(1), th:nth-child(2), th:nth-child(3){
		text-align: center;
	}
	.row_selected td,
