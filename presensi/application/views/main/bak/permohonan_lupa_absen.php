...
$arrWidth=array("150", "320", "100", "110", "110", "120");
$arrData=array("NIP / NAMA", "Satuan Kerja", "Jenis", "Tanggal", "Tanggal Klarifikasi Absen", "Status");
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,
			  "ajax": {	
	            "url": "main/permohonan_json/json_lupa_absen/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
        	  	"type": "POST"
        	  },
			...
			/* Click event handler */
			  ...
			  $("#btnAdd,#btnEdit").on("click", function () {
		  		...
		  		if(tempLihat == 1)
			  	document.location.href = "app/loadUrl/main/permohonan_lupa_absen_add?reqId="+anSelectedId;
			  ...
			  $("#btnCari").on("click", function () {
			  	...
			  	oTable.fnReloadAjax("main/permohonan_json/json_lupa_absen/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&sSearch="+reqCariFilter);
			  });
...
<div id="wadah">
    <div class="judul-halaman"><span>Permohonan Klarifikasi Absen</span></div>
   ...
   <div id="parameter-tambahan" style="width: 80%">
        ...
        <select id="reqPermohonan">
          <option value="">Semua</option>         
          <option value="lupa_absen" selected>Klarifikasi Absen</option>
