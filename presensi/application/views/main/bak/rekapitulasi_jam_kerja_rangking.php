...
$arrData=array("NIP / NAMA", "Satuan Kerja", "Jumlah Jam");
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,		
			  "ajax": {	
	            "url": "main/rekapitulasi_jam_kerja_json/json_ranking/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
        	  	"type": "POST"
        	  },
			  // "sAjaxSource": "main/rekapitulasi_jam_kerja_json/json_ranking/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
			...
			/* Click event handler */
			  ...
			  $("#btnCari").on("click", function () {
			  	...
			  	oTable.fnReloadAjax("main/rekapitulasi_jam_kerja_json/json_ranking/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&sSearch="+reqCariFilter);
			  });
