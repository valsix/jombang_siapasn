...
$arrWidth=array("150", "320", "150");
$arrData=array("NIP / NAMA", "Satuan Kerja");
// print_r($arrData);exit();

for($i=1; $i <= 12; $i++) 
{
	array_push($arrData, getNameMonth($i));
}

array_push($arrData, "Jam Kerja Pertahun");
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,		
			  "ajax": {	
	            "url": "main/rekapitulasi_jam_kerja_json/json_pertahun_ranking/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
        	  	"type": "POST"
        	  },
			  // "sAjaxSource": "main/rekapitulasi_jam_kerja_json/json_pertahun_ranking/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
			...
			/* Click event handler */
			  ...
			  $("#btnCari").on("click", function () {
			  	...
			  	oTable.fnReloadAjax("main/rekapitulasi_jam_kerja_json/json_pertahun_ranking/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&sSearch="+reqCariFilter);
			  });
...
<div id="wadah">
    <div class="judul-halaman"><span>Monitoring Jam Kerja Pertahun</span></div>
