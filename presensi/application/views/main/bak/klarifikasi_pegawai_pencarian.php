...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "main/setting_klarifikasi_pegawai_json/jsonpilih/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>",
			...
			/* Click event handler */
			  ...
			  $('#btnApproval').on('click', function () {
			  	...
			  	$.messager.confirm('Konfirmasi',"Apakah anda yakin simpan, data terpilih?",function(r){
			  		if (r)
			  		{
			  			$.getJSON("main/setting_klarifikasi_pegawai_json/pilih?reqPegawaiId="+reqPegawaiId,
			  				function(data){
			  					document.location.href = "app/loadUrl/main/klarifikasi_pegawai";
			  				});
			  		}
			  ...
			  $("#btnCari").on("click", function () {
			  	var reqSatuanKerjaId= reqStatusIntegrasi= reqCariFilter= reqPegawaiId= "";
			  	...
			  	oTable.fnReloadAjax("main/setting_klarifikasi_pegawai_json/jsonpilih/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqCheckId="+reqPegawaiId+"&reqStatusIntegrasi="+reqStatusIntegrasi+"&reqPencarian="+reqCariFilter);
			  });
...
<div id="wadah">
    <div class="judul-halaman">
    	<span>Pilih Pengecualian Pegawai</span>
    	<span>
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(css/media/bluetab.gif)">    
        <ul>
			<li>
                ...
                <span><a id="btnResetAbsensi" title="Kembali">Kembali</a> </span>
                <span><a id="btnApproval" title="Pilih">Pilih</a> </span>
            </li>
        </ul>
    </div>
