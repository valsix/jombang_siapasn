...
for($i=1; $i <= $totalhari; $i++) 
{
	...
	array_push($arrDataDetil, "Jam Kerja");
}
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,
			  "ajax": {	
	            "url": "main/rekapitulasi_absensi_json/rekap_json/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
        	  	"type": "POST"
        	  },
			  // "sAjaxSource": "main/rekapitulasi_absensi_json/rekap_json/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
			...
			/* Click event handler */
			  ...
			  $("#btnCari").on("click", function () {
			  	...
			  	// reqStatusIntegrasi= $("#reqStatusIntegrasi").val();
			  	reqSatuanKerjaId= $("#reqSatuanKerjaId").val();
			  	oTable.fnReloadAjax("main/rekapitulasi_absensi_json/rekap_json/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&sSearch="+reqCariFilter);
			  });
			  ...
			  $("#reqSatuanKerjaId, #reqBulan, #reqTahun").change(function() { 
			  	...
			  	document.location.href= "app/loadUrl/main/rekapitulasi_absensi_unit_kerja/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun;
			  	// setCariInfo();
			  });
