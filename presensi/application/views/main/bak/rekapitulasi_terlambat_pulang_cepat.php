...
$arrWidth=array("150", "320", "100", "100", "100", "100", "100", "100", "100");
$arrData=array("NIP / NAMA", "Satuan Kerja", "Kelompok", "Masuk", "Terlambat", "Terlambat Tanggal", "Pulang Cepat", "Pulang Cepat Tanggal", "Tidak Masuk", "Tidak Masuk Hari");
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,		
			  "ajax": {	
	            "url": "main/rekapitulasi_jam_kerja_json/json_terlambat_pulang_cepat/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
        	  	"type": "POST"
        	  },
			  // "sAjaxSource": "main/rekapitulasi_jam_kerja_json/json_terlambat_pulang_cepat/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
			...
			/* Click event handler */
			  ...
			  $("#btnCari").on("click", function () {
			  	...
			  	oTable.fnReloadAjax("main/rekapitulasi_jam_kerja_json/json_terlambat_pulang_cepat/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&sSearch="+reqCariFilter);
			  });
			  ...
			  $("#reqSatuanKerjaId, #reqBulan, #reqTahun").change(function() { 
			  	...
			  	document.location.href= "app/loadUrl/main/rekapitulasi_terlambat_pulang_cepat/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun;
			  	// setCariInfo();
			  });
...
<div id="wadah">
    <div class="judul-halaman"><span>Monitoring Terlambat & Pulang Cepat</span></div>
