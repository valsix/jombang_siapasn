...
$arrWidth=array("150", "320", "100", "110", "110", "110", "120", "110", "110");
$arrData=array("NIP / NAMA", "Satuan Kerja", "Jenis", "Tanggal", "Awal", "Akhir", "Lama", "Status", "");
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bServerSide": true,
			  "ajax": {	
	            "url": "main/permohonan_json/json/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
        	  	"type": "POST"
        	  },
			  // "sAjaxSource": "main/permohonan_json/json/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
			...
			/* Click event handler */
			  ...
			  $("#btnCari").on("click", function () {
			  	...
			  	oTable.fnReloadAjax("main/permohonan_json/json/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&sSearch="+reqCariFilter);
			  });
			  ...
			  $("#btnAdd,#btnEdit").on("click", function () {
		  		...
		  		if(tempLihat == 1)
			  	document.location.href = "app/loadUrl/main/kegiatan_add?reqId="+anSelectedId;
...
<div id="wadah">
    <div class="judul-halaman"><span>Permohonan Keseluruhan</span></div>
    <div id="bluemenu" class="bluetabs" style="background:url(css/media/bluetab.gif)">    
        <ul>
			<li>
            	...
            	<span><a id="btnAdd" title="Tambah">Tambah</a></span>
                <span><a id="btnEdit" title="Ubah Data">Ubah</a> </span>
   ...
   <div id="parameter-tambahan" style="width: 80%">
        ...
        <select id="reqPermohonan">
          <option value="">Semua</option>         
          <option value="lupa_absen">Klarifikasi Absen</option>
