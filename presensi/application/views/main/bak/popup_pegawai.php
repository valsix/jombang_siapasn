...
$arrData= array(
	...
	, array("label"=>"CHECK", "width"=>"50")
	, array("label"=>"NAMA", "width"=>"")
	, array("label"=>"NIP", "width"=>"100")
	, array("label"=>"JABATAN", "width"=>"100")
);
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(css/media/bluetab.gif)">    
        <ul>
			<li>
				...
				<input type="text" id="reqPegawaiId" name="reqPegawaiId" />
