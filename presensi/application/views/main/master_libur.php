...
$arrData= array(
	array("label"=>"Tanggal Awal", "width"=>"110", "display"=>"")
	, array("label"=>"Tanggal Akhir", "width"=>"120", "display"=>"")
	, array("label"=>"Tanggal", "width"=>"110", "display"=>"")
	, array("label"=>"Nama", "width"=>"100", "display"=>"")
...
<script type="text/javascript" charset="utf-8">
	var oTable;
	var json= "klarifikasi_json/harilibur";
	var form= "master_libur_add";
    $(document).ready( function () {
		...
		oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			"bServerSide": true,
			// "FixedColumns": true,
			"sAjaxSource": "main/"+json+"/?reqTahun=<?=$reqTahun?>",
	    ...
	    $("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("main/"+json+"/?reqTahun="+reqTahun+"&reqPencarian="+reqCariFilter);
		});

		$("#btnAdd,#btnubah").on("click", function () {
