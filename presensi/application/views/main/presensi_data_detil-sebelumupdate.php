...
$arrData= array(
	...
	, array("label"=>"Mesin Presensi", "width"=>"150", "display"=>"")
	, array("label"=>"Tanggal Data Masuk", "width"=>"150", "display"=>"")
);
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
	    ...
	    $("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("main/"+json+"/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqKhususDinas="+reqKhususDinas+"&reqStatus="+reqStatus+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&reqPencarian="+reqCariFilter);
		});
		...
		$("#btncetak").on("click", function () {
			...
			opUrl= "app/loadUrl/main/presensi_data_detil_excel.php?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqKhususDinas="+reqKhususDinas+"&reqStatus="+reqStatus+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun;
