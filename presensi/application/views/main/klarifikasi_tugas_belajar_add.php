...
$jenis= "klarifikasi_tugas_belajar";
...
$(function(){
	...
	$('#ff').form({
		url:'main/klarifikasi_json/tugasbelajar_add',
		onSubmit:function(){
...
<body class="bg-permohonan">
	<div class="area-permohonan">
		<div class="judul-monitoring"><span>Form Klarifikasi Tugas Belajar</span></div>

		<form id="ff" method="post" novalidate enctype="multipart/form-data">
			<table class="table">
				<thead>
					<tr>
	                    <td>Tanggal Mulai Tugas Belajar</td>
	                    <td>:</td>
	                    <td colspan="4">
	                ...
	                <tr>
                		<td>Tanggal Selesai Tugas Belajar</td>
	                    <td>:</td>
	                    <td>
                	...
                	<tr>
						...
						<td>
							...
							<input required type="text" id="reqPegawaiNip" class="easyui-validatebox" style="width:50%;" value="<?=$reqPegawaiNip?>" <?=$disabled?> />
						</td>
