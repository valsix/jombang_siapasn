...
$arrData= array(
	...
	, array("label"=>"Nomor<br/>Tanggal Surat", "width"=>"", "display"=>"")
	, array("label"=>"Nama<br/>NIP Baru", "width"=>"", "display"=>"")
	, array("label"=>"Mulai Ditiadakan", "width"=>"", "display"=>"")
	, array("label"=>"Selesai Ditiadakan", "width"=>"", "display"=>"")
...
<script type="text/javascript" charset="utf-8">
	var oTable; 
	var json= "klarifikasi_json/masukpulangindividu"; var form= "klarifikasi_masuk_pulang_individu_add";
...
<div id="wadah">
    <div class="judul-halaman">
    	<span>Monitoring Klarifikasi Masuk Pulang Force Majeur Individu</span>
