...
$arrData= array(
	...
	, array("label"=>"MULAI DL", "width"=>"")
	, array("label"=>"SELESAI DL", "width"=>"")
...
<title>Klarifikasi Dinas Luar</title>
<base href="<?=base_url()?>">
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
		...
		oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			...
			"bServerSide": true,
			"FixedColumns": true,
			"sAjaxSource": "main/klarifikasi_json/dinasluar/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqKhususDinas=<?=$reqKhususDinas?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("main/klarifikasi_json/dinasluar/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqKhususDinas="+reqKhususDinas+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus+"&reqPencarian="+reqCariFilter);
		});
...
<div id="wadah">
    <div class="judul-halaman">
    	<span>Monitoring Klarifikasi Dinas Luar</span>
