...
$reqStatusTpp= $this->input->get("reqStatusTpp");
...
$infojudul= "Hasil Klarifikasi ";
if(!empty($reqMode))
	$infojudul= "Hasil Klarifikasi Detil ";
...
$jumlahdata= $set->getCountByParamsNewTppHasilKlarifikasi(array(), $infotanggaldetil, $reqStatusTpp, $reqPeriode, $searchJson.$statementdetil);
$set->selectByParamsNewTppHasilKlarifikasi(array(), -1, -1, $infotanggaldetil, $reqStatusTpp, $reqPeriode, $statementdetil, $searchJson.$statement, $sOrder);
//echo $set->query;exit;
...
if($maxhari == 28)
{
	if($reqStatusTpp == "1")
	{
		$field= array("JENIS", "NIP_BARU_NAMA_LENGKAP", "JABATAN_RIWAYAT_NAMA", "HARIINFO1", "HARIINFO2", "HARIINFO3","HARIINFO4","HARIINFO5","HARIINFO6","HARIINFO7","HARIINFO8","HARIINFO9","HARIINFO10","HARIINFO11","HARIINFO12","HARIINFO13","HARIINFO14","HARIINFO15","HARIINFO16","HARIINFO17","HARIINFO18","HARIINFO19","HARIINFO20","HARIINFO21","HARIINFO22","HARIINFO23","HARIINFO24","HARIINFO25","HARIINFO26","HARIINFO27","HARIINFO28","NIP_BARU","NAMA_LENGKAP");
	}
	else
	{
...
elseif($maxhari == 29)
{
	if($reqStatusTpp == "1")
	{
		$field= array("JENIS", "NIP_BARU_NAMA_LENGKAP", "JABATAN_RIWAYAT_NAMA", "HARIINFO1", "HARIINFO2", "HARIINFO3","HARIINFO4","HARIINFO5","HARIINFO6","HARIINFO7","HARIINFO8","HARIINFO9","HARIINFO10","HARIINFO11","HARIINFO12","HARIINFO13","HARIINFO14","HARIINFO15","HARIINFO16","HARIINFO17","HARIINFO18","HARIINFO19","HARIINFO20","HARIINFO21","HARIINFO22","HARIINFO23","HARIINFO24","HARIINFO25","HARIINFO26","HARIINFO27","HARIINFO28","HARIINFO29","NIP_BARU","NAMA_LENGKAP");
	}
	else
	{
...
elseif($maxhari == 30)
{
	if($reqStatusTpp == "1")
	{
		$field= array("JENIS", "NIP_BARU_NAMA_LENGKAP", "JABATAN_RIWAYAT_NAMA", "HARIINFO1", "HARIINFO2", "HARIINFO3","HARIINFO4","HARIINFO5","HARIINFO6","HARIINFO7","HARIINFO8","HARIINFO9","HARIINFO10","HARIINFO11","HARIINFO12","HARIINFO13","HARIINFO14","HARIINFO15","HARIINFO16","HARIINFO17","HARIINFO18","HARIINFO19","HARIINFO20","HARIINFO21","HARIINFO22","HARIINFO23","HARIINFO24","HARIINFO25","HARIINFO26","HARIINFO27","HARIINFO28","HARIINFO29","HARIINFO30","NIP_BARU","NAMA_LENGKAP");
	}
	else
	{
...
while($set->nextRow())
{
	...
	for($i=0; $i<count($field); $i++)
	{
		...
		elseif($field[$i] == "HARIINFO1" || $field[$i] == "HARIINFO2" || $field[$i] == "HARIINFO3" || $field[$i] == "HARIINFO4" || $field[$i] == "HARIINFO5" || $field[$i] == "HARIINFO6" || $field[$i] == "HARIINFO7" || $field[$i] == "HARIINFO8" || $field[$i] == "HARIINFO9" || $field[$i] == "HARIINFO10" || $field[$i] == "HARIINFO11" || $field[$i] == "HARIINFO12" || $field[$i] == "HARIINFO13" || $field[$i] == "HARIINFO14" || $field[$i] == "HARIINFO15" || $field[$i] == "HARIINFO16" || $field[$i] == "HARIINFO17" || $field[$i] == "HARIINFO18" || $field[$i] == "HARIINFO19" || $field[$i] == "HARIINFO20" || $field[$i] == "HARIINFO21" || $field[$i] == "HARIINFO22" || $field[$i] == "HARIINFO23" || $field[$i] == "HARIINFO24" || $field[$i] == "HARIINFO25" || $field[$i] == "HARIINFO26" || $field[$i] == "HARIINFO27" || $field[$i] == "HARIINFO28" || $field[$i] == "HARIINFO29" || $field[$i] == "HARIINFO30" || $field[$i] == "HARIINFO31")
		{
			...
			$in1= $set->getField("JAM_MASUK_".$infohari); if(empty($in1)) $in1= "-".$infojamkosong;
			$in2= $set->getField("MASUK_".$infohari);
			$out1= $set->getField("JAM_PULANG_".$infohari); if(empty($out1)) $out1= "-".$infojamkosong;
...
$filename = "hasilklarifikasi_".$IdCetakSatuanKerjaId."_".$reqTahun.$reqBulan."_".date('ymdhs');
