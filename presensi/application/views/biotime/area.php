...
<script type="text/javascript">
	...
	{
		var tt = $('#tt').treegrid({
			url: 'siap/satuan_kerja_json/tree',
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(css/media/bluetab.gif)">    
        <ul>
			<li>
                ...
                <span><a id="btnAdd" title="Tambah Area" style="cursor: pointer;">Tambah Area</a></span>
            </li>
        </ul>
    </div>
	    				...
	    				<table id="tt" class="easyui-treegrid" style="width:100%; height: 100%">
	    					<thead>
	    						<tr>
	    							...
	    							<th field="AREA_NAMA" width="20%">Nama Area</th>
	    							<th field="NAMA" width="30%">Satuan Kerja SIAP ASN</th>
	    							<th field="JUMLAH_PEGAWAI_AREA" width="10%" align="center">Jml Pegawai</th>
	    							<th field="JUMLAH_DEVICE" width="10%" align="center">Jml Device</th>
