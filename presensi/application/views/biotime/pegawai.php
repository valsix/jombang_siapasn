...
$arrWidth=array("20", "110", "120", "100", "80", "75", "100", "100");
$arrData=array("ID", "NIP Baru / Nama", "Satuan Kerja SIAP ASN", "Jabatan", "Aktif", "FP / FF", "Area Default", "Area Absensi");
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "bio/pegawai_json/json/?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>",
			...
			/* Click event handler */
			  ...
			  $("#btnCari").on("click", function () {
			  	var reqSatuanKerjaId= reqStatusIntegrasi= reqStatusAktif= reqCariFilter= "";
			  	...
			  	oTable.fnReloadAjax("bio/pegawai_json/json/?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqStatusIntegrasi="+reqStatusIntegrasi+"&reqStatusAktif="+reqStatusAktif+"&reqPencarian="+reqCariFilter);
			  });
			  ...
			  $("#reqSatuanKerjaId, #reqStatusIntegrasi, #reqStatusAktif").change(function() { 
			  	setCariInfo();
			  });
	    ...
	    <div class="parameter-tambahan">
	    	<table style="width: 100%">
	    		<tr>
	    			...
	    			<td style="width:10%">Status Aktif</td>
	    			<td style="width:10px">:</td>
	    			<td>
