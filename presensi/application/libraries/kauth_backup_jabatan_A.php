...
//        set the unique storege
	...
	function getLoginInformation($pegawaiId, $kodeGroup="")
	{
		...
		if($pegawai->firstRow())
		{
			...
			{
				if($identity->KODE_DEPARTEMEN != 0 && $identity->KODE_STAFF == "01")
				{
					$identity->APPROVAL[0] = "";
				...
				elseif($identity->KODE_JABATAN == "KP00127A" || $identity->KODE_JABATAN == "KP00138A" || $identity->KODE_JABATAN == "KP00134A" || $identity->KODE_JABATAN == "KP00107A")
				{
						$identity->APPROVAL[0] = "";
						$identity->APPROVAL[1] = "Direktur Utama";
						$identity->APPROVAL_ID[0] = "''";
				...
				elseif($identity->KODE_DEPARTEMEN == 10)
				{
						$identity->APPROVAL[0] = "";
				...
				elseif($identity->KODE_DEPARTEMEN == 4 && $identity->KODE_SUB_DEPARTEMEN == 42 && $identity->KODE_STAFF == "02")
				{
						$identity->APPROVAL[0] = "";
				...
				elseif($identity->KODE_DEPARTEMEN == 4 && $identity->KODE_SUB_DEPARTEMEN == 42)
				{
						$identity->APPROVAL[0] = "";
						$identity->APPROVAL[1] = "Manager";
						$identity->APPROVAL_ID[0] = "''";
				...
				else
				{
					...
					elseif($identity->KODE_STAFF == "17" && $identity->KODE_JABATAN == "KP00116A")
					{
						$identity->APPROVAL[0] = "";
						$identity->APPROVAL[1] = "Manager";
						$identity->APPROVAL_ID[0] = "''";
					...
					elseif(($identity->KODE_STAFF == "04" || $identity->KODE_STAFF == "05" || $identity->KODE_STAFF == "17") && $identity->KODE_DEPARTEMEN == 7)
					{
						$identity->APPROVAL[0] = "";
						$identity->APPROVAL[1] = "Direktur";
						$identity->APPROVAL_ID[0] = "''";
						$identity->APPROVAL_ID[1] = "'08'";			
						$identity->APPROVAL_STATEMENT[0] = array();
						$identity->APPROVAL_STATEMENT[1] = array("A.CABANG_ID" => $identity->KODE_CABANG, 
																 "A.DEPARTEMEN_ID" => $identity->KODE_DEPARTEMEN);								
					}
					elseif($identity->KODE_STAFF == "02" && $identity->KODE_DEPARTEMEN == 6)
					{
						$identity->APPROVAL[0] = "";
					...
					elseif($identity->KODE_STAFF == "02" && $identity->KODE_DEPARTEMEN == 5)
					{
						$identity->APPROVAL[0] = "";
						$identity->APPROVAL[1] = "Kepala Satuan";
						$identity->APPROVAL_ID[0] = "''";
					...
					elseif($identity->KODE_STAFF == "04" && $identity->KODE_DEPARTEMEN == 6)
					{
						$identity->APPROVAL[0] = "";
						$identity->APPROVAL[1] = "Manager";
						$identity->APPROVAL_ID[0] = "''";
					...
					elseif($identity->KODE_DEPARTEMEN == 6 && ($identity->KODE_SUB_DEPARTEMEN == 61 || $identity->KODE_SUB_DEPARTEMEN == 62))
					{
							$identity->APPROVAL[0] = "";
							$identity->APPROVAL[1] = "Manager";
							$identity->APPROVAL_ID[0] = "''";
			...
			else
			{
				...
				else
				{
					...
					elseif($identity->KODE_STAFF == "17" && $identity->KODE_SUB_DEPARTEMEN == "94" && $identity->KODE_CABANG == "AS")
					{
						$identity->APPROVAL[0] = "";
						$identity->APPROVAL[1] = "Manager Unit";
						$identity->APPROVAL_ID[0] = "''";
						$identity->APPROVAL_ID[1] = "'15'";	
						$identity->APPROVAL_STATEMENT[0] = array();		
						$identity->APPROVAL_STATEMENT[1] = array("A.CABANG_ID" => $identity->KODE_CABANG, 
																 "A.DEPARTEMEN_ID" => $identity->KODE_DEPARTEMEN);										
					} //ANGGIT ASAHAN
					...
					/* JIKA NON TEKNIK DAN SUB DIEKTORAT ADMINISTRASI */
					elseif(($identity->KODE_STAFF == "04" || $identity->KODE_STAFF == "05" || $identity->KODE_STAFF == "17") && $identity->KODE_SUB_DEPARTEMEN == "94" )
					{
						$identity->APPROVAL[0] = "Supervisor";
						$identity->APPROVAL[1] = "Manager Unit";
						$identity->APPROVAL_ID[0] = "'16'";
					...
					/* JIKA NON TEKNIK  */
					elseif( $identity->KODE_STAFF == "05" && $identity->KODE_CABANG == "JP")
					{
						$identity->APPROVAL[0] = "Supervisor";
						$identity->APPROVAL[1] = "Manager Unit";
					...
					elseif($identity->KODE_STAFF == "16"  && $identity->KODE_SUB_DEPARTEMEN == "94")
					{
						$identity->APPROVAL[0] = "";
						$identity->APPROVAL[1] = "Manager Unit";
						$identity->APPROVAL_ID[0] = "''";
