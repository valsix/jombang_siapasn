...
(function(n) {
    n(["jquery"], function(n) {
        ...
        function k(t, u, f) {
            ...
            var o = '<div class=modal-body style="position: absolute;width: 100%; background-color: rgba(255,255,255,0.8);height: 100%;">%1%<\/div><iframe class="embed-responsive-item" src="%0%" style="width:100%;height:calc(100vh - 78px); overflow:hidden; border:none; "/>'.replace("%0%", t.message || t.url || t).replace("%1%", i.loadingHtml),
                e = n(o).load(s);
            return r({
                buttons: t.buttons || !1,
                message: e,
        ...
        function rt() {
            function i() {
                return n('<div class="modal fade" tabindex="-1" style="overflow-y:hidden; "><div class=modal-dialog style="width:calc(100% - 100px) !important;"><div class=modal-content> <div class=modal-header><button type=button class="x close" data-dismiss=modal><span aria-hidden=true>&times;<\/span><span class=sr-only>Close<\/span><\/button><h4 class=modal-title><\/h4><\/div><\/div><\/div><\/div>').on("hidden.bs.modal", v).on("click", "button.x", function(i) {
					//location.reload();
