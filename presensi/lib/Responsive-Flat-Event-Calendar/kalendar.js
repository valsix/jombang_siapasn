;(function($, window, document, undefined) {
	...
	kalendar.prototype.setMonth = function() {
		...
		var bln = '';
		var thn = '';
		if(pad(tempDate.getMonth(),2) == '00')
		{
			bln = '12';
			thn = tempDate.getFullYear()-1;
		}
		else
		{
			bln = pad(tempDate.getMonth(),2);
			thn = tempDate.getFullYear();
		}

		var periodeProses = bln+''+thn;
		...
		req = $.get( "absensi_rekap_json/ambil_data_kehadiran/?reqTanggalAwal="+tanggalAwal+"&reqTanggalAkhir="+tanggalAkhir+"&reqPeriodeProses="+periodeProses, function( data ) {
			$("#kalender-pegawai").hide();
