...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="'+classes.sFilterInput+'"/> <button id="clicktoggle">Filter ▾</button>';
		// var input = '<div class="fg-toolbar ui-toolbar ui-widget-header ui-helper-clearfix ui-corner-tl ui-corner-tr">'
		// +'<input type="search" class="'+classes.sFilterInput+'"/> <button id="clicktoggle">Filter ▾</button>'
		// +'</div>';
	...
	DataTable.defaults = {
		 ...
		 *    } );
		 */
		"aLengthMenu": [ 10, 25, 50, 250, 500, 1000 ],
