(function(e) {
    e.skdslider = function(t, n) {
        ...
        r.running = false;
        if (r.stopSlidingAfter) {
            if (r.stopSlidingAfter == "all") {
                r.stopSlidingAfter = o.length
            }
            r.stopSlidingAfter -= 1
        }
    ...
    e.skdslider.playSlide = function(t, n, r, i) {
        ...
        if (r.stopSlidingAfter && r.stopSlidingAfter == r.currentSlide) {
            clearTimeout(r.interval);
            r.autoSlide = false;
            r.currentState = "pause";
            t.find("a.play-control").addClass("play");
            t.find("a.play-control").removeClass("pause")
        }
