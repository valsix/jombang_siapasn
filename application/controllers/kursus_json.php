...
class kursus_json extends CI_Controller {
	...
	{	
		...
		$aColumns = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "KURSUS_ID");
		$aColumnsAlias = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "KURSUS_ID");
		...
		$arrayWhere = array("KURSUS_ID" => $riwayatId);
