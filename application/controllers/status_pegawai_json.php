...
class status_pegawai_json extends CI_Controller {
	...
	function json() 
	{
		...
		$aColumns = array("NAMA", "LINK_URL_INFO", "STATUS_PEGAWAI_ID");
		$aColumnsAlias = array("NAMA", "LINK_URL_INFO", "STATUS_PEGAWAI_ID");
	...
	function add()
	{
		...
		{
			$set->setField('STATUS_PEGAWAI_ID',$reqId);
			$set->setField("LAST_USER", $this->LOGIN_USER);
			$set->setField("USER_LOGIN_ID", $this->LOGIN_ID);
			$set->setField("USER_LOGIN_PEGAWAI_ID", ValToNullDB($this->LOGIN_PEGAWAI_ID));
			$set->setField("LAST_DATE", "NOW()");
	...
	function log() 
	{
		$this->load->model('StatusPegawaiLog');

		$set = new StatusPegawaiLog();
