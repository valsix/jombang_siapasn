...
class klasifikasi_json extends CI_Controller {
	...
	function json() 
	{
		...
		$aColumns = array("KODE", "NAMA", "KLASIFIKASI_ID");
		$aColumnsAlias = array("KODE", "NAMA", "KLASIFIKASI_ID");
		...
		if ( isset( $_GET['iSortCol_0'] ) )
		{
			...
			if (trim($sOrder) == "ORDER BY KODE desc")
			{
				/*
		...
		$searchJson = " AND (UPPER(NAMA) LIKE '%".strtoupper($_GET['sSearch'])."%' OR UPPER(KODE) LIKE '%".strtoupper($_GET['sSearch'])."%')";
	...
	function add()
	{
		...
		$reqKlasifikasiParentId= $this->input->post("reqKlasifikasiParentId");
		$reqKode= $this->input->post("reqKode");
		$reqNama= $this->input->post("reqNama");
		
		$set->setField('KLASIFIKASI_PARENT_ID', $reqKlasifikasiParentId);
		...
		{
			$set->setField('KLASIFIKASI_ID', $reqId); 
			// $set->setField("LAST_USER", $this->LOGIN_USER);
			// $set->setField("LAST_DATE", "NOW()");
	...
	function log() 
	{
		...
		$aColumns = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "KLASIFIKASI_ID");
		$aColumnsAlias = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "KLASIFIKASI_ID");
