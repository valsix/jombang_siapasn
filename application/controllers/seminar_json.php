...
class seminar_json extends CI_Controller {
	...
	function delete()
	{
		...
		$set->setField("USER_LOGIN_PEGAWAI_ID", ValToNullDB($this->LOGIN_PEGAWAI_ID));
		$set->setField("LAST_DATE", "NOW()");
		$set->setField("SEMINAR_ID", $reqId);
		
		if($reqMode == "seminar_0")
		{
	...
	{	
		...
		$aColumns = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "SEMINAR_ID");
		$aColumnsAlias = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "SEMINAR_ID");
		...
		$arrayWhere = array("SEMINAR_ID" => $riwayatId);
