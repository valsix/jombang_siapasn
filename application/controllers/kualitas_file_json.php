...
class kualitas_file_json extends CI_Controller {
	...
	function json() 
	{
		...
		$aColumns = array("NAMA", "LINK_URL_INFO", "KUALITAS_FILE_ID");
		$aColumnsAlias = array("NAMA", "LINK_URL_INFO", "KUALITAS_FILE_ID");
	...
	function add()
	{
		...
		{
			$set->setField('KUALITAS_FILE_ID', $reqId); 
			$set->setField("LAST_USER", $this->LOGIN_USER);
			$set->setField("USER_LOGIN_ID", $this->LOGIN_ID);
			$set->setField("USER_LOGIN_PEGAWAI_ID", ValToNullDB($this->LOGIN_PEGAWAI_ID));
			$set->setField("LAST_DATE", "NOW()");
	...
	function delete()
	{
		...
		elseif($reqMode == "kualitas_file_1")
		{
	...
	function log() 
	{	
		$this->load->model('KualitasFileLog');

		$set = new KualitasFileLog();
		
		ini_set("memory_limit","500M");
		ini_set('max_execution_time', 520);
		
		
		$aColumns = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "KUALITAS_FILE_ID");
		$aColumnsAlias = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "KUALITAS_FILE_ID");
