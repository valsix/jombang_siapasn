...
class jenis_dokumen_json extends CI_Controller {
	...
	function json() 
	{
		...
		$aColumns = array("NAMA", "LINK_URL_INFO", "JENIS_DOKUMEN_ID");
		$aColumnsAlias = array("NAMA", "LINK_URL_INFO", "JENIS_DOKUMEN_ID");
	...
	function add()
	{
		...
		{
			$set->setField('JENIS_DOKUMEN_ID', $reqId); 
			$set->setField("LAST_USER", $this->LOGIN_USER);
			$set->setField("USER_LOGIN_ID", $this->LOGIN_ID);
			$set->setField("USER_LOGIN_PEGAWAI_ID", ValToNullDB($this->LOGIN_PEGAWAI_ID));
			$set->setField("LAST_DATE", "NOW()");
	...
	function delete()
	{
		...
		elseif($reqMode == "jenis_dokumen_1")
		{
