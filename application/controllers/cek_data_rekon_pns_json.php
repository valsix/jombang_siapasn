...
class cek_data_rekon_pns_json extends CI_Controller {
	...
	function json() 
	{
		...
		$aColumns = array("NIP_BARU", "NAMA", "HASIL_CEK", "NAMA_SATUAN_KERJA", "CEK_STATUS_SK_PNS", "CEK_PANGKAT_GAJI", "CEK_JURUSAN", "CEK_PPK", "SATUAN_KERJA_UPT");

		$aColumnsAlias = array("NIP_BARU", "NAMA", "HASIL_CEK", "NAMA_SATUAN_KERJA", "CEK_STATUS_SK_PNS", "CEK_PANGKAT_GAJI", "CEK_JURUSAN", "CEK_PPK", "SATUAN_KERJA_UPT");
		...
		if ( isset( $_GET['iSortCol_0'] ) )
		{
			...
			if ( trim($sOrder) == "ORDER BY A.HASIL_CEK ASC" )
			{
				/*
				...
				*/
				$sOrder = "ORDER BY A.HASIL_CEK ASC";
		...
		//echo $set->query;exit;
		$sOrder= "";
		$set->selectByParamsRekapCekDataRekon(array(), $dsplyRange, $dsplyStart, $statement.$searchJson, $sOrder);
		// echo $set->query;exit;
		/* Output */
		$output = array(
