...
class agama_json extends CI_Controller {
	...
	function json() 
	{
		...
		$aColumns = array("NAMA", "LINK_URL_INFO", "AGAMA_ID");
		$aColumnsAlias = array("NAMA", "LINK_URL_INFO", "AGAMA_ID");
	...
	{	
		...
		$aColumns = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "AGAMA_ID");
		$aColumnsAlias = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "AGAMA_ID");
