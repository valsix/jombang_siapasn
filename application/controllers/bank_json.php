...
class bank_json extends CI_Controller {
	...
	function json() 
	{
		...
		$aColumns = array("NAMA", "LINK_URL_INFO", "BANK_ID");
		$aColumnsAlias = array("NAMA", "LINK_URL_INFO", "BANK_ID");
	...
	function log() 
	{
		...
		$aColumns = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "BANK_ID");
		$aColumnsAlias = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "BANK_ID");
