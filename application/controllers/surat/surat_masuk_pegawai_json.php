...
class surat_masuk_pegawai_json extends CI_Controller {
	...
	function json() 
	{
		...
		function json_upt() 
		{
			...
			// kalau pembatalan lewati
			// $statement.= " AND SMP.STATUS_BERKAS != 99";
		...
		function add_pensiun()
		{
			...
			$reqTmtPensiun= $this->input->post("reqTmtPensiun");
			// print_r($reqAnakId);exit;

			$reqPenilaianSkpJumlah= $this->input->post("reqPenilaianSkpJumlah");
			// kalau belum 2 maka tidak bisa simpan
			if($reqPenilaianSkpJumlah < 2)
			{
				echo "xxx-Data tidak bisa disimpan, karena penilaian SKP belum diisi minimal 2 tahun mundur dari tahun usulan.";
				exit;
			}
			...
			$set->setField('TMT_PENSIUN', dateToDBCheck($reqTmtPensiun));
			$set->setField("LAST_LEVEL", $this->LOGIN_LEVEL);
			$set->setField("LAST_USER", $this->LOGIN_USER);
			$set->setField("USER_LOGIN_ID", $this->LOGIN_ID);
			$set->setField("USER_LOGIN_PEGAWAI_ID", ValToNullDB($this->LOGIN_PEGAWAI_ID));
			...
			if($tempSimpan == 1)
			{
				...
				$vsimpanfilepegawai->simpansuamiistri($vpost, $reqPegawaiId);
				$vsimpanfilepegawai->simpananak($vpost, $reqPegawaiId);
		...
		function add_kenaikan_pangkat()
		{
			...
			$reqPegawaiId= $this->input->post("reqPegawaiId");
			$reqMode= $this->input->post("reqMode");
			$reqJabatanTambahanAkhirId= $this->input->post("reqJabatanTambahanAkhirId");
			$reqJabatanRiwayatAkhirId= $this->input->post("reqJabatanRiwayatAkhirId");
			$reqPendidikanRiwayatAkhirId= $this->input->post("reqPendidikanRiwayatAkhirId");
			$reqGajiRiwayatAkhirId= $this->input->post("reqGajiRiwayatAkhirId");
			$reqPangkatRiwayatAkhirId= $this->input->post("reqPangkatRiwayatAkhirId");
			...
			$reqKpStatusStruktural= $this->input->post("reqKpStatusStruktural");
			$reqKpDiklatId= $this->input->post("reqKpDiklatId");
			$reqKpDiklatStrukturalId= $this->input->post("reqKpDiklatStrukturalId");
			// echo $reqKpDiklatStrukturalId;exit();

			$reqKpJenis= $this->input->post("reqKpJenis");
			$reqKpPangkatId= $this->input->post("reqKpPangkatId");
			$reqKpStatusSuratTandaLulus= $this->input->post("reqKpStatusSuratTandaLulus");
			$reqKpSuratTandaLulusId= $this->input->post("reqKpSuratTandaLulusId");
			$reqKpStatusPendidikanRiwayatBelumDiakui= $this->input->post("reqKpStatusPendidikanRiwayatBelumDiakui");
			$reqKpPendidikanRiwayatBelumDiakuiId= $this->input->post("reqKpPendidikanRiwayatBelumDiakuiId");
			$reqKpPegawaiFileId= $this->input->post("reqKpPegawaiFileId");

			$reqKpPakLamaId= $this->input->post("reqKpPakLamaId");
			$reqKpPakBaruId= $this->input->post("reqKpPakBaruId");
			$reqKpStatusSertifikatKeaslian= $this->input->post("reqKpStatusSertifikatKeaslian");
			$reqKpPegawaiFileSertifikatKeaslianId= $this->input->post("reqKpPegawaiFileSertifikatKeaslianId");
			$reqKpStatusSertifikatPendidik= $this->input->post("reqKpStatusSertifikatPendidik");
			$reqKpPegawaiFileSertifikatPendidikId= $this->input->post("reqKpPegawaiFileSertifikatPendidikId");

			$reqKpPakPertamaStatusId= $this->input->post("reqKpPakPertamaStatusId");
			$reqKpStatusPendidikanRiwayatCantumGelar= $this->input->post("reqKpStatusPendidikanRiwayatCantumGelar");
			$reqKpStatusPendidikanRiwayatIjinTugas= $this->input->post("reqKpStatusPendidikanRiwayatIjinTugas");
			...
			$set->setField("PEGAWAI_ID", $reqPegawaiId);
			$set->setField("STATUS_BERKAS", "1");
			$set->setField("JABATAN_TAMBAHAN_AKHIR_ID", ValToNullDB($reqJabatanTambahanAkhirId));
			$set->setField("JABATAN_RIWAYAT_AKHIR_ID", ValToNullDB($reqJabatanRiwayatAkhirId));
			$set->setField("JABATAN_RIWAYAT_SEKARANG_ID", ValToNullDB($req));
			$set->setField("PENDIDIKAN_RIWAYAT_AKHIR_ID", ValToNullDB($reqPendidikanRiwayatAkhirId));
			$set->setField("PENDIDIKAN_RIWAYAT_SEKARANG_ID", ValToNullDB($reqPendidikanRiwayatSekarangId));
			...
			if($reqKpJenis == "kpstruktural")
			{
				if($reqKpStatusStruktural == "1")
				{
					$reqKpDiklatId= $reqKpDiklatStrukturalId= "";
				}
				// elseif($reqKpStatusStruktural == "3")
				// {
				// 	$reqKpStatusSuratTandaLulus= $reqKpStatusStruktural;
				// 	$reqKpDiklatId= $reqKpDiklatStrukturalId= "";
				// }
				elseif($reqKpStatusStruktural == "2")
				{
					$reqKpStatusSuratTandaLulus= $reqKpSuratTandaLulusId= "";
				}
				// elseif($reqKpStatusStruktural == "4")
				// {
				// 	$reqKpDiklatId= $reqKpStatusStruktural;
				// 	$reqKpStatusSuratTandaLulus= $reqKpSuratTandaLulusId= "";
				// }
				elseif($reqKpStatusStruktural == "3")
				{
					$reqKpStatusSuratTandaLulus= "3";
					$reqKpDiklatId= "4";
					$reqKpDiklatStrukturalId= $reqKpSuratTandaLulusId= "";
				}
				else
				{
					$reqKpDiklatId= $reqKpDiklatStrukturalId= $reqKpStatusSuratTandaLulus= $reqKpSuratTandaLulusId= "";
				}
			}

			$set->setField("KP_JENIS", $reqKpJenis);
			$set->setField("KP_PANGKAT_ID", $reqKpPangkatId);

			$set->setField("KP_DIKLAT_ID", ValToNullDB($reqKpDiklatId));
			$set->setField("KP_DIKLAT_STRUKTURAL_ID", ValToNullDB($reqKpDiklatStrukturalId));

			$set->setField("KP_STATUS_SURAT_TANDA_LULUS", ValToNullDB($reqKpStatusSuratTandaLulus));
			$set->setField("KP_SURAT_TANDA_LULUS_ID", ValToNullDB($reqKpSuratTandaLulusId));
			$set->setField("KP_STATUS_PENDIDIKAN_RIWAYAT_BELUM_DIAKUI", ValToNullDB($reqKpStatusPendidikanRiwayatBelumDiakui));
			$set->setField("KP_PENDIDIKAN_RIWAYAT_BELUM_DIAKUI_ID", ValToNullDB($reqKpPendidikanRiwayatBelumDiakuiId));
			$set->setField("KP_PEGAWAI_FILE_ID", ValToNullDB($reqKpPegawaiFileId));

			$set->setField("KP_PAK_LAMA_ID", ValToNullDB($reqKpPakLamaId));
			$set->setField("KP_PAK_BARU_ID", ValToNullDB($reqKpPakBaruId));
			$set->setField("KP_STATUS_SERTIFIKAT_KEASLIAN", ValToNullDB($reqKpStatusSertifikatKeaslian));
			$set->setField("KP_PEGAWAI_FILE_SERTIFIKAT_KEASLIAN_ID", ValToNullDB($reqKpPegawaiFileSertifikatKeaslianId));
			$set->setField("KP_STATUS_SERTIFIKAT_PENDIDIK", ValToNullDB($reqKpStatusSertifikatPendidik));
			$set->setField("KP_PEGAWAI_FILE_SERTIFIKAT_PENDIDIK_ID", ValToNullDB($reqKpPegawaiFileSertifikatPendidikId));

			$set->setField("KP_PAK_LAMA_STATUS", ValToNullDB($reqKpPakPertamaStatusId));
			$set->setField("KP_STATUS_PENDIDIKAN_RIWAYAT_CANTUM_GELAR", ValToNullDB($reqKpStatusPendidikanRiwayatCantumGelar));
			$set->setField("KP_STATUS_PENDIDIKAN_RIWAYAT_IJIN_TUGAS", ValToNullDB($reqKpStatusPendidikanRiwayatIjinTugas));
			...
			if($reqKpJenis == "kpreguler" || $reqKpJenis == "kpstruktural" || $reqKpJenis == "kpjft" || $reqKpJenis == "kppi" || $reqKpJenis == "kpbtugas" || $reqKpJenis == "kpstugas")
			{
				if($set->insertKenaikanPangkatReguler())
				{
					$tempSimpan=1;
					$reqRowId= $set->id;
				}
		...
		function add_kenaikan_pangkat_dinas()
		{
			$this->load->model('persuratan/SuratMasukPegawai');
	...
	function total_pegawai_upt() 
	{
		...
		if($tempJenisId == "3" || $tempJenisId == "4" || $tempJenisId == "7" || $tempJenisId == "10")
		{
			$statement= " AND A.STATUS_E_FILE_UPT IS NULL AND A.SURAT_MASUK_UPT_ID = ".$reqId;
			$infovalid= $set->getCountByParams(array(), $statement);
		}
		...
		if($tempData > 1 || $tempJenis == "7" || $tempJenis == "10")
		{
