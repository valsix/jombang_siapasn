...
class mailbox_kategori_json extends CI_Controller {
	...
	function json() 
	{
		...
		$aColumns = array("JENIS_PELAYANAN_NAMA", "NAMA", "SATUAN_KERJA_NAMA", "LINK_URL_INFO", "MAILBOX_KATEGORI_ID");
		$aColumnsAlias = array("JENIS_PELAYANAN_NAMA", "NAMA", "SATUAN_KERJA_NAMA", "LINK_URL_INFO", "MAILBOX_KATEGORI_ID");
	...
	function add()
	{
		...
		$set->setField('JENIS_PELAYANAN_ID', ValToNullDB($reqJenisPelayananId));
		...
		{
			$set->setField('MAILBOX_KATEGORI_ID', $reqId); 
			$set->setField("LAST_USER", $this->LOGIN_USER);
			$set->setField("USER_LOGIN_ID", $this->LOGIN_ID);
			$set->setField("USER_LOGIN_PEGAWAI_ID", ValToNullDB($this->LOGIN_PEGAWAI_ID));
			$set->setField("LAST_DATE", "NOW()");
	...
	function delete()
	{
		...
		elseif($reqMode == "mailbox_kategori_1")
		{
	...
	function combo() 
	{
		...
		while($set->nextRow())
		{
			$arr_json[$i]['id'] = $set->getField("MAILBOX_KATEGORI_ID");
	...
	function log() 
	{	
		$this->load->model('MailboxKategoriLog');

		$set = new MailboxKategoriLog();

		ini_set("memory_limit","500M");
		ini_set('max_execution_time', 520);


		$aColumns = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "MAILBOX_KATEGORI_ID");
		$aColumnsAlias = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "MAILBOX_KATEGORI_ID");
