...
class penilaian_skp_json extends CI_Controller {
	...
	function add()
	{
		...
		$reqNilaiHasilPerilaku= $this->input->post('reqNilaiHasilPerilaku');	
		...
		//SEMESTER 2
		$set->setField("JENIS_JABATAN_DINILAI2", $reqPegawaiJenisJabatan2);
		...
		$set->setField("NILAI_HASIL_KERJA", ValToNullDB(CommaToDot($reqNilaiHasilKerja)));
		$set->setField("NILAI_HASIL_PERILAKU", ValToNullDB(CommaToDot($reqNilaiHasilPerilaku)));
