		...
		if(!empty($reqUser) AND !empty($reqPasswd))
		{
			...
			if($respon == 1)
			{
				...
				if($set_detil->insert())
				{
					...
					$checkloginid= $this->kauth->getInstance()->getIdentity()->INFO_SIPETA;
					// kondisi kalau admin saja
					//if($checkloginid == "0")

					// if($checkloginid == "1" || $checkloginid == "411" || $checkloginid == "359" || $checkloginid == "376" || $checkloginid == "524" || $checkloginid == "516")
					if(!empty($checkloginid))
					{
