...
class surat_masuk_json extends CI_Controller {
	...
	function json() 
	{
		...
		$aColumns = array("NOMOR", "KEPADA", "PERIHAL", "SATUAN_KERJA_ASAL_NAMA", "SATUAN_KERJA_TUJUAN_NAMA", "TANGGAL", "TANGGAL_DITERUSKAN", "TANGGAL_BATAS", "SURAT_MASUK_ID");
		$aColumnsAlias = array("NOMOR", "KEPADA", "PERIHAL", "SATUAN_KERJA_ASAL_NAMA", "SATUAN_KERJA_TUJUAN_NAMA", "TANGGAL", "TANGGAL_DITERUSKAN", "TANGGAL_BATAS", "SURAT_MASUK_ID");
	...
	function add()
	{
		...
		$reqTgl = $this->input->post("reqTgl");
		$reqTglDiteruskan = $this->input->post("reqTglDiteruskan");
		$reqTglBatas = $this->input->post("reqTglBatas");
		$reqKepada = $this->input->post("reqKepada");
		$reqPerihal = $this->input->post("reqPerihal");
		$reqSatkerTujuanId = $this->input->post("reqSatkerTujuanId");
		$reqSatkerAsalId = $this->input->post("reqSatkerAsalId");
		
		$set->setField('NOMOR', $reqNomor);
		$set->setField('NO_AGENDA', $reqAgenda);
		$set->setField('TANGGAL', dateToDBCheck($reqTgl));
		$set->setField('TANGGAL_DITERUSKAN', dateToDBCheck($reqTglDiteruskan));
		$set->setField('TANGGAL_BATAS', dateToDBCheck($reqTglBatas));
		$set->setField('KEPADA', $reqKepada);
		$set->setField('PERIHAL', $reqPerihal);
		$set->setField('SATUAN_KERJA_TUJUAN_ID', ValToNullDB($reqSatkerTujuanId));
		$set->setField('SATUAN_KERJA_ASAL_ID', ValToNullDB($reqSatkerAsalId));
		...
		{
			$set->setField('SURAT_MASUK_ID', $reqRowId); 
			if($set->update())
			{
				echo $reqRowId."-Data berhasil disimpan.";
			}
