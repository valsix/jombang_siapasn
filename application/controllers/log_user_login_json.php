...
class log_user_login_json extends CI_Controller {
	...
	function json() 
	{
		...
		$aColumns = array("LAST_DATE", "IP_ADDRESS", "KETERANGAN", "LAST_USER");
		$aColumnsAlias = array("LAST_DATE", "IP_ADDRESS", "KETERANGAN", "LAST_USER");
		...
		$searchJson =  " AND (UPPER(A.KETERANGAN) LIKE '%".strtoupper($_GET['sSearch'])."%' OR UPPER(A.LAST_USER) LIKE '%".strtoupper($_GET['sSearch'])."%')";
