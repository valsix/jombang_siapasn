...
class kgb_peraturan_json extends CI_Controller {
	...
	function json() 
	{
		...
		$aColumns = array('MULAI_BERLAKU', 'AKHIR_BERLAKU', 'NAMA', 'KGB_PERATURAN_ID');
		$aColumnsAlias = array('MULAI_BERLAKU', 'AKHIR_BERLAKU', 'NAMA', 'KGB_PERATURAN_ID');
		...
		if ( isset( $_GET['iSortCol_0'] ) )
		{
			...
			if ( trim($sOrder) == " ORDER BY KGB_PERATURAN_ID asc " )
			{
				/*
				...
				*/
				$sOrder = " ORDER BY KGB_PERATURAN_ID ASC ";
	...
	function add()
	{
		...
		{
			$set->setField('KGB_PERATURAN_ID', $reqId); 
	...
	function log() 
	{
		$this->load->model('KgbPeraturanLog');

		$set = new KgbPeraturanLog();
		
		ini_set("memory_limit","500M");
		ini_set('max_execution_time', 520);
		
		
		$aColumns = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "KGB_PERATURAN_ID");
		$aColumnsAlias = array("INFO_LOG", "LAST_USER", "LAST_DATE", "STATUS_NAMA", "KGB_PERATURAN_ID");
