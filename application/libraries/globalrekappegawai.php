...
class globalrekappegawai
{
	function getsessionuser()
	{
		...
		$sessioninfosepeta= $CI->kauth->getInstance()->getIdentity()->INFO_SIPETA;
	...
	function getparampegawai($arrparam)
	{
		...
		if(empty($satuankerjaid))
		{
			...
			if($reqSatuanKerjaId == "")
			{
				if(isStrContain(strtoupper($sessionusergroup), "TEKNIS") == "1" || $sessionstatussatuankerjabkd == 1 || $sessioninfosepeta == "sipeta_all")
				{
