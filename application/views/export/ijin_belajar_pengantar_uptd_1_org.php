...
$tempJumlahOrang= $set->getCountByParamsCetakPengantarSatuOrang(array(), $statement);
...
<body>
	...
	<div class="row content" style="margin-top:30px; text-align: justify;">
		&emsp;&emsp;&emsp;Bersama ini kami sampaikan permohonan izin / tugas belajar dari <?=$reqSuratSatuanKerjaPengirimNama?> 
		sebagaimana sudah memenuhi syarat dan ketentuan sesuai Perbup Nomor 9 tahun 2011  tentang Persyaratan Mengikuti 
		Pendidikan dan Pelatihan, Tugas Belajar dan Izin Belajar Bagi Pegawai Negeri Sipil Daerah Pemerintah Kabupaten 
	...
	<div class="row content" style="margin-top:30px; text-align:justify">
		<table>
			<tr>
				...
				<?php /*?><td width="30%">Nama</td>
				<td width="5%">:</td>
				<td width="65%"><?=$reqPegawaiNamaLengkap?></td><?php */?>
			</tr>
			<tr>
				<td>NIP</td>
				<td>:</td>
			...
			<tr>
				...
				<td style="vertical-align:top"><?=$reqPegawaiSatuanKerja?></td>
			</tr>
			<tr>
