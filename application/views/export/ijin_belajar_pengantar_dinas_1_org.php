...
<body>
	<div id="container">
		...
		<div class="row content" style="margin-top:30px; text-align: justify;">
			&emsp;&emsp;&emsp;Bersama ini kami sampaikan permohonan izin / tugas belajar dari <?=$reqSuratSatuanKerjaPengirimNama?> sebagaimana sudah 
			memenuhi syarat dan ketentuan sesuai Perbup Nomor 9 tahun 2011  tentang Persyaratan Mengikuti 
			Pendidikan dan Pelatihan, Tugas Belajar dan Izin Belajar Bagi Pegawai Negeri Sipil Daerah 
		...
		<div class="row content" style="margin-top:30px; text-align:justify">
			<table>
				<tr>
					<td width="35%">Nama</td>
					<td width="5%">:</td>
					<td width="65%"><?=$reqPegawaiNamaLengkap?></td>
				</tr>
				<tr>
					<td>NIP</td>
					<td>:</td>
