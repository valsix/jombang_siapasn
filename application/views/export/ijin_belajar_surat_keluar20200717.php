					...
					<td>
                    	<table>
                            ...
                            <tr>
                                ...
                                <td style="text-align: justify">Surat Kepala Dinas Pendidikan Kabupaten Jombang tanggal <?=$reqSuratTanggal?> nomor : <?=$reqSuratNomor?> perihal Permohonan Izin Belajar.</td>
                            </tr>
                        </table>
					</td>
				</tr>
			...
			<table>
				<tr>
					...
					<td style="text-align: justify">
						<p>
							Mengikuti pendidikan Program <?=$reqPegawaiPendidikanUsulanNama?> program studi / jurusan pendidikan <?=$reqPegawaiPendidikanUsulanJurusan?>  pada <?=$reqPegawaiPendidikanUsulanNamaSekolah?> <?=$reqPegawaiPendidikanUsulanTempat?>, dengan ketentuan sebagai berikut : 
						</p>
