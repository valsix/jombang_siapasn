		...
		<div class="row content" style="text-align: justify;">
			<table style="text-align: justify; padding-left: -2px;">
				<tr>
					...
					<td>1.</td>
					<td>Sesuai dengan ketentuan Pasal 306 Peraturan Pemerintah Nomor 11 Tahun 20I7 tentang Manajemen Pegawai Negeri Sipil, <?=$infohal1?> ditetapkan oleh Presiden / PPK setelah mendapat pertimbangan teknis Kepala Badan Kepegawaian Negara.</td>
				</tr>
				<tr>
					<!-- pemberian pensiun PNS/pensiun janda/duda PNS -->
					<td>2.</td>
					<td>Berkenaan dengan hal tersebut, bersama ini disampaikan dengan hormat permohonan pertimbangan teknis <?=$infohal2?> atas nama <?=$reqPegawaiNamaLengkap?> NIP. <?=$reqPegawaiNipBaru?><?
					if($reqJumlahUsulanPegawai > 1)
					{
					?> 
					dkk
					...
					?>, sebanyak <?=$reqJumlahUsulanPegawai?> orang.</td>
				</tr>
				<tr>
					<td>3.</td>
					<td>Sebagai bahan pertimbangan, kami sampaikan kelengkapan bahan sebagaimana terlampir sesuai ketentuan peraturan perundang-undangan.</td>
				</tr>
				<tr>
					<td>4.</td>
					<td>Demikian atas bantuan dan kerjasamanya disampaikan terima kasih.</td>
				</tr>
			</table>
		</div>
