...
while($set->nextRow())
{
  ...
  $arrInfo[$index_data]["KP_JENIS_NAMA"] = $set->getField("KP_JENIS_NAMA");
  $arrInfo[$index_data]["PANGKAT_RIWAYAT_NAMA"] = $set->getField("PANGKAT_RIWAYAT_NAMA");
  $arrInfo[$index_data]["PANGKAT_RIWAYAT_KODE"] = $set->getField("PANGKAT_RIWAYAT_KODE");
  $arrInfo[$index_data]["PANGKAT_RIWAYAT_TMT"] = getFormattedDateJson($set->getField("PANGKAT_RIWAYAT_TMT"));
  $arrInfo[$index_data]["USULAN_PANGKAT_RIWAYAT_NAMA"] = $set->getField("USULAN_PANGKAT_RIWAYAT_NAMA");
  $arrInfo[$index_data]["USULAN_PANGKAT_RIWAYAT_KODE"] = $set->getField("USULAN_PANGKAT_RIWAYAT_KODE");
  $arrInfo[$index_data]["USULAN_PANGKAT_RIWAYAT_TMT"] = getFormattedDateJson($set->getField("USULAN_PANGKAT_RIWAYAT_TMT"));
...
<table border="0" cellspacing="0" cellpadding="0" width="1171">
  <tr>
    ...
    <tr>
      <td colspan="4" style="text-align:center"><br/>DAFTAR NAMA USUL KENAIKAN PANGKAT<br/><br/><br/></td>
    </tr>
</table>
...
<div class="area-rekap-gaji">
  <table border="0" cellspacing="0" cellpadding="0" width="1171" class="myTable">
    <thead>
    <tr>
      <td rowspan="2" style="text-align:center; font-size: 14px;" class="garisleft garistop garisbottom" width="37"><p align="center"><strong>No</strong></p></td>
      <td rowspan="2" style="text-align:center; font-size: 14px;" class="garisleft garistop garisbottom" width="156"><p align="center"><strong>NAMA / NIP</strong></p></td>
      <td colspan="2" style="text-align:center; font-size: 14px;" class="garisleft garistop garisbottom" width="222"><p align="center"><strong>PANGKAT / GOLONGAN RUANG</strong></p></td>
      <td rowspan="2" style="text-align:center; font-size: 14px;" class="garisleft garistop garisbottom" width="156"><p align="center"><strong>JABATAN</strong></p></td>
      <td rowspan="2" style="text-align:center; font-size: 14px;" class="garisleft garisright garistop garisbottom" width="106"><p align="center"><strong>JENIS KENAIKAN PANGKAT</strong></p></td>
    </tr>
    <tr>
      <td style="text-align:center; font-size: 14px;" class="garisleft garistop garisbottom" width="100"><p align="center"><strong>LAMA (TMT)</strong></p></td>
      <td style="text-align:center; font-size: 14px;" class="garisleft garistop garisbottom" width="100"><p align="center"><strong>BARU (TMT)</strong></p></td>
    </tr>
    </thead>
    <tbody>
    <?
    ...
    <tr>
      ...
      <td style="padding:6px; font-size: 14px;" class="garisleft garisbottom" width="156"><p><?=$arrInfo[$index_data]["NAMA_LENGKAP"]?><br/><?=$arrInfo[$index_data]["NIP_BARU"]?></p></td>
      <td style="padding:6px; font-size: 14px;" class="garisleft garisbottom" width="222"><p><?=$arrInfo[$index_data]["PANGKAT_RIWAYAT_NAMA"]?><br><?=$arrInfo[$index_data]["PANGKAT_RIWAYAT_KODE"]?><br><?=$arrInfo[$index_data]["PANGKAT_RIWAYAT_TMT"]?></p></td>
      <td style="padding:6px; font-size: 14px;" class="garisleft garisbottom" width="222"><p><?=$arrInfo[$index_data]["USULAN_PANGKAT_RIWAYAT_NAMA"]?><br><?=$arrInfo[$index_data]["USULAN_PANGKAT_RIWAYAT_KODE"]?><br><?=$arrInfo[$index_data]["USULAN_PANGKAT_RIWAYAT_TMT"]?></p></td>
      <td style="padding:6px; font-size: 14px;" class="garisleft garisbottom" width="222"><p><?=$arrInfo[$index_data]["JABATAN_RIWAYAT_NAMA"]?></p></td>
      <td style="padding:6px; font-size: 14px;" class="garisleft garisright garisbottom" width="222"><p><?=$arrInfo[$index_data]["KP_JENIS_NAMA"]?></p></td>
    </tr>
    <?
    $nomor++;
    }
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="1171" class="myTable">
    ...
    <tr>
      ...
      <td colspan="2" style="text-align:center; font-size: 14px;" class="garisleft garistop garisbottom" width="222"><p align="center"><strong>PANGKAT / GOLONGAN RUANG</strong></p></td>
      <td rowspan="2" style="text-align:center; font-size: 14px;" class="garisleft garistop garisbottom" width="156"><p align="center"><strong>JABATAN</strong></p></td>
      <td rowspan="2" style="text-align:center; font-size: 14px;" class="garisleft garistop garisright garisbottom" width="106"><p align="center"><strong>JENIS KENAIKAN PANGKAT</strong></p></td>
    </tr>
    <tr>
      <td style="text-align:center; font-size: 14px;" class="garisleft garistop garisbottom" width="100"><p align="center"><strong>LAMA (TMT)</strong></p></td>
      <td style="text-align:center; font-size: 14px;" class="garisleft garistop garisbottom" width="100"><p align="center"><strong>BARU (TMT)</strong></p></td>
