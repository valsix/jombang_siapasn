	...
	<div id="container">
		...
		<div class="row">
			<div class="col-6 float-l">
				<table>
					...
					<tr>
						...
						<td></td>
						<td>
							dkk <?php /*?>(<?=$reqJumlahUsulanPegawai?> orang)<?php */?>
						</td>
					</tr>
				</table>
			</div>
			<div class="col-6 float-r">
				...
				<div class="row" style="margin-left:20px">
					<div class="col-1 float-l">Cq. </div>
					<div class="col-11 float-l">
						Kepala <?=$reqSuratKepada?>
					</div>
				</div>
		...
		<div class="row content" style="margin-top:30px; text-align: justify;">
			&emsp;&emsp;&emsp;Bersama ini kami sampaikan permohonan ijin belajar dari <?=$reqSuratSatuanKerjaPengirimNama?> sebagaimana sudah 
