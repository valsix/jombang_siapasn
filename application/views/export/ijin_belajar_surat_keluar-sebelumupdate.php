...
$reqTtdNama= $set->getField('TTD_NAMA');
...
//$reqPegawaiPendidikanUsulanJurusan= str_replace("S-3 ", '', $reqPegawaiPendidikanUsulanJurusan);
	...
	$arr = array("D-1","D-2","D-3","D-4","D-Iv","D-Iii","D-Ii","D-I","S-1","S-2","S-3");
	foreach ($arr as &$value) {
	    $reqPegawaiPendidikanUsulanJurusan = str_replace($value,'', $reqPegawaiPendidikanUsulanJurusan);
	}

	//revisi nama fakultas
	$arr = array("Fakultas","FAKULTAS");
	foreach ($arr as &$value) {
	    $reqPegawaiPendidikanUsulanFakultas = str_replace($value,'', $reqPegawaiPendidikanUsulanFakultas);
	}

	//revisi kapital nama sekolah
	$arr2 = array("Pgri","Upbjj", "Stie", "Stikes", " Ut ", "Upbjj-ut", "Wr ", "Iik", "(Ut)", "-Ut");
	foreach ($arr2 as &$value2) {
		$value2besar = strtoupper($value2);
	    $reqPegawaiPendidikanUsulanNamaSekolah = str_replace($value2,$value2besar, $reqPegawaiPendidikanUsulanNamaSekolah);
	}


	//revisi kapital nama jurusan
	$arr3 = array("Pgsd","Pgpaud","Pg Paud","Ners");
	foreach ($arr3 as &$value3) {
		$value3besar = strtoupper($value3);
	    $reqPegawaiPendidikanUsulanJurusan = str_replace($value3,$value3besar, $reqPegawaiPendidikanUsulanJurusan);
	}

	$reqPegawaiPendidikanUsulanJurusan = str_replace("PGPAUD","PG PAUD", $reqPegawaiPendidikanUsulanJurusan);

	if ($reqPegawaiPendidikanUsulanFakultas=="" OR $reqPegawaiPendidikanUsulanFakultas==" " OR $reqPegawaiPendidikanUsulanFakultas=="-")
	{
		$isiFakultas = " ";
	} else {
		$isiFakultas = " Fakultas ";
	}

	if ($reqPegawaiPendidikanIdUsulan == 9){ //D-III
		$reqPegawaiDataPendidikanUsul = "Program Diploma Tiga (D-III) program studi/jurusan ".$reqPegawaiPendidikanUsulanJurusan." pada ".$reqPegawaiPendidikanUsulanNamaSekolah." di ".$reqPegawaiPendidikanUsulanTempat;

	} elseif ($reqPegawaiPendidikanIdUsulan == 10) {//D-IV
		$reqPegawaiDataPendidikanUsul = "Program Diploma IV program studi/jurusan ".$reqPegawaiPendidikanUsulanJurusan." pada ".$reqPegawaiPendidikanUsulanNamaSekolah." di ".$reqPegawaiPendidikanUsulanTempat;

	} elseif ($reqPegawaiPendidikanIdUsulan == 11) {//S-1

		$reqPegawaiDataPendidikanUsul = "Program Sarjana (S-1) program studi/jurusan ".$reqPegawaiPendidikanUsulanJurusan.$isiFakultas.$reqPegawaiPendidikanUsulanFakultas." pada ".$reqPegawaiPendidikanUsulanNamaSekolah." di ".$reqPegawaiPendidikanUsulanTempat;

	} elseif ($reqPegawaiPendidikanIdUsulan == 12) { //S-2
		$reqPegawaiDataPendidikanUsul = "Program Pascasarjana (S-2) program studi/jurusan ".$reqPegawaiPendidikanUsulanJurusan." pada ".$reqPegawaiPendidikanUsulanNamaSekolah." di ".$reqPegawaiPendidikanUsulanTempat;

	} elseif ($reqPegawaiPendidikanIdUsulan == 13) { //S-3
		$reqPegawaiDataPendidikanUsul = "Program Doktor (S3) program studi/jurusan ".$reqPegawaiPendidikanUsulanJurusan." pada ".$reqPegawaiPendidikanUsulanNamaSekolah." di ".$reqPegawaiPendidikanUsulanTempat;
	...
	//hacked cara cepat
	if($reqId==3852){
		$reqSuratSatuanKerjaPengirimKepala = "Kepala Bagian Umum Sekretariat Daerah";
	}

	if($reqSuratSatuanKerjaPengirimKepala == "Sekretaris Daerah Kabupaten Jombang"){
		$reqSuratSatuanKerjaPengirimKepala = "Kepala Bagian Umum Sekretariat Daerah";
	}

	$reqTtdNamaBesarAwal = ucwordsPertama($reqTtdNama);
					...
					<td>
                    	<table>
                        	<tr>
                                ...
                                <td style="vertical-align:top;text-align: justify">Peraturan Bupati Jombang Nomor 9 Tahun 2011 tentang Persyaratan Mengikuti Pendidikan dan Pelatihan (DIKLAT), Tugas Belajar dan Izin Belajar bagi Pegawai Negeri Sipil Daerah Pemerintah Kabupaten Jombang;</td>
                            </tr>
                            <tr>
                            	<td style="vertical-align:top">2.</td>
                                <td style="vertical-align:top;text-align: justify">Surat <?=$reqSuratSatuanKerjaPengirimKepala ?> Kabupaten Jombang Nomor : <?=$reqSuratNomor?> tanggal <?=$reqSuratTanggal?> perihal <?=$reqSuratPerihal?>.</td>
                            </tr>
                        </table>
					</td>
				</tr>
			...
			<table>
				<tr>
					...
					<td>
						<table>
							<tr>
								<td colspan="3">Pegawai Negeri Sipil,</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td valign="top">:</td>
								<td valign="top"><?=$reqPegawaiPendidikanNama?></td>
							</tr>
							<tr>
								<td valign="top">Jabatan</td>
								<td valign="top">:</td>
								<td valign="top"><?=$reqPegawaiJabatanNama?></td>
							</tr>
							<tr>
					...
					<td style="text-align: justify">
                        ...
                        <table style="width:100%">
                            ...
                            <tr>
                                ...
                                <td>Setelah menyelesaikan pendidikan / lulus wajib melaporkan kelulusannya ke <?=$reqTtdNamaBesarAwal?> Kabupaten Jombang;</td>
                            </tr>
                            <tr>
