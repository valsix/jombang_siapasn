...
elseif($reqStatusBkdUptId == "3")
{
	...
	$reqJumlahUsulanPegawai= $set->getField('JUMLAH_USULAN_KANREG_PEGAWAI');
	$reqJenisKarisKarsu= $set->getField('JENIS_KARIS_KARSU');
	$reqJenisNamaKarisKarsu= $set->getField('JENIS_KARIS_KARSU');
...
$tempInfoKarisKarsu= "Karis";
$tempInfoSdr= "Saudara";
if($reqJenisKelamin == "L"){}
else
{
	$tempInfoKarisKarsu= "Karsu";
	$tempInfoSdr= "Saudari";
}
...
<body>
	<div id="container">
			...
			<div class="col-12">
				<table style="width:100%; margin-left:-50px">
					...
					<tr>
						...
						<td>:</td>
						<td>
							Permohonanan <?=$tempInfoKarisKarsu?>
						</td>
                        <td style="padding-left:31px; ">
							<?
							if($reqStatusBkdUptId == "3")
		...
		<div class="row content" style="margin-top:30px; text-align: justify;">
			&emsp;&emsp;&emsp;Bersama ini kami sampaikan berkas permohonan Penerbitan Kartu <?=$reqJenisNamaKarisKarsu?> <?=$tempInfoSdr?> : 
		</div>
