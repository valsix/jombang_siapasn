...
<body>
	<div id="container">
		...
		<div class="row content" style="margin-top:30px; text-align: justify;">
			&emsp;&emsp;&emsp;Bersama ini kami sampaikan permohonan izin / tugas belajar dari <?=$reqSuratSatuanKerjaPengirimNama?> sebagaimana 
			sudah memenuhi syarat dan ketentuan sesuai Perbup Nomor 9 tahun 2011  tentang Persyaratan Mengikuti Pendidikan dan Pelatihan, Tugas Belajar dan Izin Belajar Bagi Pegawai Negeri Sipil Daerah Pemerintah Kabupaten Jombang dan ketentuan lainnya, atas <?=$reqPegawaiNamaLengkap?>, NIP <?=$reqPegawaiNipBaru?>, dkk sebanyak <?=reqJumlahUsulanPegawai?> orang.
		</div>
