...
<body>
	<div id="container">
			...
			<div class="col-12">
				<table style="width:100%; margin-left:-50px">
					...
					<tr>
						...
						<td></td>
						<td>
							<?=$reqJenisKarisKarsu?> karena <?=$reqPermohonan?> 
						</td>
		...
		<div class="row content" style="margin-top:30px; text-align: justify;">
			&emsp;&emsp;&emsp;Sehubungan dengan surat laporan Kehilangan Kartu <?=$reqJenisNamaKarisKarsu?> : 
		</div>
		...
		<div class="row content" style="text-align: justify;">
			maka dengan ini kami mohon diterbitkan kembali Kartu <?=$reqJenisNamaKarisKarsu?> (<?=$reqJenisKarisKarsu?>) yang bersangkutan dan sebagai bahan pertimbangan dilampirkan berkas persyaratan sebagai berikut : 
		</div>
		<div class="row content" style="text-align: justify;">
			<table>
				<tr>
				...
				<tr>
					<td>7.</td>
					<td>Foto Copy <?=$reqJenisKarisKarsu?></td>
				</tr>
			</table>
		</div>
		<div class="row content" style="">
