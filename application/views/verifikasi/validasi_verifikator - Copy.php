...
<head>
	...
	<script type="text/javascript" charset="utf-8">
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("validasi/pegawai_json/json?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqStatusPegawaiId="+reqStatusPegawaiId+"&sSearch="+reqCariFilter);
		});
		...
		<div class="wrapper">
			...
			<section id="content-full">
				...
				<div class="area-parameter no-marginbottom">
					...
					<div id="settoggle">
						<div class="row">
							<input type="" id="reqStatusPegawaiId" value="" />
							...
							<div class="col s7 m5">
								<select class="option-vw9" id="reqStatusPegawaiId">
									...
									<option value="12" selected>CPNS/PNS</option>
