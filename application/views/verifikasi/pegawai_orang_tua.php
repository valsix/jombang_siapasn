...
$this->load->model('validasi/OrangTua');
...
$reqRowId= $ayah->getField('ORANG_TUA_ID');
...
<head>
 ...
 <script type="text/javascript"> 
  $(function(){
    $('#ff').form({
      url:'validasi/orang_tua_json/add',
      onSubmit:function(){
      ...
      <div class="col s12 m10 offset-m1 ">
       <form id="ff" method="post" enctype="multipart/form-data">
        ...
        <ul class="collection card">
          <li class="collection-item ubah-color-warna"><?=$infoperubahan?> ORANG TUA</li>
