...
$arrtabledata= array(
  ...
  , array("label"=>"Nama", "field"=> "NAMA_LENGKAP", "display"=>"",  "width"=>"400", "colspan"=>"", "rowspan"=>"")
  ...
  <div class="container fiori-container">
    <div class="page-title-wrapper">
      <div class="page-title-heading">
        <div> Perumpunan<div class="page-title-subheading">List Data Perumpunan</div>
        </div>
      </div>
    ...
    $(function(){
      ...
      $('#clicktoggle').trigger('click');
        ...
        $("#btncetak").on("click", function () {
          ...
          newWindow = window.open("app/loadUrl/app/talenta_perumpunan_excel.php?reqBulan=<?=date('m')?>&reqTahun=<?=date('Y')?>&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqStatusPegawaiId="+reqStatusPegawaiId+"&reqUrutkan="+reqUrutkan+"&reqUrutkanVal="+reqUrutkanVal+"&sSearch="+reqCariFilter, 'Cetak');
          newWindow.focus();
        });
        ...
        $('#btnCari').on('click', function () {
          ...
          jsonurl= "json/talenta_json/jsonperumpunan?reqPencarian="+reqPencarian+"&reqGlobalValidasiCheck="+reqGlobalValidasiCheck;
