  ...
  <div class="container fiori-container">
    <div class="page-title-wrapper">
      <div class="page-title-heading">
        <div> Kualifikasi <div class="page-title-subheading">List Data Kualifikasi</div>
        </div>
      </div>
    ...
    $(function(){
      ...
      $('#clicktoggle').trigger('click');
        ...
        $("#btncetak").on("click", function () {
          ...
          newWindow = window.open("app/loadUrl/app/talenta_kualifikasi_excel.php?reqBulan=<?=date('m')?>&reqTahun=<?=date('Y')?>&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqStatusPegawaiId="+reqStatusPegawaiId+"&sSearch="+reqCariFilter, 'Cetak');
          newWindow.focus();
        });
