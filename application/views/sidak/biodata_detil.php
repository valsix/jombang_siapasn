...
$set->selectpetatalent(array(), -1,-1, $statement);
$set->firstRow();
$reqId= $set->getField("PEGAWAI_ID");
$reqKotakRumpun= $set->getField("KOTAK_RUMPUN");
...
if(empty($infopegawaiimage) || !file_exists($infopegawaiimage))
...
$reqIntegritasNilai= $set->getField("INTEGRITAS_NILAI");
$reqKerjasamaNilai= $set->getField("KERJASAMA_NILAI");
$reqKomunikasiNilai= $set->getField("KOMUNIKASI_NILAI");
$reqOrientasiNilai= $set->getField("ORIENTASI_NILAI");
$reqPelayananPublikNilai= $set->getField("PELAYANAN_PUBLIK_NILAI");
$reqPengembanganDiriNilai= $set->getField("PENGEMBANGAN_DIRI_NILAI");
$reqKelolaPerubahanNilai= $set->getField("KELOLA_PERUBAHAN_NILAI");
$reqAmbilKeputusanNilai= $set->getField("AMBIL_KEPUTUSAN_NILAI");
$reqPerekatBangsaNilai= $set->getField("PEREKAT_BANGSA_NILAI");
$reqSkorKompetensi= dotToComma($set->getField("SKOR_KOMPETENSI"));

$arrInfo= array(
  array("ATRIBUT_NAMA"=>"Integritas", "ATRIBUT_NILAI"=>$reqIntegritasNilai)
  , array("ATRIBUT_NAMA"=>"Kerjasama", "ATRIBUT_NILAI"=>$reqKerjasamaNilai)
  , array("ATRIBUT_NAMA"=>"Komunikasi", "ATRIBUT_NILAI"=>$reqKomunikasiNilai)
  , array("ATRIBUT_NAMA"=>"Orientasi Pada Hasil", "ATRIBUT_NILAI"=>$reqOrientasiNilai)
  , array("ATRIBUT_NAMA"=>"Pelayanan Publik", "ATRIBUT_NILAI"=>$reqPelayananPublikNilai)
  , array("ATRIBUT_NAMA"=>"Pengembangan diri dan Orang lain", "ATRIBUT_NILAI"=>$reqPengembanganDiriNilai)
  , array("ATRIBUT_NAMA"=>"Mengelola Perubahan", "ATRIBUT_NILAI"=>$reqKelolaPerubahanNilai)
  , array("ATRIBUT_NAMA"=>"Pengambilan Keputusan", "ATRIBUT_NILAI"=>$reqAmbilKeputusanNilai)
  , array("ATRIBUT_NAMA"=>"Perekat Bangsa", "ATRIBUT_NILAI"=>$reqPerekatBangsaNilai)
);
$jumlah_info= count($arrInfo);
...
$kinerjatanggal= dateToPageCheck($set->getField('TANGGAL_KOMPETENSI'));
$kinerjajabatan= $reqJabatanRiwayatNama;
$kinerjaunitkerja= $reqJabatanRiwayatUnitKerja;
$kinerjajpm= $reqSkorKompetensi;
$kinerjatahun= $set->getField('TAHUN');
// $kinerjaperilaku= $arrInfo[0]["NILAI_PERILAKU"];
$kinerjaprestasi= $reqPrestasiHasil;
...
$kinerjadeskripsi= $set->getField('DESKRIPSI');
...
while($set->nextRow())
{
  ...
  $arrInfo[$index_data]["JPM"] = $set->getField("JPM");
...
// echo $kinerjakekurangan;exit;
  ...
  // $kinerjajpm = $kinerjajpm*100;

  switch ($reqKotakRumpun) {
    case 1:
      $kuadranNama="Pegawai bermasalah (kinerja dibawah ekspektasi, kemungkinan salah penempatan)";
      break;
    case 2:
      $kuadranNama="Pekerja Keras Masa Depan (kinerja konsisten, kurang berpotensi posisi lebih tinggi, pekerjaan yang berbeda)";
      break;
    case 3:
      $kuadranNama="Pegawai Kurang Konsisten (kinerja dibawah ekspektasi, menguasai pekerjaan, kemungkinan bisa beradaptasi di situasi yang berbeda)";
      break;
    case 4:
      $kuadranNama="Pekerja Keras (kinerja diatas rata-rara, kurang berpotensi posisi lebih tinggi dan pekerjaan yang berbeda)";
      break;
    case 5:
      $kuadranNama="Pegawai Berpengalaman (kinerja konsisten, menguasai pekerjaan, dapat beradaptasi dengan perkerjaan yang berbeda)";
      break;
    case 6:
      $kuadranNama="Pegawai Berpotensi, Kinerja Tidak Konsisten (Menguasai pekerjaan sangat baik, hasil kinerja tidak konsisten)";
      break;
    case 7:
      $kuadranNama="Pegawai Profesional (Kinerja diatas rata-rata, menguasai pekerjaan dengan sangat baik, berpotensi untuk pekerjaan yang berbeda)";
      break;
    case 8:
      $kuadranNama="Pimpinan Masa Depan (Kompetensi diatas standar, menguasai pekerjaan, berpotensi ditempatkan di pekerjaan lain dengan kompetensi sama)";
      break;
    case 9:
      $kuadranNama="Pimpinan Tinggi Masa Depan (Berpotensi untuk dipromosikan ke level manajemen puncak)";
      break;
    default:
      echo "";
  }
...
<html lang="en">
  <head>
    ...
    <title><?=$infopegawainama?> - Biodata Detail</title>
    <base href="<?=base_url()?>" />
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="alert alert-success">KUADRAN <?=romanic_number($reqKotakRumpun)?></div>
        </div>
        <div class="col-md-8">
          <div class="alert alert-warning"><?=$kuadranNama?></div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-2">
          <div class="alert alert-info text-center" role="alert">
            <h4 style="margin-bottom: 0px;"><?=$kinerjajpm?></h4>
          </div>
          <div class="alert alert-info text-center" role="alert">
