      ...
      <div class="app-header header-shadow">
        <div class="container fiori-container">
          ...
          <ul class="horizontal-nav-menu">
            <li class="dropdown">
              <a data-offset="10" data-display="static" aria-expanded="false" class="active" href="sidak/index/rekam_jejak">
                <span>Rekam Jejak</span>
              </a>
            </li>
            <li class="dropdown">
              <a data-offset="10" data-display="static" aria-expanded="false" class="active" href="sidak/index/kualifikasi">
                <span>Kualifikasi</span>
              </a>
            </li>
            <li class="dropdown">
              <a data-offset="10" data-display="static" aria-expanded="false" class="active" href="sidak/index/pengembangan_kompetensi">
                <span>Pengembangan Kompetensi</span>
              </a>
            </li>
            <li class="dropdown">
              <a data-offset="10" data-display="static" aria-expanded="false" class="active" href="sidak/index/perumpunan">
                <span>Perumpunanan</span>
              </a>
            </li>
            <li class="dropdown">
              <a data-offset="10" data-display="static" aria-expanded="false" class="active" href="sidak/index/sidak_nilai_akhir">
                <span>Nilai Akhir</span>
              </a>
            </li>
            <li class="dropdown">
              <a data-offset="10" data-display="static" aria-expanded="false" class="active" href="sidak/index/peta">
                <span>Peta</span>
              </a>
            </li>
            <li class="dropdown">
