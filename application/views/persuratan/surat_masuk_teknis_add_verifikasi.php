          ...
          <table class="bordered striped md-text">
          	<thead> 
                ...
                <tr>
                    ...
                    <th class="green-text material-font hide-on-small-only" style="width:10%">Jurusan</th>
                    <th class="green-text material-font hide-on-small-only" style="width:1%">:</th>
                    <th class="green-text material-font hide-on-small-only"><?=$reqPendidikanJurusanUsulan?></th>
                </tr>
          ...
          elseif($tempInformasiTable == "PEGAWAI")
          {
            ...
            <div id="swipe-2" class="col s12" style="height:auto !important">
                ...
                <div class="iframe-container">
                  <iframe src="<?=$reqUrlFile?>" id="mainframe" allowfullscreen></iframe>
                </div>
...
/*
  // cetak revisi ijin belajar dari mas WANDA asli
...
*/
  // menyesuaikan sebelum revisi diarahkan ke ijin_belajar_surat_keluar
	$('button[id^="reqlogcetaksuratkeluar"]').click(function() { 
	  var id= $(this).attr('id');
	  var element= id.split('reqlogcetaksuratkeluar');
      var reqrowid= element[1];
