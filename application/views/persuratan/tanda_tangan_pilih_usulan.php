...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "surat/surat_masuk_pegawai_json/json_pilih_usulan_tanda_tangan/?reqUptBkdJenis=<?=$reqUptBkdJenis?>&reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqSatuanKerjaId=<?=$reqSatuanKerjaId?>",
        	"sScrollX": "100%",								  
        	"sScrollXInner": "100%",
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("surat/surat_masuk_pegawai_json/json_pilih_usulan_tanda_tangan/?reqUptBkdJenis=<?=$reqUptBkdJenis?>&reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqSatuanKerjaId=<?=$reqSatuanKerjaId?>");
		});
					   ...
					   buttons: [
						   {
							   ...
							   callback: function() {
								   ...
								   parent.cetakrekomendasi("<?=$reqRowId?>", data, anSelectedTipeId);
								   parent.closeModal();
