...
$(document).ready( function () {
  ...
  function setsimpan()
  {
    urlreload= "app/loadUrl/persuratan/surat_masuk_upt_add_pegawai_verfikasi_karsu?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>";
