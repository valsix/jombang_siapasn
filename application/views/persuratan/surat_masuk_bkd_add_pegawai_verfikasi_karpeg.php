                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                        <input type="checkbox" disabled id="reqStatusCheckBoxFix<?=$infonomorid?>" <?=$tempRequiredOtomatis?> <?=$vdatachecked?> class="easyui-validatebox"<?=$infoInfoChecked?> />
...
$(document).ready( function () {
  ...
  function setsimpan()
  {
    urlreload= "app/loadUrl/persuratan/surat_masuk_bkd_add_pegawai_verfikasi_karpeg?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>";
