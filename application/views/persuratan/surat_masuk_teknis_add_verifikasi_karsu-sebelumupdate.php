...
while($set->nextRow())
{
  ...
  // echo $reqSuamiIstriPertamaPnsStatusSi."-".$set->getField("NOMOR")."<br/>";
	// if($reqSuamiIstriPertamaPnsStatusSi == 2)
 //  {
 //    if($set->getField("NOMOR") <= 7){}
 //    else
 //      continue;
 //  }
  
 //  if($reqSuamiIstriPertamaPnsStatusSi == 3)
 //  {
 //    if($set->getField("NOMOR") <= 8){}
 //    else
 //      continue;
 //  }
            ...
            onSubmit:function(){
				...
				else
				{
					mbox.alert(infodata, {open_speed: 500}, interval = window.setInterval(function() 
					{
						...
						document.location.href= "app/loadUrl/persuratan/surat_masuk_teknis_add_verifikasi_karsu?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>";
					}, 1000));
        ...
        <li class="collection-item">
          ...
          $tempChecked= "";
			...
			else
			{
				...
				{
			?>
            <?php /*?><button class="btn waves-effect waves-light green" style="font-size:9pt" type="submit" name="action">
            Simpan
			...
			{
            ?>
            <button class="btn red waves-effect waves-light" style="font-size:9pt" type="button" id="reqbatalusulnomor">Batal Terverifikasi
                <i class="mdi-content-save left hide-on-small-only"></i>
            </button>
			...
			{
            ?>
            <button class="btn red waves-effect waves-light" style="font-size:9pt" type="button" id="reqbatalusulkanreg">Batalkan Usul Ke Kanreg II BKN
                <i class="mdi-content-save left hide-on-small-only"></i>
            </button>
            <?
			}
            ...
            <?
					...
					{
			?>
            <button class="btn waves-effect waves-light green" style="font-size:9pt" type="submit" id="reqSubmit" name="action">
            Simpan
            <i class="mdi-content-save left hide-on-small-only"></i>
            </button>
            <?
