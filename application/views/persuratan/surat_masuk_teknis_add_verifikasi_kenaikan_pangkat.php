          ...
          <li class="collection-item">
            <form id="ff" method="post"  novalidate enctype="multipart/form-data">
              <div class="row">
                ...
                ?>
                            <button class="btn pink waves-effect waves-light" style="font-size:9pt" type="button"
                            onClick="parent.openModal('app/loadUrl/persuratan/usulan_surat_pilih?reqId=<?=$reqId?>&reqJenis=13&reqRowId=<?=$reqRowId?>')"
...
$(document).ready( function () {
  ...
  function setsimpan()
  {
    urlreload= "app/loadUrl/persuratan/surat_masuk_teknis_add_verifikasi_kenaikan_pangkat?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>";
  ...
  $(".reqbatalusulkanreg").click(function() {
    ...
    $.ajax({'url': s_url,'success': function(dataajax){
      if(dataajax == '2' || dataajax == '3')
      {
        ...
        document.location.href= "app/loadUrl/persuratan/surat_masuk_teknis_add_verifikasi_kenaikan_pangkat?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>";
      }
      else
      {
  ...
  $(".reqkirimwa").click(function() { 
    parent.openModal('app/loadUrl/persuratan/surat_masuk_wa?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>&kembali=surat_masuk_teknis_add_verifikasi_kenaikan_pangkat')
  });

  $(".reqturunstatus").click(function() { 
    parent.openModal('app/loadUrl/persuratan/surat_masuk_teknis_add_turun_status?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>&kembali=surat_masuk_teknis_add_verifikasi_kenaikan_pangkat')
  });
