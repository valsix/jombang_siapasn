    ...
    $(function(){
      $('#ff').form({
          ...
          onSubmit:function(){
              ...
              // $.messager.alert('Info', "Tidak simpan lagi cek.", 'info');
              // return false;
          },
            ...
            <div class="row">
                <table class="bordered striped md-text">
                  <thead>
                    ...
                    ?>
                    <tr>
                        <th class="green-text " style="width:20%">Jenis Pensiun</th>
                  ...
                  <tr>
                    <td>
                      <table class="bordered striped md-text table_list tabel-responsif table-syarat" style="margin-bottom:10px;">
                        ...
                        <!-- <tr>
                          <th colspan="2">
                            <button class="btn blue waves-effect waves-light" style="font-size:9pt;<?=$infonama?>" type="button" id='buttonframepdf<?=$infonomorid?>'>
                              <input type="hidden" id="labelvpdf<?=$infonomorid?>" value="<?=$riwayatfieldinfo?>" />
                              <span id="labelframepdf<?=$infonomorid?>"><?=$riwayatfieldinfo?></span>
                            </button>
                          </th>
