        ...
        <!-- start header nav-->
          ...
          <div id="main">
            ...
            <div class="wrapper">
              ...
              <!--start container-->
              <div class="container">
                <iframe src="app/loadUrl/persuratan/<?=$arrMenu[0]["LINK_FILE"]?>/?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>" name="mainFrame" id="mainFrame" onload="iframeLoaded()" style="border: none; width:100%" scrolling="no"></iframe>
              </div>
              <!--end container-->
          </section>
          <!-- END CONTENT -->
