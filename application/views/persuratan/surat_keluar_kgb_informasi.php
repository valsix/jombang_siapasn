...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "surat/surat_keluar_bkd_json/json_surat_keluar_kgb?reqStatusPilih=<?=$reqStatusPilih?>&reqJenis=<?=$reqJenis?>&reqBulanData=<?=$reqBulanData?>&reqTahunData=<?=$reqTahunData?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
        	"sScrollX": "100%",								  
        	"sScrollXInner": "100%",
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("surat/surat_keluar_bkd_json/json_surat_keluar_kgb?reqStatusPilih=<?=$reqStatusPilih?>&reqJenis=<?=$reqJenis?>&reqBulanData=<?=$reqBulanData?>&reqTahunData=<?=$reqTahunData?>&reqBulan="+reqBulan+"&reqTahun="+reqTahun);
		});
			...
			<section id="content-full">
                ...
                <div class="area-parameter">
					<div class="kiri">
						...
						<span>entries</span>
                        <span style="padding-left:50px">Bulan</span>
                        <select name="reqBulan" id="reqBulan">
                            ...
                            {
                            ?>
                            <option value="<?=generateZero($arrBulan[$bulan],2)?>" <? if($reqBulan == $arrBulan[$bulan]) echo "selected";?>><?=getNameMonth(generateZero($arrBulan[$bulan],2))?></option>
                            <?
                            }
                            ?>
                        </select>
