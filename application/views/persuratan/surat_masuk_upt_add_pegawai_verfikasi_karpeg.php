...
$infomode= "karpeg";
$arrparam= ["reqJenis"=>$reqJenis, "reqRowId"=>$reqRowId, "reqJenisKarpeg"=>$reqJenisKarpeg, "reqMode"=>$infomode, "reqNoSuratKehilangan"=>$reqNoSuratKehilangan, "reqTanggalSuratKehilangan"=>$reqTanggalSuratKehilangan];
          ...
          <li class="collection-item">
            <form id="ff" method="post"  novalidate enctype="multipart/form-data">
                ...
                <table class="bordered striped md-text table_list tabel-responsif" id="link-table" style="margin-bottom:10px;">
                  <tr class="ubah-color-warna">
                    ...
                    <th class="white-text material-font" style="text-align: center;width:1% !important">
                      <input type="checkbox" disabled id="reqCheckAllAtas" class="checkbox-indigo"/>
                  ...
                  foreach ($arrInfo as $key => $value)
                  {
                    ...
                    $arrparam= ["reqJenis"=>$reqJenis, "infotipe"=>$reqDokumenKategoriField, "infonomor"=>$infonomor, "infopegawaiid"=>$reqPegawaiId, "infokategorifileid"=>$reqDokumenKategoriFileId, "infopangkatriwayatakhirid"=>$infopangkatriwayatakhirid, "infogajiriwayatakhirid"=>$infogajiriwayatakhirid, "pnspangkatriwayatid"=>$pnspangkatriwayatid];
                    $arrparam= array_merge($arrparam, $arrsuamiistri);
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                        <input type="checkbox" disabled id="reqStatusCheckBoxFix<?=$infonomor?>" <?=$tempRequiredOtomatis?> <?=$vdatachecked?> class="easyui-validatebox"<?=$infoInfoChecked?> />
                  ...
                  <tfoot> 
                    <tr class="ubah-color-warna">
                      ...
                      <th class="white-text material-font">
                        <input type="checkbox" disabled id="reqCheckAllBawah" class="checkbox-indigo"/>
              ...
              <table class="bordered striped md-text table_list tabel-responsif" style="margin-top:20px">
                ...
                <?
                foreach ($arrRevisiLog as $key => $value)
                {
                  $tempCetakIjinBelajar= $value["CETAK_IJIN_BELAJAR_ID"];
...
$(document).ready( function () {
  ...
  function setsimpan()
  {
    urlreload= "app/loadUrl/persuratan/surat_masuk_upt_add_pegawai_verfikasi_karpeg?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>";
    infourllink= $("#infourllink").val();
    // console.log(infourllink);

    if(infourllink == "kirim_ulang")
    {
      $("#infourllink").val("");
      $('#ff').form('submit', {
