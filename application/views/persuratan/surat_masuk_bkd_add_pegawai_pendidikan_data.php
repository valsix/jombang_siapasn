...
<head>
  ...
  <script type="text/javascript"> 
    ...
    $('#ff').form({
		url:'surat/surat_masuk_pegawai_json/add_pendidikan_dinas',
        onSubmit:function(){
          ...
          //$.messager.alert('Info', infodata, 'info');
			...
			else
			{
				mbox.alert(infodata, {open_speed: 500}, interval = window.setInterval(function() 
				{
				  ...
				  mbox.close();
				  document.location.href= "app/loadUrl/persuratan/surat_masuk_bkd_add_pegawai_pendidikan_data/?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId="+rowid;
				}, 1000));
      ...
      $('input[id^="reqJurusan"], input[id^="reqNipBaru"]').autocomplete({
        source:function(request, response){
          ...
          {
            urlAjax= "pendidikan_riwayat_json/cari_pegawai_usulan?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqMode=1";
          }
            ...
            <div class="row">
              ...
              <div class="row">
                <div class="input-field col s12 m6">
                  ...
                  <input type="text" required class="easyui-validatebox" id="reqNamaSekolah"  name="reqNamaSekolah" <?=$read?> value="<?=$reqNamaSekolah?>" title="Nama sekolah harus diisi" />
                </div>
...
<script type="text/javascript">
  $(document).ready(function() {
	...
	$("#tambah").click(function() { 
	  document.location.href= "app/loadUrl/persuratan/surat_masuk_bkd_add_pegawai_pendidikan_data/?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>";
	});
  ...
  $("#reqcetakrekomendasimodal").click(function() { 
    parent.openModal('app/loadUrl/persuratan/tanda_tangan_pilih_badan?reqMode=rekomendasidetil&reqStatusBkdUptId=2&reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>&reqJenis=<?=$reqJenis?>&reqSatuanKerjaId=<?=$reqSatkerAsalId?>')
    // parent.openModal('app/loadUrl/persuratan/tanda_tangan_pilih_usulan?reqUptBkdJenis=1&reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>&reqJenis=<?=$reqJenis?>&reqSatuanKerjaId=<?=$reqSatkerAsalId?>')
  });
