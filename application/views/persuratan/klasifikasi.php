...
<script type="text/javascript" charset="utf-8">
  ...
  $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
         ...
         "bProcessing": true,
         "bServerSide": true,
         "sAjaxSource": "klasifikasi_json/json",
         "sScrollX": "100%",								  
         "sScrollXInner": "100%",
   ...
   $("#btnCari").on("click", function () {
    tempJsonParsing= reqCariFilter= "";
    reqCariFilter= $("#reqCariFilter").val();
              //setJsonFilter();
              //alert(tempJsonParsing);
              oTable.fnReloadAjax("klasifikasi_json/json?sSearch="+reqCariFilter);
          });
   ...
   $('#btnAdd').on('click', function () {
       window.parent.openPopup("app/loadUrl/app/klasifikasi_add");
   ...
   $('#btnEdit').on('click', function () {
       if(anSelectedData == "")
          return false;				
      window.parent.openPopup("app/loadUrl/app/klasifikasi_add/?reqId="+anSelectedId);
   ...
   $('#btnDelete').on('click', function () {
      ...
      $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
          if (r){
             $.getJSON("klasifikasi_json/delete/?reqId="+anSelectedId,
                function(data){
                   $.messager.alert('Info', data.PESAN, 'info');
                   oTable.fnReloadAjax("klasifikasi_json/json");
               });
   ...
   $('#btnLog').on('click', function () {
       window.parent.openPopup("app/loadUrl/app/informasi_data_log?reqjson=klasifikasi_json/log&reqjudul=Klasifikasi Log");
...
function hapusData(id, statusaktif)
{
    ...
    $.messager.confirm('Konfirmasi', infoMode+" ?",function(r){
        if (r){
            var s_url= "klasifikasi_json/delete/?reqMode="+reqmode+"&reqId="+id;
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <h5 class="breadcrumbs-title">Klasifikasi</h5>
                            </div>
                        </div>
                    </div>
                </div>
