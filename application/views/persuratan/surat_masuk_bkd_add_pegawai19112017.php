      ...
      <ul class="collection card">
        ...
        <li class="collection-item">
          <div class="row">
          	...
          	<a style="cursor:pointer" onClick="parent.openModal('app/loadUrl/persuratan/pegawai_pilih_dinas?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>')"> <i class="mdi-content-add-circle-outline"> Tambah</i></a>
            </div>
            <div class="col s12 m3">
            <a style="cursor:pointer" onClick="parent.openModal('app/loadUrl/persuratan/pegawai_pilih_upt?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>')"> <i class="mdi-content-add-circle-outline"> Tambah Dari data Upt</i></a>
            </div>
          </div>
