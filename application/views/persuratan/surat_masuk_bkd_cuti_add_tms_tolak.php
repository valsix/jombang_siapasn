...
$infolabel= $infopertanyaan= "";
if($j == "tms")
{
  $infopertanyaan= "Apakah yakin untuk proses TMS an. ".$reqPegawaiNama." ?";
  $infolabel= "Usulan TMS";
}
else if($j == "tolak")
{
  $infopertanyaan= "Apakah yakin untuk proses Tolak an. ".$reqPegawaiNama." ?";
  $infolabel= "Usulan Tolak";
}
?>
<html>
<head>
        ...
        mbox.alert(infodata, {open_speed: 500}, interval = window.setInterval(function() 
        {
          ...
          if (window.parent && window.parent.document)
          {
            ...
            if(kembali == "")
            {
              ...
              {
                parent.setUrlInfo('app/loadUrl/persuratan/surat_masuk_bkd_cuti_add_tms_tolak?reqRowId=<?=$reqRowId?>');
              }
            }
            else
            {
    ...
    <div class="row">
      <div class="col s12 m10 offset-m1">
        ...
        <ul class="collection card" style="height: 90vh">
          <li class="collection-item ubah-color-warna"><?=$infolabel?></li>
              ...
              <form id="ff" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="input-field col s12 m12">
                    ...
                    <input type="hidden" name="reqJenis" value="<?=$j?>" />
