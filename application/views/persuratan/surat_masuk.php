...
<head>
	...
	<script type="text/javascript" charset="utf-8">
		...
		$('#btnEdit').on('click', function () {
			if(anSelectedData == "")
			return false;				
			newWindow = window.open("app/loadUrl/persuratan/surat_masuk_add?reqId="+anSelectedId+"&reqJenis="+anSelectedJenisId, 'Cetak'+Math.floor(Math.random()*999999));
			newWindow.focus();
			tempindextab= parseInt(tempindextab) + 1;
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("surat/surat_masuk_bkd_json/json_surat/?reqJenis=<?=$reqJenis?>&reqJenisPelayananId="+reqJenisPelayananId+"&reqStatusSurat="+reqStatusSurat+"&reqStatusNomor="+reqStatusNomor+"&sSearch="+reqCariFilter);
		});
