...
$(document).ready( function () {
  ...
  $(".requsulanbatal").click(function() { 
    parent.openModal('app/loadUrl/persuratan/surat_masuk_upt_add_batal?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>&kembali=surat_masuk_upt_add_pegawai_lookup_verfikasi_pensiun')
  });
