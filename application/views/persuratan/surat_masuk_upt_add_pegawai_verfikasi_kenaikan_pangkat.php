              ...
              <div class="row">
                <table class="bordered striped md-text">
                  <thead>
                    ...
                    ?>
                    <tr>
                      <th class="green-text material-font" style="width:20%">Jenis KP</th>
                      <th class="green-text material-font" style="width:1%">:</th>
...
$(document).ready( function () {
  ...
  function setsimpan()
  {
    urlreload= "app/loadUrl/persuratan/surat_masuk_upt_add_pegawai_verfikasi_kenaikan_pangkat?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>";
