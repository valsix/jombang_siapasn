...
<head>
  ...
  <script type="text/javascript">
  	...
  	function setCariInfo()
	{
		...
		$.ajax({'url': "app/loadUrl/persuratan/surat_masuk_add_pegawai_data/?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>",'success': function(datahtml) {
    ...
    function hapusdata(id)
	{
		$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
			if (r){
				$.getJSON("surat/surat_masuk_pegawai_bkd_json/delete_pegawai/?reqId="+id,
					function(data){
          ...
          <table class="bordered striped md-text table_list tabel-responsif" id="link-table">
            <thead> 
              <tr>
                ...
                <?php /*?><th rowspan="2" class="green-text material-font">Aksi</th><?php */?>
              </tr>
              <tr>
