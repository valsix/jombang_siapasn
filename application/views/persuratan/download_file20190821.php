...
for($index=0; $index < $jumlah_info; $index++)
{
  ...
  $direktori= "uploads/".$buatfolderzip."/";
  $direktorihapus= "uploads/".$buatfolderzip;
...
for($index_file=0; $index_file < $indexZip; $index_file++)
{
  ...
  $filelokasiformatbaru= $direktori.$namafilebaru;
  $filelokasiformatbarubackup= $direktori.$namafilebaru;
