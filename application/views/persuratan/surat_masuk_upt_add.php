...
else
{
    ...
    $set= new Menu();
    $set->selectByParamsUpt(array(), -1, -1, $statement);
    $set->firstRow();
                                    ...
                                    <li class="bold">
                                        ...
                                        <div class="collapsible-body">
                                            <ul>
                                                ...
                                                ?>
                                                        <li>
                                                            <a onClick="executeOnClick('<?=$childMenuId?>');" class="green-text waves-effect waves-cyan"><?=$childNama?></a>
                                                        </li>                                        
                                                <?
                                                    }
                                                }
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        {
            newWindow = window.open("app/loadUrl/persuratan/cetak_pdf?reqStatusBkdUptId=&reqCss=surat_rekomendasi&reqUrl=ijin_belajar_surat_rekomendasi&reqId="+rowid+"&reqPegawaiPilihKepalaId="+id+"&reqTipeId="+tipeid, 'Cetak');
            newWindow.focus();
        }

        function cetakpengantartipejabatan(reqGantiBaris, id, tipeid, jabatanpilihan, jabatanmanual)
        {
            var s_url= "surat/surat_masuk_pegawai_json/total_pegawai_upt?reqId=<?=$reqId?>";
            ...
            $.ajax({'url': s_url,'success': function(dataajax){
              ...
              newWindow = window.open("app/loadUrl/persuratan/cetak_pdf?reqGantiBaris="+reqGantiBaris+"&reqStatusBkdUptId=1&reqCss="+requrlcss+"&reqUrl="+requrl+"&reqUrlList="+requrllist+"&reqId=<?=$reqId?>&reqPegawaiPilihKepalaId="+id+"&reqTipeId="+tipeid+"&reqJabatanPilihan="+jabatanpilihan+"&reqJabatanManual="+reqJabatanManual, 'Cetak');
              newWindow.focus();
            }});
        }
        ...
        function cetakpengantartipe(id, tipeid)
        {
            ...
            $.ajax({'url': s_url,'success': function(dataajax){
              ...
              newWindow = window.open("app/loadUrl/persuratan/cetak_pdf?reqStatusBkdUptId=1&reqCss="+requrlcss+"&reqUrl="+requrl+"&reqUrlList="+requrllist+"&reqId=<?=$reqId?>&reqPegawaiPilihKepalaId="+id+"&reqTipeId="+tipeid, 'Cetak');
              newWindow.focus();
            }});
        }
