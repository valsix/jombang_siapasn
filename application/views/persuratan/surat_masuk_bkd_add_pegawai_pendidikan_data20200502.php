...
<script type="text/javascript">
  ...
  $("#reqcetakrekomendasimodal").click(function() { 
    parent.openModal('app/loadUrl/persuratan/tanda_tangan_pilih_badan?reqMode=rekomendasi&reqStatusBkdUptId=2&reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqSatuanKerjaId=<?=$reqSatkerAsalId?>')
