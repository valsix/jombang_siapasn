...
{
	$arrData= array("Nomor", "Tanggal", "NIP", "Nama", "Unit Kerja", "Aksi");
	$json= "json_teknis";
}
?>
...
<head>
	...
	<script type="text/javascript" charset="utf-8">
		...
		$("#btnCari").on("click", function () {
			var reqSatuanKerjaId= reqTahun= reqCariFilter= "";
			reqSatuanKerjaId= $("#reqSatuanKerjaId").val();
			reqTahun= $("#reqTahun").val();
			reqCariFilter= $("#reqCariFilter").val();

			oTable.fnReloadAjax("surat/surat_keluar_bkd_json/<?=$json?>?reqJenis=<?=$reqJenis?>&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqTahun="+reqTahun+"&sSearch="+reqCariFilter);
		});
