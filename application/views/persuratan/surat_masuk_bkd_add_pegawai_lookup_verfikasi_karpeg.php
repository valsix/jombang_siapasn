          ...
          success:function(data){
            ...
            else
            {
              mbox.alert(infodata, {open_speed: 500}, interval = window.setInterval(function() 
              {
                ...
                document.location.href= "app/loadUrl/persuratan/surat_masuk_bkd_add_pegawai_lookup_verfikasi_karpeg?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>";
              }, 1000));
            ...
            <div class="row">
                <table class="bordered striped md-text">
                	<thead>
                      ...
                      <tr>
                          <th class="green-text ">Kartu Pegawai Lama</th>
                          <th class="green-text ">:</th>
                          <th colspan="4" class="green-text "><?=$reqKartuPegawaiLama?></th>
                      </tr>
                      <tr>
                      	  <th class="green-text ">Nama</th>
                          <th class="green-text ">:</th>
                          <th colspan="4" class="green-text "><?=$reqPegawaiNama?></th>
                      </tr>
                      <tr>
                          <th class="green-text ">NIP Baru</th>
                          <th class="green-text ">:</th>
                          <th colspan="4" class="green-text "><?=$reqPegawaiNipBaru?></th>
                      </tr>
                      <tr>
                          <th class="green-text ">Gol Terakhir</th>
                          <th class="green-text ">:</th>
                          <th colspan="4" class="green-text "><?=$reqPangkatRiwayatAkhir?></th>
                      </tr>
                      <tr>
                          <th class="green-text ">Jabatan</th>
                          <th class="green-text ">:</th>
                          <th colspan="4" class="green-text "><?=$reqPegawaiJabatan?></th>
                      </tr>
                      <tr>
                      	<th class="green-text ">Satuan Kerja</th>
                          <th class="green-text ">:</th>
                          <th colspan="4" class="green-text "><?=$reqSatuanKerjaNama?></th>
                      </tr>
                  </thead>
                </table>
                    ...
                    <td>
                      <table class="bordered striped md-text table_list tabel-responsif table-syarat" style="margin-bottom:10px;">
                        <tr>
                          ...
                          <td>
                            <select id="reqDokumenPilih<?=$infonomor?>" name="reqDokumenPilih[]">
                              <?
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <div id="labeldokumendarifileupload<?=$infonomor?>">
                              <select id="reqDokumenIndexId<?=$infonomor?>">
