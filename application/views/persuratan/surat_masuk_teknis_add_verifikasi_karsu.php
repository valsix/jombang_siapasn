...
$reqStatusPernahTurun= $set->getField('STATUS_PERNAH_TURUN');
...
$(document).ready( function () {
  ...
  function setsimpan()
  {
    urlreload= "app/loadUrl/persuratan/surat_masuk_teknis_add_verifikasi_karsu?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>";
  ...
  $(".reqkirimwa").click(function() { 
    parent.openModal('app/loadUrl/persuratan/surat_masuk_wa?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>&kembali=surat_masuk_teknis_add_verifikasi_karsu')
  });

  $(".reqturunstatus").click(function() { 
    parent.openModal('app/loadUrl/persuratan/surat_masuk_teknis_add_turun_status?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>&kembali=surat_masuk_teknis_add_verifikasi_karsu')
  });
