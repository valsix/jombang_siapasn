                    ...
                    <form id="ff" method="post" enctype="multipart/form-data">
                         ...
                         <div class="row">
                         	<div class="input-field col s12 m3">
                              ...
                              <input class="easyui-validatebox" required type="text" name="reqKlasifikasi" id="reqKlasifikasi" value="<?=$reqKlasifikasi?>" />
                            </div>
                         ...
                         <div class="row">
                          <div class="input-field col s12 m6">
                            ...
                            <input type="text" name="reqPerihal" id="reqPerihal"  value="<?=$reqPerihal?>" />
                          </div>
                         </div>
                         ...
                         <div class="row">
                            <div class="input-field col s12 m12">
                              ...
                              <input type="text" id="reqSatuanKerjaTujuanNama" name="reqSatuanKerjaTujuanNama" <?=$read?> value="<?=$reqSatuanKerjaTujuanNama?>" class="easyui-validatebox" required />
                            </div>
                         </div>
