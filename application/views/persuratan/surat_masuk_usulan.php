...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "surat/surat_masuk_bkd_json/json_surat/?reqJenis=<?=$reqJenis?>",
        	"sScrollX": "100%",								  
        	"sScrollXInner": "100%",
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("surat/surat_masuk_bkd_json/json_surat/?reqJenis=<?=$reqJenis?>");
		});
				...
				<div id="breadcrumbs-wrapper">
					<div class="container">
						<div class="row">
							...
							<h5 class="breadcrumbs-title">Usulan Pelayanan <?=$reqJenisNama?></h5>
                ...
                <div id="bluemenu" class="bluetabs">
                    <ul>
                        <li>
                            ...
                            <a id="btnEdit" title="Baca"><img src="images/icon-edit.png" /> Baca</a>
                        </li>
                    </ul>
                </div>
