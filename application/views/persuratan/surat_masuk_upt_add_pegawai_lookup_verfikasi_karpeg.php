...
$infomode= "karpeg";
$arrparam= ["reqJenis"=>$reqJenis, "reqRowId"=>$reqRowId, "reqJenisKarpeg"=>$reqJenisKarpeg, "reqMode"=>$infomode, "reqMode"=>$infomode, "reqNoSuratKehilangan"=>$reqNoSuratKehilangan, "reqTanggalSuratKehilangan"=>$reqTanggalSuratKehilangan];
          ...
          success:function(data){
            ...
            else
            {
              mbox.alert(infodata, {open_speed: 500}, interval = window.setInterval(function() 
              {
                ...
                document.location.href= "app/loadUrl/persuratan/surat_masuk_upt_add_pegawai_lookup_verfikasi_karpeg?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>";
              }, 1000));
...
$(document).ready( function () {
  ...
  $(".requsulanbatal").click(function() { 
    parent.openModal('app/loadUrl/persuratan/surat_masuk_upt_add_batal?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>&kembali=surat_masuk_upt_add_pegawai_lookup_verfikasi_karpeg')
  });
