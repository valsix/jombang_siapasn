...
$(function(){
  ...
  // {
  //   if (typeof window.parent.simpandataturunstatus === 'function')
  //   {
  //     parent.simpandataturunstatus();
  //   }
  // }

  $('#ff').form({
    url:'surat/surat_masuk_pegawai_check_json/turun_status',
    onSubmit:function(){
      var f = this;
    ...
    success:function(data){
      ...
      else
      {
        mbox.alert(infodata, {open_speed: 500}, interval = window.setInterval(function() 
        {
          ...
          //parent.setUrlInfo('app/loadUrl/persuratan/surat_masuk_teknis_add_verifikasi?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>');
          kembali= "<?=$kembali?>";
          if(kembali == "")
            parent.setUrlInfo('app/loadUrl/persuratan/surat_masuk_teknis_add?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>');
          else
              ...
              <form id="ff" method="post" enctype="multipart/form-data">
                <div class="row">
                  <div class="input-field col s12">
                    ...
                    <input required class="easyui-validatebox" type="text" name="reqKeterangan" id="reqKeterangan" <?=$read?> value="<?=$reqKeterangan?>" />
                  </div>
                </div>
