...
$index_set=0;
$arrMenu=setmenusuratbkpp($reqJenis, $tempStatusKelompokPegawaiUsul);
                            ...
                            for($index_detil=0; $index_detil < count($arrayKey); $index_detil++)
                            {
                                ...
                                else
                                {
                                    ...
                                    <ul class="collapsible collapsible-accordion">
                                        <li class="bold">
                                            <a class="collapsible-header ubah-color-warna waves-effect waves-cyan">
                                                <?=$tempIcon?>
                                                <span><?=$tempNama?></span>
                                            </a>
                                                ...
                                                <ul>
                                                    ...
                                                    for ($i=0; $i < count($arrMenu); $i++) { 
                                                        if ($arrMenu[$i]['MENU_PARENT_ID'] == $tempMenuId){ 
                                                            ...
                                                            ?>
                                                            <li><a onClick="executeOnClick('<?=$childMenuId?>');" class="ubah-color-warna waves-effect waves-cyan"><?=$childNama?></a></li>                                        
                                                            <?
                                                        }
                                                    }
                                                    ?>
