...
$arrdata= [];
$arrdata["MENU_ID"]= "01";
$arrdata["MENU_PARENT_ID"]= "0";
$arrdata["NAMA"]= "Usulan";
$arrdata["LINK_FILE"]= "surat_masuk_bkd_cuti_add_data";
$arrdata["ICON"]= '<i class="mdi-action-dashboard"></i>';
...
if(!empty($m))
    $infourlawal ='app/loadUrl/persuratan/surat_masuk_bkd_cuti_add_data/?m='.$m.'&reqRowId='.$reqRowId;
else
    $infourlawal ='app/loadUrl/persuratan/surat_masuk_bkd_cuti_add_data/?reqRowId='.$reqRowId;
        ...
        function executeOnClick(varItem){
            ...
            ?>
                else if(varItem == '<?=$tempMenuId?>')
                {
                    ...
                    mainFrame.location.href='app/loadUrl/persuratan/<?=$tempLinkFile?>/?m=<?=$m?>&reqRowId=<?=$reqRowId?>&reqId=<?=$reqId?>';
                    iframeLoaded();
                }
            <?
            }
