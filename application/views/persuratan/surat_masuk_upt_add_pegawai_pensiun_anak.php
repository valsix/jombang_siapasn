...
function setsuamiistrijeniskawinid(infomode, infoid)
{
    ...
    {
      $("#reqSuamiIstriAktaNikahNo"+infoid+", #reqSuamiIstriAktaNikahTanggal"+infoid+", #reqSuamiIstriNikahTanggal"+infoid+", #reqSuamiIstriAktaCeraiNo"+infoid+", #reqSuamiIstriAktaCeraiTanggal"+infoid+", #reqSuamiIstriCeraiTanggal"+infoid).val("");
    }
...
function setanakjeniskawinid(infomode, infoid)
{
	...
	{
		$("#reqAnakAktaNikahNo"+infoid+", #reqAnakAktaNikahTanggal"+infoid+", #reqAnakNikahTanggal"+infoid+", #reqAnakAktaCeraiNo"+infoid+", #reqAnakAktaCeraiTanggal"+infoid+", #reqAnakCeraiTanggal"+infoid).val("");
	}
