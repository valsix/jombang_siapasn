...
else
{
  ...
  $reqRowDetilId= $set->getField('SURAT_MASUK_KARPEG_ID');
...
<head>
  ...
  <script type="text/javascript"> 
    ...
    $(function(){
      ...
      $('#ff').form({
		url:'surat/surat_masuk_pegawai_json/add_karpeg',
        onSubmit:function(){
			var reqPegawaiId= "";
          ...
          //$.messager.alert('Info', infodata, 'info');
			...
			else
			{
				mbox.alert(infodata, {open_speed: 500}, interval = window.setInterval(function() 
				{
				  ...
				  mbox.close();
				  document.location.href= "app/loadUrl/persuratan/surat_masuk_upt_add_pegawai_karpeg/?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId="+rowid;
				}, 1000));
      ...
      $('input[id^="reqNipBaru"]').autocomplete({
			source:function(request, response){
			  ...
			  {
				urlAjax= "pendidikan_riwayat_json/cari_pegawai_karpeg_usulan?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>";
			  }
							...
							<div id="keteranganlabeldetil">
								<div class="row">
									...
									<div class="input-field col s12 m4">
										...
										<input placeholder="" type="text" class="easyui-validatebox" id="reqData4" name="reqData4" />
									</div>
									<div class="input-field col s12 m4">
										<label for="reqData6">Seharusnya</label>
										<input placeholder="" type="text" class="easyui-validatebox" id="reqData6" name="reqData6" />
									</div>
								</div>
								<div class="row">&nbsp;</div>
								<div class="row">&nbsp;</div>
				   ...
				   buttons: [
					   {
						   ...
						   callback: function() {
								...
								function(data){
									...
									{
										clearInterval(interval);
										document.location.href= "app/loadUrl/persuratan/surat_masuk_upt_add_pegawai_karpeg/?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>";
									}, 1000));
									$(".mbox > .right-align").css({"display": "none"});
									//$(".right-align").hide();
								});
