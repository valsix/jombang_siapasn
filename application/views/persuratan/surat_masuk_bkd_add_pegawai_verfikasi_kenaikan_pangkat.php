                      ...
                      <td>
                        <table class="bordered striped md-text table_list tabel-responsif table-syarat" style="margin-bottom:10px;">
                          <tr>
                            ...
                            <td>
                              <select id="reqDokumenPilih<?=$infonomorid?>" name="reqDokumenPilih[]">
                                <?
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <div id="labeldokumendarifileupload<?=$infonomorid?>">
                                <select id="reqDokumenIndexId<?=$infonomorid?>">
...
$(document).ready( function () {
  ...
  function setsimpan()
  {
    urlreload= "app/loadUrl/persuratan/surat_masuk_bkd_add_pegawai_verfikasi_kenaikan_pangkat?reqId=<?=$reqId?>&reqJenis=<?=$reqJenis?>&reqRowId=<?=$reqRowId?>";
