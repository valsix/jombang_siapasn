...
$arrpendidikan= [];
$set= new Pendidikan();
$set->selectByParams(array(), -1,-1, "", "ORDER BY A.PENDIDIKAN_ID DESC");
// echo $set->query;exit;
while($set->nextRow())
{
  $arrdata= [];
...
$arrtabledata= array(
  ...
  , array("label"=>"Pendidikan", "field"=> "PENDIDIKAN_NAMA", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
  , array("label"=>"Jurusan", "field"=> "PENDIDIKAN_JURUSAN_NAMA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")

  // untuk dua ini kunci, data akhir id, data sebelum akhir untuk order
  , array("label"=>"sorderdefault", "field"=> "SORDERDEFAULT", "display"=>"1", "width"=>"")
  , array("label"=>"fieldid", "field"=> "PENDIDIKAN_JURUSAN_ID", "display"=>"1", "width"=>"")
);
...
<body>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <h5 class="breadcrumbs-title">Nilai Rumpun Kualifikasi Jurusan</h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col s12 m12">
                      ...
                      <div class="row" style="margin-left: -24px;">
                        ...
                        <div class="input-field col s12 m4">
                          <select id='reqPendidikanId'>
                            <option value=''></option>
                            <?
                            for($indexdetil=0; $indexdetil < count($arrpendidikan); $indexdetil++)
                            {
                              $infooptionid= $arrpendidikan[$indexdetil]["ID"];
                              $infooptiontext= $arrpendidikan[$indexdetil]["TEXT"];
                            ?>
                            <option value="<?=$infooptionid?>" <? if($reqTipeUjianId == $infooptionid) echo "selected";?>><?=$infooptiontext?></option>
                            <?
                            }
                            ?>
                          </select>
                          <label for="reqPendidikanId" class="labelkhusus">Pendidikan</label>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $("#reqTahun,#reqPendidikanId,#reqPilihan").change(function() {
          setCariInfo();
        });
        ...
        $("#btnEdit").on("click", function () {
          ...
          window.parent.openPopup("app/loadUrl/app/nilai_rumpun_jurusan_add/?reqId="+reqGlobalValidasiCheck);
        });
        ...
        $('#btnCari').on('click', function () {
          ...
          reqGlobalValidasiCheck= $("#reqGlobalValidasiCheck").val();
          if(typeof reqGlobalValidasiCheck == "undefined")
          {
              reqGlobalValidasiCheck= "";
          }

          jsonurl= "json/rumpun_nilai_json/jsonjurusan?reqPencarian="+reqPencarian+"&reqPendidikanId="+reqPendidikanId+"&reqGlobalValidasiCheck="+reqGlobalValidasiCheck;
        ...
        jQuery(document).ready(function() {
          var jsonurl= "json/rumpun_nilai_json/jsonjurusan?reqPendidikanId=";
            ...
            $('#example tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected') ) {
                    ...
                    /*if(valinfoid !== "")
                    {
                      ...
                      window.location = "main/index/kotak_masuk_detil/?reqMode=kotak_masuk&reqId="+valinfoid+"&reqRowId="+valinforowid+"&reqPilihan="+reqPilihan;
                    }*/
                }
            } );
