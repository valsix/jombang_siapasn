...
<script type="text/javascript" charset="utf-8">
  ...
  $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
         ...
         "bProcessing": true,
         "bServerSide": true,
         "sAjaxSource": "upload_surat_rekom_penetapan_json/json",
         "sScrollX": "100%",								  
         "sScrollXInner": "100%",
   ...
   $('#btnAdd').on('click', function () {
       window.parent.openPopup("app/loadUrl/app/upload_surat_rekom_penetapan_add");
   ...
   $('#btnEdit').on('click', function () {
       if(anSelectedData == "")
          return false;				
      window.parent.openPopup("app/loadUrl/app/upload_surat_rekom_penetapan_add/?reqId="+anSelectedId);
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <h5 class="breadcrumbs-title">Upload Surat Rekom Penetap</h5>
                            </div>
                        </div>
                    </div>
                </div>
