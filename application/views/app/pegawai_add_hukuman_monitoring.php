 ...
 <style type="text/css">
  ...
  (min-device-width: 768px) and (max-device-width: 1024px)  {
    table.tabel-responsif thead th{ display:none; }
      ...
      */
      <?
      $arrData= array("No. SK", "Tgl. SK", "TMT SK", "Tingkat Hukuman", "Jenis Hukuman", "Permasalahan", "Pejabat Penetap", "Masih Berlaku", "Status", "Aksi");
	   ...
	   buttons: [
		   {
			   ...
			   callback: function() {
					var s_url= "hukuman_json/delete/?reqMode="+reqmode+"&reqId="+id;
					...
					$.ajax({'url': s_url,'success': function(msg){
					  ...
					  else
					  {
						  ...
						  document.location.href= "app/loadUrl/app/pegawai_add_hukuman_monitoring/?reqId="+pegawai_id;
					  }
					}});
					mbox.close();
			   }
  ...
  <div class="row">
    <div class="col s12 m10 offset-m1 ">
      ...
      <ul class="collection card">
        <li class="collection-item ubah-color-warna">RIWAYAT HUKUMAN</li>
        <li class="collection-item">
          <div class="row">
            ...
            {
            ?>
            <a style="cursor:pointer" onClick="parent.setload('pegawai_add_hukuman_data?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>')"> <i class="mdi-content-add-circle-outline"> <span class=" material-font">Tambah</span></i></a>
            <?
            }
            ?>
            <?
            ...
            {
            ?>
              <a style="cursor:pointer; margin-left: 20px" onClick="parent.setload('pegawai_add_hukdis_monitoring_bkn?reqId=<?=$reqId?>')"> <i class="mdi-action-view-list"> <span class=" material-font">BKN</span></i></a>
            <?
            }
            ?>
          </div>
            ...
            <tbody>
              ...
              while($set->nextRow())
              {
                ...
                <tr>
                  ...
                  <td><?=$set->getField('TINGKAT_HUKUMAN_NAMA')?></td>
                  <td><?=$set->getField('JENIS_HUKUMAN_NAMA')?></td>
                  <td><?=$set->getField('KETERANGAN')?></td>
                  <td><?=$set->getField('PEJABAT_PENETAP_NAMA')?></td>
                  <td><?=$set->getField('BERLAKU_NAMA')?></td>
                  <td>
                    <?
                  ...
                  <td width="90px">
                    ...
                    <span>
                        <a href="javascript:void(0)" class="round waves-effect waves-light purple white-text" title="Log"  onclick="parent.openModal('app/loadUrl/app/informasi_data_log?reqjson=hukuman_json/log/<?=$reqRowId?>&reqjudul=Data Hukuman Log')">
                    ...
                    <span>
                      <?if($set->getField('STATUS')!=1):?>
                      <a href="javascript:void(0)" class="round waves-effect waves-light blue white-text" title="Ubah" onClick="parent.setload('pegawai_add_hukuman_data?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>')">
