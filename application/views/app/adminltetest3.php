    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
                ...
                //echo "uhui";
                $data = file_get_contents('http://siapasn.jombangkab.go.id/statistik_json/dashboard_tipe_pegawai');
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?echo $json[5]['jumlah'];?></h3>

                <p><?echo $json[5]['nama'];?></p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?echo $json[0]['jumlah'];?></h3>

                <p><?echo $json[0]['nama'];?></p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?echo $json[1]['jumlah'];?></h3>

                <p><?echo $json[1]['nama'];?></p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3><?echo $totalJFT=$json[2]['jumlah']+$json[3]['jumlah']+$json[4]['jumlah'];?></h3>

                <p><?echo $json[2]['nama'];?></p>
              </div>
              <div class="icon">
