...
$arrtabledata= array(
  ...
  , array("label"=>"Tipe Diklat/Kursus", "field"=> "TIPE_DIKLAT_NAMA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
  , array("label"=>"Nama Diklat", "field"=> "NAMA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
  ...
  , array("label"=>"fieldrowid", "field"=> "DIKLAT_KURSUS_ID", "display"=>"1", "width"=>"")
    ...
    <div class="wrapper">
        <section id="content-full">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m12 l12">
                            ...
                            <h5 class="breadcrumbs-title">Sinkron Kursus</h5>
            ...
            <div class="area-parameter no-marginbottom">
              ...
              <div id="settoggle">
                <div class="row">
                  <div class="col s3 m2">Tipe Diklat/Kursus</div>
                  <div class="col s2 m1 select-semicolon">:</div>
                  <div class="col s3 m3">
                    <select id="reqTipeKursus">
                    <option value="" <? if("" == $reqTipeKursus) echo "selected";?>>Semua</option>
	                  <?
                    foreach($arrtipekursus as $item) 
                    {
                      $selectvalid= $item["id"];
                      $selectvaltext= $item["text"];
	                  ?>
	                    <option value="<?=$selectvalid?>" <? if($selectvalid == $reqTipeKursus) echo "selected";?> ><?=$selectvaltext?></option>
	                  <?
	                  }
	                  ?>
	                  </select>
...
<script type="text/javascript">
    ...
    $("#btncetak").on("click", function () {
      var reqGlobalValidasiCheck= reqCariFilter= reqSatuanKerjaId= reqTipeKursus= reqTipeKursus= reqTipeKursus= "";
      ...
      newWindow = window.open("app/loadUrl/app/talenta_rekam_jejak_excel.php?reqBulan=<?=date('m')?>&reqTahun=<?=date('Y')?>&reqPencarian="+reqCariFilter+"&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqTipeKursus="+reqTipeKursus+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqEselonGroupId="+reqEselonGroupId, 'Cetak');
      newWindow.focus();
    });
    ...
    $("#btnEdit").on("click", function () {
      ...
      ajaxurl= "json/sepadan_json/sessdetil?m=diklatkursus&reqId="+valinfoid+"&reqRowId="+valinforowid+"&reqTipeKursusId="+valinfojenisid;
    ...
    $('#btnCari').on('click', function () {
      var reqGlobalValidasiCheck= reqCariFilter= reqSatuanKerjaId= reqTipeKursus= reqTahun= "";
      // reqPencarian= $('#example_filter input').val();
      reqSatuanKerjaId= $("#reqSatuanKerjaId").val();
      reqCariFilter= $("#reqCariFilter").val();
      reqTipeKursus= $("#reqTipeKursus").val();
      ...
      jsonurl= "json/sepadan_json/jsondiklatkursus?reqPencarian="+reqCariFilter+"&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqTipeKursus="+reqTipeKursus+"&reqTahun="+reqTahun;
    ...
    jQuery(document).ready(function() {
      var jsonurl= "json/sepadan_json/jsondiklatkursus";
