...
$('#btnLog').on('click', function () {
	window.parent.openPopup("app/loadUrl/app/informasi_data_log?reqjson=jenis_pengadaan_json/log&reqjudul=Jenis Pengadaan Log");
					...
					<div class="container">
						<div class="row">
							<div class="col s12 m12 l12">
								...
								<h5 class="breadcrumbs-title">Jenis Pengadaan</h5>
							</div>
						</div>
					</div>
				</div>
