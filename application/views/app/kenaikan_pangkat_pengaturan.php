...
<script type="text/javascript" charset="utf-8">
  ...
  $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
           ...
           "bProcessing": true,
           "bServerSide": true,
           "sAjaxSource": "pengaturan_kenaikan_pangkat_json/json",			  
        ...
        $("#btnCari").on("click", function () {
            tempJsonParsing= "";
              ...
              oTable.fnReloadAjax("pengaturan_kenaikan_pangkat_json/json?"+tempJsonParsing);
          });

        $('#btnAdd').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/kenaikan_pangkat_pengaturan_add");
        ...
        $('#btnEdit').on('click', function () {
        	if(anSelectedData == "")
        		return false;				
        	window.parent.openPopup("app/loadUrl/app/kenaikan_pangkat_pengaturan_add/?reqId="+anSelectedId);
        ...
        $('#btnDelete').on('click', function () {
        	...
        	$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
        		if (r){
        			$.getJSON("pengaturan_kenaikan_pangkat_json/delete/?reqId="+anSelectedId,
        				function(data){
        					$.messager.alert('Info', data.PESAN, 'info');
        					oTable.fnReloadAjax("pengaturan_kenaikan_pangkat_json/json");
        				});
        ...
        $('#btnLog').on('click', function () {
            window.parent.openPopup("app/loadUrl/app/informasi_data_log?reqjson=pengaturan_kenaikan_pangkat_json/log&reqjudul=Pangkat Log");
...
function hapusData(id, statusaktif)
{
    ...
    if(statusaktif == "")
    {
        ...
        $.messager.confirm('Konfirmasi', infoMode+" ?",function(r){
            if (r){
                var s_url= "pengaturan_kenaikan_pangkat_json/delete/?reqMode="+reqmode+"&reqId="+id;
                ...
                <div id="breadcrumbs-wrapper">
                    <div class="container">
                        <div class="row">
                            ...
                            <h5 class="breadcrumbs-title">Pengaturan Kenaikan Pangkat</h5>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="example" class="display mdl-data-table dt-responsive" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th rowspan="2" style="text-align:center">Batas Awal Usul</th>
                                    <th rowspan="2" style="text-align:center">Batas Akhir Usul Struktural</th>
                                    <th colspan="2" style="text-align:center">Batas Akhir Usul Non-Struktural</th>
                                    <th rowspan="2" style="text-align:center">Aksi</th>   
                                </tr>
                                <tr>
                                    <th style="text-align:center">Gol III/d kebawah</th>
                                    <th style="text-align:center">Gol IV/a keatas</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
