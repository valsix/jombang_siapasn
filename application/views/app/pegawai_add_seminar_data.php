...
{
  $reqMode = 'update';
  $statement= " AND A.SEMINAR_ID = ".$reqRowId." AND A.PEGAWAI_ID = ".$reqId;
  $set= new Seminar();
        ...
        onSubmit:function(){
          ...
          else
          {
            mbox.alert(infodata, {open_speed: 500}, interval = window.setInterval(function() 
            {
              ...
              mbox.close();
              document.location.href= "app/loadUrl/app/pegawai_add_seminar_data/?reqId=<?=$reqId?>&reqRowId="+rowid;
            }, 1000));
    ...
    <div class="row">
     <div class="col s12 m10 offset-m1">
       ...
       <ul class="collection card">
         <li class="collection-item ubah-color-warna">EDIT SEMINAR</li>
            ...
            <form id="ff" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="input-field col s12 m6">
                  ...
                  <label for="reqNamaSeminar">Nama Seminar</label>
                  <input type="text" name="reqNamaSeminar" id="reqNamaSeminar" <?=$read?> value="<?=$reqNamaSeminar?>" title="Nama seminar harus diisi" class="required" />
                </div>
              </div>
                ...
                <div class="input-field col s12">
                  ...
                  <script type="text/javascript">
                    $("#kembali").click(function() { 
                      document.location.href = "app/loadUrl/app/pegawai_add_seminar_monitoring?reqId=<?=$reqId?>";
                    });
                  </script>
