        ...
        $.ajax({'url': s_url,'success': function(msg){
          if(msg == ''){}
            else
            {
              ...
              document.location.href= "app/loadUrl/app/pegawai_add_diklat_fungsional_monitoring/?reqId="+pegawai_id;
            }
          }});
      }
    });  
  ...
  <div class="row">
    <div class="col s12 m10 offset-m1 ">
      ...
      <ul class="collection card">
        <li class="collection-item ubah-color-warna">RIWAYAT DIKLAT FUNGSIONAL</li>
        <li class="collection-item">
          <div class="row">
            ...
            {
            ?>
            <a style="cursor:pointer" onClick="parent.setload('pegawai_add_diklat_fungsional_data?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>')"> <i class="mdi-content-add-circle-outline"> <span class=" material-font">Tambah</span></i></a>
            <?
            }
            ?>
          </div>
          <table class="bordered striped md-text table_list tabel-responsif responsive-table" id="link-table">
            ...
            <tbody>
              ...
              while($set->nextRow())
              {
                $reqRowId = $set->getField('DIKLAT_FUNGSIONAL_ID');
                ...
                <tr>
                  ...
                  <td width="90px">
                    ...
                    <span>
                        <a href="javascript:void(0)" class="round waves-effect waves-light purple white-text" title="Log"  onclick="parent.openModal('app/loadUrl/app/informasi_data_log?reqjson=diklat_fungsional_json/log/<?=$reqRowId?>&reqjudul=Data Diklat Fungsional Log')">
                        <i class="mdi-action-query-builder"></i>
                      </a>
                    </span>
                    <span>
                      <?if($set->getField('STATUS')!=1):?>
                      <a href="javascript:void(0)" class="round waves-effect waves-light blue white-text" title="Ubah" onClick="parent.setload('pegawai_add_diklat_fungsional_data?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>')">
