...
$arrtabledata= array(
  ...
  , array("label"=>"Tahun SKP", "field"=> "TAHUN", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
  ...
  , array("label"=>"fieldinfotahun", "field"=> "TAHUN", "display"=>"1", "width"=>"")
  , array("label"=>"fieldrowid", "field"=> "PENILAIAN_SKP_ID", "display"=>"1", "width"=>"")
    ...
    <div class="wrapper">
        <section id="content-full">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m12 l12">
                            ...
                            <h5 class="breadcrumbs-title">Sinkron Kinerja</h5>
            ...
            <div class="area-parameter no-marginbottom">
              ...
              <div id="settoggle">
                <div class="row">
                  <div class="col s3 m2">Tahun SKP</div>
...
<script type="text/javascript">
    ...
    var valinfoid= valinforowid= valinfotahun='';
    ...
    $("#btnEdit").on("click", function () {
      ...
      ajaxurl= "json/sepadan_json/sessdetil?m=kinerja&reqId="+valinfoid+"&reqRowId="+valinforowid+"&reqTahun="+valinfotahun;
    ...
    $('#btnCari').on('click', function () {
      var reqGlobalValidasiCheck= reqCariFilter= reqSatuanKerjaId= reqTahun= "";
      // reqPencarian= $('#example_filter input').val();
      reqSatuanKerjaId= $("#reqSatuanKerjaId").val();
      reqCariFilter= $("#reqCariFilter").val();
      reqTahun= $("#reqTahun").val();

      jsonurl= "json/sepadan_json/jsonkinerja?reqPencarian="+reqCariFilter+"&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqTahun="+reqTahun;
    ...
    jQuery(document).ready(function() {
      var jsonurl= "json/sepadan_json/jsonkinerja";
    ...
    $(document).ready(function() {
        ...
        $('#example tbody').on( 'click', 'tr', function () {
            if ( $(this).hasClass('selected') ) {
                ...
                fieldinfotahun= arrdata[parseFloat(indexfieldid) - 2]["field"];

                if(typeof dataselected == "undefined")
                {
                  valinfoid= valinforowid= valinfotahun= "";
                }
                else
                {
