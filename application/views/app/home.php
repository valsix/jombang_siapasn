...
$vurlglobal= base_url();
// $vurlglobal= "https://siapasn.jombangkab.go.id/";
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <?
          $urllink= $vurlglobal.'statistik_json/dashboard_tipe_pegawai?reqSatuanKerjaId='.$reqSatuanKerjaId;
          // echo $urllink;exit;
          $data_dashboard_tipe_pegawai= file_get_contents($urllink, false, stream_context_create($arrContextOptions));
          ...
          <section class="col-lg-6 connectedSortable">
             <div class="card">
              <div class="card-header">
                ...
                <?
                $urllink= $vurlglobal.'statistik_json/dashboard_eselon?reqSatuanKerjaId='.$reqSatuanKerjaId;
                // echo $urllink;exit;
                $data_dashboard_eselon= file_get_contents($urllink, false, stream_context_create($arrContextOptions));
                ...
                <div class="col-xs-12 col-sm-12 col-lg-12">
                  <figure class="highcharts-figure">
                      ...
                      <p class="highcharts-description">
                        Data dapat berubah sewaktu-waktu dengan ada pembaharuan/koreksi data. 
                          <?
                            $urllink= $vurlglobal.'statistik_json/dashboard_pensiun?reqSatuanKerjaId='.$reqSatuanKerjaId;
                            // echo $urllink;exit;
                            $data_dashboard_pensiun= file_get_contents($urllink, false, stream_context_create($arrContextOptions));
                            $json_dashboard_pensiun = json_decode($data_dashboard_pensiun, TRUE);
                              ...
                              for($x=0;$x<12;$x++){
                                ...
                                $tahun_ini .= $json_dashboard_pensiun[$x]['jumlah'].$koma;
                              }
                              ...
                              for($x=12;$x<24;$x++){
                                ...
                                $tahun_depan .= $json_dashboard_pensiun[$x]['jumlah'].$koma;
                              }
...
<script type="text/javascript">
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'Perkiraan Pensiun'
        },
        subtitle: {
            text: ''
        },
        xAxis: {
            categories: ['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun', 'Jul', 'Agus', 'Sep', 'Oct', 'Nov', 'Des']
        },
        yAxis: {
            title: {
                text: 'Jumlah PNS'
