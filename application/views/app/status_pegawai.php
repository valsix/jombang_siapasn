...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "status_pegawai_json/json",			  
        ...
        $('#btnAdd').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/status_pegawai_add");
        ...
        $("#btnCari").on("click", function () {
        	tempJsonParsing= "";
					  ...
					  oTable.fnReloadAjax("status_pegawai_json/json?"+tempJsonParsing);
					});

        $('#btnEdit').on('click', function () {
        	if(anSelectedData == "")
        		return false;				
        	window.parent.openPopup("app/loadUrl/app/status_pegawai_add/?reqId="+anSelectedId);
...
$('#btnLog').on('click', function () {
	window.parent.openPopup("app/loadUrl/app/informasi_data_log?reqjson=status_pegawai_json/log&reqjudul=Status Pegawai Log");
...
function hapusData(id, statusaktif)
{
	...
	$.messager.confirm('Konfirmasi', infoMode+" ?",function(r){
		if (r){
			var s_url= "status_pegawai_json/delete/?reqMode="+reqmode+"&reqId="+id;
					...
					<div class="container">
						<div class="row">
							<div class="col s12 m12 l12">
								...
								<h5 class="breadcrumbs-title">Status Pegawai</h5>
							</div>
						</div>
					</div>
				</div>
