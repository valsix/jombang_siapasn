					...
					<form id="ff" method="post" novalidate enctype="multipart/form-data">
						<div class="content" style="height:90%; width:100%;overflow:hidden; overflow:-x:hidden; overflow-y:auto; position:fixed;">
							...
							<div class="form-group" >
								...
								<label for="" class="col-md-1" >Status Pendidikan</label>
								<div class="col-md-2">
							...
							<div class="form-group" >
								...
								<label for="" class="col-md-2" >Gelar</label>
								<div class="col-md-4">
							...
							<div class="form-group" >
								...
								<div class="col-md-4">
									<textarea name="reqAlamatSekolah"  class="required form-control"><?=$tempAlamatSekolah?></textarea>
								</div>
							</div>
