...
$arrtabledata= array(
  ...
  , array("label"=>"Nama Jabatan", "field"=> "NAMA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
  , array("label"=>"TMT Jabatan", "field"=> "TMT_JABATAN", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
  , array("label"=>"Jenis Jabatan", "field"=> "JENIS_JABATAN_NAMA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
  ...
  , array("label"=>"fieldinfojenisid", "field"=> "JENIS_JABATAN_ID", "display"=>"1", "width"=>"")
  , array("label"=>"fieldrowid", "field"=> "JABATAN_RIWAYAT_ID", "display"=>"1", "width"=>"")
  , array("label"=>"fieldid", "field"=> "PEGAWAI_ID", "display"=>"1", "width"=>"")
);

$arrjenisjabatan= array(
  array("id"=>"", "text"=>"Semua")
    ...
    <div class="wrapper">
        <section id="content-full">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m12 l12">
                            ...
                            <h5 class="breadcrumbs-title">Sinkron Jabatan</h5>
            ...
            <div class="area-parameter no-marginbottom">
              ...
              <div id="settoggle">
                <div class="row">
                  <div class="col s3 m2">Jenis Jabatan</div>
                  <div class="col s2 m1 select-semicolon">:</div>
                  <div class="col s3 m3">
                    <select id="reqJenisJabatan">
                    <option value="" <? if("" == $reqJenisJabatan) echo "selected";?>>Semua</option>
	                  <?
                    foreach($arrjenisjabatan as $item) 
                    {
	                  ...
	                  ?>
	                    <option value="<?=$selectvalid?>" <? if($selectvalid == $reqJenisJabatan) echo "selected";?> ><?=$selectvaltext?></option>
	                  <?
	                  }
	                  ?>
	                  </select>
                  ...
                  <div class="col s3 m2">Tahun TMT Jabatan</div>
                  <div class="col s2 m1 select-semicolon">:</div>
                  <div class="col s3 m1">
...
<script type="text/javascript">
    ...
    $("#btncetak").on("click", function () {
      var reqGlobalValidasiCheck= reqCariFilter= reqSatuanKerjaId= reqJenisJabatan= reqJenisJabatan= reqJenisJabatan= "";
      ...
      newWindow = window.open("app/loadUrl/app/talenta_rekam_jejak_excel.php?reqBulan=<?=date('m')?>&reqTahun=<?=date('Y')?>&reqPencarian="+reqCariFilter+"&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqJenisJabatan="+reqJenisJabatan+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqEselonGroupId="+reqEselonGroupId, 'Cetak');
      newWindow.focus();
    });
    ...
    $("#btnEdit").on("click", function () {
      ...
      ajaxurl= "json/sepadan_json/sessdetil?m=jabatanriwayat&reqId="+valinfoid+"&reqRowId="+valinforowid+"&reqJenisJabatanId="+valinfojenisid;
    ...
    $('#btnCari').on('click', function () {
      var reqGlobalValidasiCheck= reqCariFilter= reqSatuanKerjaId= reqJenisJabatan= reqTahun= "";
      // reqPencarian= $('#example_filter input').val();
      reqSatuanKerjaId= $("#reqSatuanKerjaId").val();
      reqCariFilter= $("#reqCariFilter").val();
      reqJenisJabatan= $("#reqJenisJabatan").val();
      ...
      jsonurl= "json/sepadan_json/jsonjabatan?reqPencarian="+reqCariFilter+"&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqJenisJabatan="+reqJenisJabatan+"&reqTahun="+reqTahun;
    ...
    jQuery(document).ready(function() {
      var jsonurl= "json/sepadan_json/jsonjabatan";
