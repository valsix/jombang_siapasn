				...
				<table class="table">
					<thead>
						<tr>           
							...
							<td>:</td>
							<td>
								<input name="reqNama" class="easyui-validatebox" style="width:170px" type="text" required value="<?=$reqNama?>" />
							</td>			
						</tr>  
						<tr>           
							<td>Kode</td>
							<td>:</td>
							<td>
								<input name="reqKode" class="easyui-validatebox" style="width:170px" type="text" required value="<?=$reqKode?>" />
							</td>			
						</tr>  
