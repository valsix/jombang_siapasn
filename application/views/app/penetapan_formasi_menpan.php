...
<script type="text/javascript" charset="utf-8">
  ...
  $(document).ready( function () {
   ...
   $('#btnAdd').on('click', function () {
       window.parent.openPopup("app/loadUrl/app/penetapan_formasi_menpan_add");
   ...
   $('#btnEdit').on('click', function () {
       if(anSelectedData == "")
          return false;				
      window.parent.openPopup("app/loadUrl/app/penetapan_formasi_menpan_add/?reqId="+anSelectedId);
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <h5 class="breadcrumbs-title">Penetapan Formasi Menpan</h5>
                            </div>
                        </div>
                    </div>
                </div>
