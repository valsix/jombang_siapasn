...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "gaji_pokok_json/json",			  
        ...
        $("#btnCari").on("click", function () {
        	tempJsonParsing= "";
				  ...
				  oTable.fnReloadAjax("gaji_pokok_json/json?"+tempJsonParsing);
				});

        $('#btnAdd').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/gaji_pokok_add");
        ...
        $('#btnEdit').on('click', function () {
        	if(anSelectedData == "")
        		return false;				
        	window.parent.openPopup("app/loadUrl/app/gaji_pokok_add/?reqId="+anSelectedId);
        ...
        $('#btnDelete').on('click', function () {
        	...
        	$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
        		if (r){
        			$.getJSON("gaji_pokok_json/delete/?reqId="+anSelectedId,
        				function(data){
        ...
        $('#btnLog').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/informasi_data_log?reqjson=gaji_pokok_json/log&reqjudul=Gaji Pokok Log");
					...
					<div class="container">
						<div class="row">
							<div class="col s12 m12 l12">
								...
								<h5 class="breadcrumbs-title">Gaji Pokok</h5>
							</div>
						</div>
					</div>
				</div>
