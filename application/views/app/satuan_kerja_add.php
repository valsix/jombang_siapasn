...
else
{
  ...
  $reqStatusSediaan= $set->getField("STATUS_SEDIAAN");
  $reqSatuanKerjaSediaanId= $set->getField("SATUAN_KERJA_SEDIAAN");
  $reqSatuanKerjaSediaanNama= $set->getField("SATUAN_KERJA_SEDIAAN_NAMA");
...
<head>
  ...
  <script type="text/javascript">	
    $(function(){
      ...
      $('input[id^="reqSatuanKerjaUrutanSurat"], input[id^="reqSatuanKerjaSediaanNama"], input[id^="reqSatuanKerjaInduk"]').keyup(function() {
        ...
        if(valid == "")
        {
          ...
          else if (id.indexOf('reqSatuanKerjaSediaanNama') !== -1)
          {
            var element= id.split('reqSatuanKerjaSediaanNama');
            var indexId= "reqSatuanKerjaSediaanId"+element[1];
          }
    ...
    $('input[id^="reqSatuanKerjaUrutanSurat"], input[id^="reqSatuanKerjaSediaanNama"], input[id^="reqSatuanKerjaInduk"]').each(function(){
    $(this).autocomplete({
      ...
      <div class="row">
        ...
        <div class="input-field col s12 m4">
          <select id="reqSatuanKerjaMutasiStatus" name="reqSatuanKerjaMutasiStatus">
            ...
            <option value="" <? if($reqSatuanKerjaMutasiStatus == "") echo "selected"?>>Tidak</option>
          </select>
        </div>
      </div>

      <div class="row">
        <label for="reqSatuanKerjaSediaanId" class="col s12 m2 label-control">Satuan Kerja Sediaan Teruskan</label>
        <div class="input-field col s12 m4">
          <input type="text" id="reqSatuanKerjaSediaanNama" <?=$read?> value="<?=$reqSatuanKerjaSediaanNama?>" class="" />
          <input type="hidden" name="reqSatuanKerjaSediaanId" id="reqSatuanKerjaSediaanId" value="<?=$reqSatuanKerjaSediaanId?>" />
        </div>
        <label for="reqStatusSediaan" class="col s12 m2 label-control">Status Sediaan</label>
        <div class="input-field col s12 m4">
          <select id="reqStatusSediaan" name="reqStatusSediaan">
            <option value="1" <? if($reqStatusSediaan == "1") echo "selected"?>>Ya</option>
            <option value="" <? if($reqStatusSediaan == "") echo "selected"?>>Tidak</option>
            <option value="2" <? if($reqStatusSediaan == "2") echo "selected"?>>Tujuan Awal</option>
          </select>
        </div>
      </div>

      <div class="row">
        <label for="reqRumpunId" class="col s12 m2 label-control">Rumpun</label>
        <div class="input-field col s12 m4">
          <select id="reqRumpunId" name="reqRumpunId">
            <option value=""></option>
            <?
            ...
            ?>
              <option value="<?=$optionid?>" <? if($reqRumpunId == $optionid) echo "selected";?>><?=$optiontext?></option>
            <?
            }
            ?>
          </select>
