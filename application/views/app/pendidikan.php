...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "pendidikan_json/json",			  
        ...
        $('#btnAdd').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/pendidikan_add");
        ...
        $("#btnCari").on("click", function () {
        	tempJsonParsing= "";
					  ...
					  oTable.fnReloadAjax("pendidikan_json/json?"+tempJsonParsing);
					});

        $('#btnEdit').on('click', function () {
        	if(anSelectedData == "")
        		return false;				
        	window.parent.openPopup("app/loadUrl/app/pendidikan_add/?reqId="+anSelectedId);
        ...
        $('#btnLog').on('click', function () {
            window.parent.openPopup("app/loadUrl/app/informasi_data_log?reqjson=pendidikan_json/log&reqjudul=Pendidikan Log");
					...
					<div class="container">
						<div class="row">
							<div class="col s12 m12 l12">
								...
								<h5 class="breadcrumbs-title">Pendidikan</h5>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="section">
						<table id="example" class="display mdl-data-table dt-responsive" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th>NAMA</th>                                       
									<th>PANGKAT_MINIMAL</th>                                       
									<th>PANGKAT_MAKSIMAL</th>                                       
									<th>NO_URUT</th>                                       
									<th>AKSI</th>        
								</tr>
							</thead>
