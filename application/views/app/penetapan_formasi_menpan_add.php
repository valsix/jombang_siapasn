	...
	<div class="container-fluid full-height">
		<div class="row full-height">
			<div class="col-md-12 area-form full-height">
				...
				<div id="judul-popup">Tambah Penetapan Formasi Menpan</div>
				<div id="area-form-inner">
					<form id="ff" method="post"  novalidate enctype="multipart/form-data">
						<table class="table">
							<tr>
								<td>Perangkat Daerah / Unit Organisasi</td>
								<td>

								</td>			
							</tr>
							<tr>    
								<td>No Surat Penetapan Formasi</td>
								<td>
									<input name="reqNama" class="easyui-validatebox" required style="width:200px" type="text" value="<?=$reqNama?>" />									
								</td>
								<td>Tanggal Surat</td>
								<td>
									<input name="reqNama" class="easyui-validatebox" required style="width:200px" type="date" value="<?=$reqNama?>" />			
								</td>
							</tr> 
							<tr>
								<td>Nama Jabatan Penetapan Formasi</td>
								<td>
									<input name="reqNama" class="easyui-validatebox" required style="width:200px" type="text" value="<?=$reqNama?>" />									
								</td>
								<td>Jumlah Penetapan Formasi</td>
								<td>
									<input name="reqNama" class="easyui-validatebox" required style="width:200px" type="text" value="<?=$reqNama?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" />									
								</td>			
							</tr> 
							<tr>
								<td>Surat Dokumen</td>
								<td>
									<input name="reqNama" class="easyui-validatebox" required style="width:200px" type="file" value="<?=$reqNama?>" />									
								</td>
								<td>Lihat Dokumen</td>
								<td>
