        ...
        <li class="collection-item">
          <div class="row">
            ...
            ?>
              ...
              {
              ?>
              onClick="parent.setappload('pegawai_add_skp23_data?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>&pelayananid=<?=$pelayananid?>&pelayananjenis=<?=$pelayananjenis?>&pelayananrowid=<?=$pelayananrowid?>&pelayanankembali=<?=$pelayanankembali?>')"
              <?
              }
              else
              {
              ?>
              onClick="parent.setload('pegawai_add_skp23_data?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>')"
              <?
              }
              ?>
              > <i class="mdi-content-add-circle-outline"> <span class=" material-font">Tambah SKP 2023 TW I</span></i></a>
