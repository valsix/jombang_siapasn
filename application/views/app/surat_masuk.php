...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "surat_masuk_json/json",
        	"sScrollX": "100%",								  
        	"sScrollXInner": "100%",
        ...
        $('#btnAdd').on('click', function () {
        	newWindow = window.open("app/loadUrl/app/surat_masuk_add", 'Cetak'+tempindextab);
        	newWindow.focus();
        ...
        $('#btnEdit').on('click', function () {
        	if(anSelectedData == "")
        		return false;				
        	newWindow = window.open("app/loadUrl/app/surat_masuk_add?reqRowId="+anSelectedId, 'Cetak'+tempindextab);
        	newWindow.focus();
			tempindextab= parseInt(tempindextab) + 1;
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("surat_masuk_json/json");
		});
		...
		$('#btnDelete').on('click', function () {
        	...
        	$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
        		if (r){
        			$.getJSON("surat_masuk_json/delete/?reqRowId="+anSelectedId,
        				function(data){
        ...
        $('#btnLog').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/surat_masuk_log");
				...
				<div id="breadcrumbs-wrapper">
					<div class="container">
						<div class="row">
							...
							<h5 class="breadcrumbs-title">Surat Masuk</h5>
						...
						<table id="example" class="display mdl-data-table dt-responsive" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th style="text-align:center">SATUAN KERJA ASAL</th>
									<th style="text-align:center">SATUAN KERJA TUJUAN</th>
                                    <th style="text-align:center">TANGGAL</th>
                                    <th style="text-align:center">TANGGAL DITERUSKAN</th>
                                    <th style="text-align:center">TANGGAL BATAS</th>
								</tr>
							</thead>
						</table>
					</div>
