...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        ?>
        		<li><a id="<?=$tempMenuId?>" onClick="executeOnClick('<?=$tempMenuId?>');"><i class="fa fa-circle-o"></i> <?=$tempNama?></a></li>
        <?
                }
            }
        ?>
  ...
  <div class="content-wrapper wrapper-konten-utama-popup">
...
<?php */?>
    ...
    <!-- Main content -->
    <section class="content area-konten-utama-popup">
