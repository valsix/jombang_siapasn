...
$arrpegawaisatuankerja= $vfpeg->getpegawaisatuankerja($reqSatuanKerjaId);
...
$judulfield= "";
$judulfield= array("No.", "NIP", "NIP Baru", "Nama", "Tempat Lahir", "Tanggal Lahir", "L/P", "Status", "Gol. Ruang", "TMT Pangkat", "Tipe Pegawai", "Eselon", "Jabatan", "TMT Jabatan", "Agama", "Telepon", "Alamat", "Satuan Kerja", "Satuan Kerja", "TMT Pensiun", "Pendidikan", "Lulus", "Keterangan");

$field= "";
$field= array("NO", "NIP_LAMA", "NIP_BARU", "NAMA", "TEMPAT_LAHIR", "TANGGAL_LAHIR", "JENIS_KELAMIN", "STATUS_PEGAWAI", "GOL_RUANG", "TMT_PANGKAT", "TIPE_PEGAWAI", "ESELON", "JABATAN", "TMT_JABATAN", "AGAMA", "TELEPON", "ALAMAT", "SATKER_INDUK", "NAMA_SATKER", "TMT_PENSIUN", "PENDIDIKAN", "LULUS", "KETERANGAN");
...
$set->selectByParamsCetakPegawai(array(), -1, -1, $statement.$searchJson, $sOrder);
// echo $set->query;exit;
?>
<!DOCTYPE html>
<html lang="en">
