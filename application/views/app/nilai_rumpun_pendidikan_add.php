...
$statement= " AND A.PENDIDIKAN_ID IN (".$reqId.")";
$set= new RumpunNilai();
$set->selectrumpunpendidikan(array(), -1, -1, $statement);
$arrdatainfo=[];
while($set->nextRow())
{
	$arrdata= [];
...
<head>
	...
	<script type="text/javascript">	
		$(function(){
			...
			$('#ff').form({
				url:'json/rumpun_nilai_json/addpendidikan',
				onSubmit:function(){
					var reqPangkatId= "";
         			...
         			else
         			{
         				mbox.alert(infodata, {open_speed: 500}, interval = window.setInterval(function() 
         				{
							clearInterval(interval);
         					mbox.close();
         					document.location.href= "app/loadUrl/app/nilai_rumpun_pendidikan_add/?reqId=<?=$reqId?>";
         				}, 1000));
	...
	<div class="container-fluid full-height">
		<div class="row full-height">
			<div class="col-md-12 area-form full-height">
				...
				<div class="ubah-color-warna white-text" style="padding: 1em">Setting Nilai Rumpun Pendidikan</div>
					...
					<form id="ff" method="post"  novalidate enctype="multipart/form-data">
						...
						<table class="striped tabel-responsif">
	                        ...
	                        <tbody>
		                        ...
		                        {
		                        	$infodetilid= $valuedetil["PENDIDIKAN_ID"];
