...
$arrData= array("NIP", "Nama", "SKP", "SKPx60%", "Orientasi", "Integritas", "Komitmen", "Displin", "Kerjasama", "Kepemimpinan", "Jumlah Nilai", "Rata-rata", "NPKx40%", "Nilai Prestasi Kerja", "Unit Kerja", "INDUK");
?>
...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "penilaian_skp_json/json?reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>",
        	"sScrollX": "100%",								  
        	"sScrollXInner": "100%",
        ...
        $('#btnProses').on('click', function () {
		  ...
		  oTable.fnReloadAjax("penilaian_skp_json/json?reqMode=proses&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqPangkatId="+reqPangkatId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&sSearch="+reqCariFilter);
		...
		$('#btnCetak').on('click', function () {
			  ...
			  reqTahun= $("#reqTahun").val();
		   	  ...
		   	  opUrl= "app/loadUrl/app/skp_pegawai_excel.php?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqPangkatId="+reqPangkatId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&sSearch="+reqCariFilter;
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("penilaian_skp_json/json?reqSatuanKerjaId="+reqSatuanKerjaId+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqPangkatId="+reqPangkatId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&sSearch="+reqCariFilter);
		});
			...
			<section id="content-full">
				...
				<div id="breadcrumbs-wrapper">
					<div class="container">
						<div class="row">
							...
							<h5 class="breadcrumbs-title">SKP</h5>
				...
				<div class="area-parameter">
                	<div class="kiri">
                       ...
                       <input type="hidden" id="reqBulan" value="" />
                       <!-- <select id='reqBulan'>
