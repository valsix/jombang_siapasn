	...
	<div id="konten">
		<div id="popup-tabel2">
			<form id="ff" method="post"  novalidate enctype="multipart/form-data">
					...
					<div class="simpleTabsContent">
						<table class="table">
							...
							<tr>
								...
								<td>:</td>
								<td>
									<input required name="reqNama" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqNama?>" />
								</td>
							</tr>
							...
							<tr>
								...
								<td>:</td>
								<td>
									<input name="reqTempatLahir" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqTempatLahir?>" />
								</td>
							</tr>
							<tr>
								<td>Tanggal Lahir</td>
								<td>:</td>
								<td>
									<input name="reqTanggalLahir" class="easyui-validatebox" style="width:300px" type="date"  value="<?=$reqTanggalLahir?>" />
								</td>
							</tr>
							<tr>
								<td>Jenis Kelamin</td>
								<td>:</td>
								<td>
									<select name="reqJenisKelamin" id="reqJenisKelamin" style="width:300px" >
							...
							<tr>
								...
								<td>:</td>
								<td>
									<select name="reqStatusKawin" id="reqStatusKawin" style="width:300px" >
							...
							<tr>
								...
								<td>:</td>
								<td>
									<input name="reqSukuBangsa" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqSukuBangsa?>" />
								</td>
							</tr>
							<tr>
								...
								<td>:</td>
								<td>
									<select name="reqGolonganDarah" id="reqGolonganDarah" style="width:300px" >
							...
							<tr>
								...
								<td>:</td>
								<td>
									<input name="reqNoRekening" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqNoRekening?>" />
								</td>
							</tr>
							...
							<tr>
								...
								<td>:</td>
								<td>
									<select name="reqBank" id="reqBank" style="width:300px" >
										<?
							...
							<tr>
								...
								<td>:</td>
								<td>
									<select name="reqAgama" id="reqAgama" style="width:300px" >
										<?
					...
					<div class="simpleTabsContent">
						<table class="table">
							...
							<tr>
								...
								<td>:</td>
								<td>
									<input name="reqAlamat" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqAlamat?>" />
								</td>
							</tr>
							<tr>
								<td>RT</td>
								<td>:</td>
								<td>
									<input name="reqRt" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqRt?>" />
								</td>
							</tr>
							<tr>
								<td>RW</td>
								<td>:</td>
								<td>
									<input name="reqRw" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqRw?>" />
								</td>
							</tr>
							<tr>
								<td>Kode Pos</td>
								<td>:</td>
								<td>
									<input name="reqKodePos" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqKodePos?>" />
								</td>
							</tr>
							<!-- </thead> -->
						</table>
					...
					<div class="simpleTabsContent">
						<table class="table">
							...
							<tr>
								...
								<td>:</td>
								<td>
									<input name="reqEmail" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqEmail?>" />
								</td>
							</tr>
							<tr>
								<td>Telepon</td>
								<td>:</td>
								<td>
									<input name="reqTelepon" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqTelepon?>" />
								</td>
							</tr>
							<tr>
								<td>HP</td>
								<td>:</td>
								<td>
									<input name="reqHp" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqHp?>" />
								</td>
							</tr>
							<tr>
								<td>Kartu Pegawai</td>
								<td>:</td>
								<td>
									<input name="reqKartuPegawai" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqKartuPegawai?>" />
								</td>
							</tr>
							<!-- </thead> -->
						</table>
					...
					<div class="simpleTabsContent">
						<table class="table">
							...
							<tr>
								...
								<td>:</td>
								<td>
									<select name="reqStatus" id="reqStatus" style="width:300px" >
							...
							<tr>
								...
								<td>:</td>
								<td>
									<select name="reqSatuanKerja" id="reqSatuanKerja" style="width:300px" >
										<?
							...
							<tr>
								...
								<td>:</td>
								<td>
									<select name="reqJenisPegawai" id="reqJenisPegawai" style="width:300px" >
										<?
							...
							<tr>
								...
								<td>:</td>
								<td>
									<input name="reqTipePegawai" class="easyui-validatebox" style="width:300px" type="number"  value="<?=$reqTipePegawai?>" />
								</td>
							</tr>
							<tr>
								...
								<td>:</td>
								<td>
									<input name="reqStatusPegawai" class="easyui-validatebox" style="width:300px" type="number"  value="<?=$reqStatusPegawai?>" />
								</td>
							</tr>
							<tr>
								<td>NIP Lama</td>
								<td>:</td>
								<td>
									<input name="reqNipLama" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqNipLama?>" />
								</td>
							</tr>
							<tr>
								<td>NIP Baru</td>
								<td>:</td>
								<td>
									<input required name="reqNipBaru" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqNipBaru?>" />
								</td>
							</tr>
							<tr>
								<td>Gelar Depan</td>
								<td>:</td>
								<td>
									<input name="reqGelarDepan" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqGelarDepan?>" />
								</td>
							</tr>
							<tr>
								...
								<td>:</td>
								<td>
									<input name="reqGelarBelakang" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqGelarBelakang?>" />
								</td>
							</tr>
							<tr>
								<td>Askes</td>
								<td>:</td>
								<td>
									<input name="reqAskes" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqAskes?>" />
								</td>
							</tr>
							<tr>
								<td>Taspen</td>
								<td>:</td>
								<td>
									<input name="reqTaspen" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqTaspen?>" />
								</td>
							</tr>
							...
							<tr>
								...
								<td>:</td>
								<td>
									<input name="reqNpwp" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqNpwp?>" />
								</td>
							</tr>
							<tr>
								<td>NIK</td>
								<td>:</td>
								<td>
									<input name="reqNik" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqNik?>" />
								</td>
							</tr>
							<tr>
								...
								<td>:</td>
								<td>
									<input name="reqSkKonversiNip" class="easyui-validatebox" style="width:300px" type="text"  value="<?=$reqSkKonversiNip?>" />
								</td>
							</tr>
							<!-- </thead> -->
						</table>
                ...
                <a href="#" onclick="$('#ff').submit();"><img src="images/icon-verifikasi.png" width="15" height="15"/> SIMPAN</a>
