		...
		<div class="row">
			<div class="col s12 m10 offset-m1">
				<ul class="collection card">
					<li class="collection-item ubah-color-warna" style="color: black;"><?=$reqNamaFile?></li>
					<li class="collection-item">
						<form id="ff" method="post" enctype="multipart/form-data">
                            ...
                            <? if($reqUrlFilePecah[count($reqUrlFilePecah)-1]=='pdf' || $reqUrlFilePecah[count($reqUrlFilePecah)-1]=='doc' || $reqUrlFilePecah[count($reqUrlFilePecah)-1]=='docx' || $reqUrlFilePecah[count($reqUrlFilePecah)-1]=='pptx'){?>
                            <div>
                            	<iframe style="width: 100%; height: 100%;"  src="<?=base_url()?>/lib/ViewerJS/#../../<?=$reqUrlFile?>"></iframe>
                            </div>
                            <?}
                            else{?>
														<div>
                            	<center><img src="<?=$reqUrlFile?>" alt="Italian Trulli"></center>
                            </div>
                            <?}?>
