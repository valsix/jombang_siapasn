			...
			<div class="col s12 m10 offset-m1">
              ...
              <div class="row">
              	<div class="input-field col s12 m12">
              		...
              		<input type="text" id="reqNameFileEdit" name="reqNameFileEdit" <?=$read?> value="<?=$reqLinkFileAsli?>" class="easyui-validatebox" />
              		<!-- <label for="reqNameFileaEdit">Nama File </label> -->
              	</div>
              </div>
               <div class="row">
                  <div class="input-field col s12">
                  	<input type="checkbox" id="reqPrioritas" name="reqPrioritas" value="1" <? if($reqPrioritas == 1) echo 'checked'?> >
