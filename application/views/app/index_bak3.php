...
<div class="wrapper">
  ...
  <aside class="main-sidebar" style="border:2px solid lime; height:300px !important; padding:10px; margin:5px; display:none;">
    <!-- sidebar: style can be found in sidebar.less -->
    <section class="sidebar" style="max-height:300px; border:1px solid yellow;">
      <!-- Sidebar user panel -->
      ...
      <ul class="sidebar-menu" data-widget="tree" style="border:1px solid red; max-height:100px; overflow:auto;">
  ...
  <div class="content-wrapper" style="border:5px solid green; max-height:calc(100vh - 400px) !important; min-height: 402.8px !important; height:300px !important; display:;">
    ...
    <!-- Main content -->
    <section class="content area-main" style="border:1px solid red;">
