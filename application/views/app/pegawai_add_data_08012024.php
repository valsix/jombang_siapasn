...
if(!empty($reqNipBaru))
{
	...
	{
		$arrdata= [];
		$reqBkn= $arrdata["id"]= $setdetil->getField("id");
		$reqBknNipBaru= $arrdata["nipBaru"]= $setdetil->getField("nipBaru");
		$reqBknNipLama= $arrdata["nipLama"]= $setdetil->getField("nipLama");
		$reqBknNama= $arrdata["nama"]= $setdetil->getField("nama");
		$reqBknGelarDepan= $arrdata["gelarDepan"]= $setdetil->getField("gelarDepan");
		$reqBknGelarBelakang= $arrdata["gelarBelakang"]= $setdetil->getField("gelarBelakang");
		$reqBknTempatLahir= $arrdata["tempatLahir"]= $setdetil->getField("tempatLahir");
		$arrdata["tempatLahirId"]= $setdetil->getField("tempatLahirId");
		$arrdata["tglLahir"]= $setdetil->getField("tglLahir");
		$reqBknAgama= $arrdata["agama"]= $setdetil->getField("agama");
		$arrdata["agamaId"]= $setdetil->getField("agamaId");
		$arrdata["email"]= $setdetil->getField("email");
		$arrdata["emailGov"]= $setdetil->getField("emailGov");
		$arrdata["nik"]= $setdetil->getField("nik");
		$arrdata["alamat"]= $setdetil->getField("alamat");
		$arrdata["noHp"]= $setdetil->getField("noHp");
		$arrdata["noTelp"]= $setdetil->getField("noTelp");
		$arrdata["jenisPegawaiId"]= $setdetil->getField("jenisPegawaiId");
		$arrdata["mkTahun"]= $setdetil->getField("mkTahun");
		$arrdata["mkBulan"]= $setdetil->getField("mkBulan");
		$reqBknJenisPegawaiNama= $arrdata["jenisPegawaiNama"]= $setdetil->getField("jenisPegawaiNama");
		$arrdata["kedudukanPnsId"]= $setdetil->getField("kedudukanPnsId");
		$reqBknPegawaiKedudukanNama= $arrdata["kedudukanPnsNama"]= $setdetil->getField("kedudukanPnsNama");
		$reqBknStatusPegawai= $arrdata["statusPegawai"]= $setdetil->getField("statusPegawai");
		$reqBknJenisKelamin= $arrdata["jenisKelamin"]= $setdetil->getField("jenisKelamin");
		if($reqBknJenisKelamin == "M")
			$reqBknJenisKelamin= "Laki-laki";
		else
			$reqBknJenisKelamin= "Perempuan";

		$arrdata["jenisIdDokumenId"]= $setdetil->getField("jenisIdDokumenId");
		$arrdata["jenisIdDokumenNama"]= $setdetil->getField("jenisIdDokumenNama");
		$arrdata["nomorIdDocument"]= $setdetil->getField("nomorIdDocument");
		$arrdata["noSeriKarpeg"]= $setdetil->getField("noSeriKarpeg");
		$arrdata["tkPendidikanTerakhirId"]= $setdetil->getField("tkPendidikanTerakhirId");
		$arrdata["tkPendidikanTerakhir"]= $setdetil->getField("tkPendidikanTerakhir");
		$arrdata["pendidikanTerakhirId"]= $setdetil->getField("pendidikanTerakhirId");
		$reqBknPendidikanAkhir= $arrdata["pendidikanTerakhirNama"]= $setdetil->getField("pendidikanTerakhirNama");
		$arrdata["tahunLulus"]= $setdetil->getField("tahunLulus");
		$arrdata["tmtPns"]= $setdetil->getField("tmtPns");
		$arrdata["tmtPensiun"]= $setdetil->getField("tmtPensiun");
		$arrdata["bupPensiun"]= $setdetil->getField("bupPensiun");
		$arrdata["tglSkPns"]= $setdetil->getField("tglSkPns");
		$arrdata["tmtCpns"]= $setdetil->getField("tmtCpns");
		$arrdata["tglSkCpns"]= $setdetil->getField("tglSkCpns");
		$arrdata["instansiIndukId"]= $setdetil->getField("instansiIndukId");
		$arrdata["instansiIndukNama"]= $setdetil->getField("instansiIndukNama");
		$arrdata["satuanKerjaIndukId"]= $setdetil->getField("satuanKerjaIndukId");
		$arrdata["satuanKerjaIndukNama"]= $setdetil->getField("satuanKerjaIndukNama");
		$arrdata["kanregId"]= $setdetil->getField("kanregId");
		$arrdata["kanregNama"]= $setdetil->getField("kanregNama");
		$arrdata["instansiKerjaId"]= $setdetil->getField("instansiKerjaId");
		$arrdata["instansiKerjaNama"]= $setdetil->getField("instansiKerjaNama");
		$arrdata["instansiKerjaKodeCepat"]= $setdetil->getField("instansiKerjaKodeCepat");
		$arrdata["satuanKerjaKerjaId"]= $setdetil->getField("satuanKerjaKerjaId");
		$arrdata["satuanKerjaKerjaNama"]= $setdetil->getField("satuanKerjaKerjaNama");
		$arrdata["unorId"]= $setdetil->getField("unorId");
		$reqBknSatuanKerjaNamaDetil= $arrdata["unorNama"]= $setdetil->getField("unorNama");
		$arrdata["unorIndukId"]= $setdetil->getField("unorIndukId");
		$arrdata["unorIndukNama"]= $setdetil->getField("unorIndukId");
		$arrdata["jenisJabatanId"]= $setdetil->getField("jenisJabatanId");
		$arrdata["jenisJabatan"]= $setdetil->getField("jenisJabatan");
		$arrdata["jabatanNama"]= $setdetil->getField("jabatanNama");
		$arrdata["jabatanStrukturalId"]= $setdetil->getField("jabatanStrukturalId");
		$arrdata["jabatanStrukturalNama"]= $setdetil->getField("jabatanStrukturalNama");
		$arrdata["jabatanFungsionalId"]= $setdetil->getField("jabatanFungsionalId");
		$arrdata["jabatanFungsionalNama"]= $setdetil->getField("jabatanFungsionalNama");
		$arrdata["jabatanFungsionalUmumId"]= $setdetil->getField("jabatanFungsionalUmumId");
		$arrdata["jabatanFungsionalUmumNama"]= $setdetil->getField("jabatanFungsionalUmumNama");
		...
		$arrdata["tmtJabatan"]= $setdetil->getField("tmtJabatan");
		$arrdata["lokasiKerjaId"]= $setdetil->getField("lokasiKerjaId");
		$arrdata["lokasiKerja"]= $setdetil->getField("lokasiKerja");
		$arrdata["golRuangAwalId"]= $setdetil->getField("golRuangAwalId");
		$arrdata["golRuangAwal"]= $setdetil->getField("golRuangAwal");
		$arrdata["golRuangAkhirId"]= $setdetil->getField("golRuangAkhirId");
		$arrdata["golRuangAkhir"]= $setdetil->getField("golRuangAkhir");
		$arrdata["tmtGolAkhir"]= $setdetil->getField("tmtGolAkhir");
		$arrdata["masaKerja"]= $setdetil->getField("masaKerja");
		$arrdata["eselon"]= $setdetil->getField("eselon");
		$arrdata["eselonId"]= $setdetil->getField("eselonId");
		$arrdata["eselonLevel"]= $setdetil->getField("eselonLevel");
		$arrdata["tmtEselon"]= $setdetil->getField("tmtEselon");
		$arrdata["gajiPokok"]= $setdetil->getField("gajiPokok");
		$arrdata["kpknId"]= $setdetil->getField("kpknId");
		$arrdata["kpknNama"]= $setdetil->getField("kpknNama");
		$arrdata["ktuaId"]= $setdetil->getField("ktuaId");
		$arrdata["ktuaNama"]= $setdetil->getField("ktuaNama");
		$arrdata["taspenId"]= $setdetil->getField("taspenId");
		$arrdata["taspenNama"]= $setdetil->getField("taspenNama");
		$arrdata["jenisKawinId"]= $setdetil->getField("jenisKawinId");
		$arrdata["statusPerkawinan"]= $setdetil->getField("statusPerkawinan");
		$arrdata["statusHidup"]= $setdetil->getField("statusHidup");
		$arrdata["tglSuratKeteranganDokter"]= $setdetil->getField("tglSuratKeteranganDokter");
		$arrdata["noSuratKeteranganDokter"]= $setdetil->getField("noSuratKeteranganDokter");
		$arrdata["jumlahIstriSuami"]= $setdetil->getField("jumlahIstriSuami");
		$arrdata["jumlahAnak"]= $setdetil->getField("jumlahAnak");
		$arrdata["noSuratKeteranganBebasNarkoba"]= $setdetil->getField("noSuratKeteranganBebasNarkoba");
		$arrdata["tglSuratKeteranganBebasNarkoba"]= $setdetil->getField("tglSuratKeteranganBebasNarkoba");
		$arrdata["skck"]= $setdetil->getField("tglSkck");
		$arrdata["tglSkck"]= $setdetil->getField("tglSkck");
		$arrdata["akteKelahiran"]= $setdetil->getField("akteKelahiran");
		$arrdata["akteMeninggal"]= $setdetil->getField("akteMeninggal");
		$arrdata["tglMeninggal"]= $setdetil->getField("tglMeninggal");
		$reqBknNpwp= $arrdata["noNpwp"]= $setdetil->getField("noNpwp");
		$arrdata["tglNpwp"]= $setdetil->getField("tglNpwp");
		$arrdata["noAskes"]= $setdetil->getField("noAskes");
		$reqBknBpjs= $arrdata["bpjs"]= $setdetil->getField("bpjs");
		$arrdata["kodePos"]= $setdetil->getField("kodePos");
		$arrdata["noSpmt"]= $setdetil->getField("noSpmt");
		$arrdata["noTaspen"]= $setdetil->getField("noTaspen");
		$arrdata["bahasa"]= $setdetil->getField("bahasa");
		$arrdata["kppnId"]= $setdetil->getField("kppnId");
		$arrdata["kppnNama"]= $setdetil->getField("kppnNama");
		$reqBknPangkatAkhir= $arrdata["pangkatAkhir"]= $setdetil->getField("pangkatAkhir");
		$arrdata["tglSttpl"]= $setdetil->getField("tglSttpl");
		$arrdata["nomorSttpl"]= $setdetil->getField("nomorSttpl");
		$arrdata["nomorSkCpns"]= $setdetil->getField("nomorSkCpns");
		$arrdata["nomorSkPns"]= $setdetil->getField("nomorSkPns");
		$arrdata["jenjang"]= $setdetil->getField("jenjang");
		$arrdata["jabatanAsn"]= $setdetil->getField("jabatanAsn");
		$reqBknKartuAsn= $arrdata["kartuAsn"]= $setdetil->getField("kartuAsn");
					...
					<li class="collection-item">
						...
						<div class="col s12">
							<ul class="tabs">
								...
								<li class="tab col s3"><a href="#tabdatabkn">Data BKN</a></li>
							</ul>
						</div>
