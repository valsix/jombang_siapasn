...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "app_user_login_json/json",			  
        ...
        $("#btnCari").on("click", function () {
			...
			reqCariFilter= $("#reqCariFilter").val();
				  ...
				  oTable.fnReloadAjax("app_user_login_json/json?sSearch="+reqCariFilter);
				});
        ...
        $('#btnAdd').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/app_user_login_add");
			//window.parent.openPopup("app/loadUrl/app/app_user_login_add");
//window.close();
        ...
        $('#btnEdit').on('click', function () {
        	if(anSelectedData == "")
        		return false;				
        	window.parent.openPopup("app/loadUrl/app/app_user_login_add/?reqId="+anSelectedId);
        ...
        $('#btnReset').on('click', function () {
        	if(anSelectedData == "")
        		return false;				
        	window.parent.openPopup("app/loadUrl/app/app_user_login_reset/?reqId="+anSelectedId);
        ...
        $('#btnDelete').on('click', function () {
        	...
        	$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
        		if (r){
        			$.getJSON("app_user_login_json/delete/?reqId="+anSelectedId,
        				function(data){
        ...
        $('#btnLog').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/informasi_data_log?reqjson=app_user_login_json/log&reqjudul=User Web Service");
...
function hapusData(id, statusaktif)
{
	...
	$.messager.confirm('Konfirmasi', infoMode+" ?",function(r){
		if (r){
			var s_url= "app_user_login_json/delete/?reqMode="+reqmode+"&reqId="+id;
					...
					<div class="container">
						<div class="row">
							<div class="col s12 m12 l12">
								...
								<h5 class="breadcrumbs-title">User Web Service</h5>
							</div>
						</div>
					</div>
				</div>
