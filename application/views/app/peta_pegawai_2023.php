...
$arrtabledata= array(
   array("label"=>"NIP", "field"=> "NIP_BARU", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
...
//   , array("label"=>"Rumpun", "field"=> "RUMPUN_INFO", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
// );
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <h5 class="breadcrumbs-title">Peta Pegawai Kuadran <?=romanic_number($reqKotakRumpun)?></h5>
...
<script type="text/javascript">
    ...
    $(function(){
      var tt = $('#tt').treegrid({
        url: 'satuan_kerja_2023_json/treepilih',
        rownumbers: false,
        pagination: false,
        idField: 'ID',
        treeField: 'NAMA',
    ...
    $("#btncetak").on("click", function () {
      ...
      newWindow = window.open("app/loadUrl/app/talenta_nilai_akhir_excel.php?reqBulan=<?=date('m')?>&reqTahun=<?=date('Y')?>&reqPencarian="+reqCariFilter+"&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqStatusPegawaiId="+reqStatusPegawaiId+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqEselonGroupId="+reqEselonGroupId, 'Cetak');
      newWindow.focus();
    });
    ...
    $('#btnCari').on('click', function () {
      ...
      jsonurl= "json/talenta_2023_json/jsonpetapegawainew?reqPencarian="+reqCariFilter+"&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqStatusPegawaiId="+reqStatusPegawaiId+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqEselonGroupId="+reqEselonGroupId+"&reqGlobalValidasiCheck="+reqGlobalValidasiCheck;
    ...
    jQuery(document).ready(function() {
      var jsonurl= "json/talenta_2023_json/jsonpetapegawainew?reqKotakRumpun=<?=$reqKotakRumpun?>&reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqStatusPegawaiId=<?=$reqStatusPegawaiId?>&reqTipePegawaiId=<?=$reqTipePegawaiId?>&reqEselonGroupId=<?=$reqEselonGroupId?>";
