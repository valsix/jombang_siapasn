...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="lib/AdminLTE-2.4.0-rc/index2.html" class="logo">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="lib/AdminLTE-2.4.0-rc/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="lib/AdminLTE-2.4.0-rc/pages/widgets.html">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> ChartJS</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/charts/morris.html"><i class="fa fa-circle-o"></i> Morris</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/charts/flot.html"><i class="fa fa-circle-o"></i> Flot</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/charts/inline.html"><i class="fa fa-circle-o"></i> Inline charts</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/UI/general.html"><i class="fa fa-circle-o"></i> General</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/UI/icons.html"><i class="fa fa-circle-o"></i> Icons</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/UI/buttons.html"><i class="fa fa-circle-o"></i> Buttons</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/UI/sliders.html"><i class="fa fa-circle-o"></i> Sliders</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/UI/timeline.html"><i class="fa fa-circle-o"></i> Timeline</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/UI/modals.html"><i class="fa fa-circle-o"></i> Modals</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/forms/general.html"><i class="fa fa-circle-o"></i> General Elements</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Advanced Elements</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/forms/editors.html"><i class="fa fa-circle-o"></i> Editors</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/tables/simple.html"><i class="fa fa-circle-o"></i> Simple tables</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/tables/data.html"><i class="fa fa-circle-o"></i> Data tables</a></li>
          </ul>
        </li>
        <li>
          <a href="lib/AdminLTE-2.4.0-rc/pages/calendar.html">
        ...
        <li>
          <a href="lib/AdminLTE-2.4.0-rc/pages/mailbox/mailbox.html">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/examples/invoice.html"><i class="fa fa-circle-o"></i> Invoice</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/examples/profile.html"><i class="fa fa-circle-o"></i> Profile</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/examples/login.html"><i class="fa fa-circle-o"></i> Login</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/examples/register.html"><i class="fa fa-circle-o"></i> Register</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/examples/lockscreen.html"><i class="fa fa-circle-o"></i> Lockscreen</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/examples/404.html"><i class="fa fa-circle-o"></i> 404 Error</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/examples/500.html"><i class="fa fa-circle-o"></i> 500 Error</a></li>
            <li class="active"><a href="lib/AdminLTE-2.4.0-rc/pages/examples/blank.html"><i class="fa fa-circle-o"></i> Blank Page</a></li>
            <li><a href="lib/AdminLTE-2.4.0-rc/pages/examples/pace.html"><i class="fa fa-circle-o"></i> Pace Page</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
