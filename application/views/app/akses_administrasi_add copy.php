...
<script type="text/javascript">
	...
	function checkAnak(val){
		...
		// $('[name^="reqCheck'+arrTempId[1]+'"]').value = 'D'
		  // $("input[name^='nameOfTheInputElement']").val("D");
		// if(arrTempId[0]=='all'){
		// 	$('[id^="read-'+arrTempId[1]+'"]').attr('checked', false);
		// 	$('[id^="dis-'+arrTempId[1]+'"]').attr('checked', false);
		// 	$('[id^="all-'+arrTempId[1]+'"]').attr('checked', true);
		// }
		// else if(arrTempId[0]=='read'){
		// 	$('[id^="all-'+arrTempId[1]+'"]').attr('checked', false);
		// 	$('[id^="dis-'+arrTempId[1]+'"]').attr('checked', false);
		// 	$('[id^="read-'+arrTempId[1]+'"]').attr('checked', true);
		// }
		// else if(arrTempId[0]=='dis'){
		// 	$('[id^="all-'+arrTempId[1]+'"]').attr('checked', false);
		// 	$('[id^="read-'+arrTempId[1]+'"]').attr('checked', false);
		// 	$('[id^="dis-'+arrTempId[1]+'"]').attr('checked', true);
		// }
	}
</script>
</body>
