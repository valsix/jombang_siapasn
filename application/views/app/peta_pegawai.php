...
<script type="text/javascript">
    ...
    $('#btnCari').on('click', function () {
      ...
      jsonurl= "json/talenta_json/jsonpetapegawai?reqPencarian="+reqCariFilter+"&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqStatusPegawaiId="+reqStatusPegawaiId+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqEselonGroupId="+reqEselonGroupId+"&reqGlobalValidasiCheck="+reqGlobalValidasiCheck;
    ...
    jQuery(document).ready(function() {
      var jsonurl= "json/talenta_json/jsonpetapegawai?reqKotakRumpun=<?=$reqKotakRumpun?>&reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqStatusPegawaiId=<?=$reqStatusPegawaiId?>&reqTipePegawaiId=<?=$reqTipePegawaiId?>&reqEselonGroupId=<?=$reqEselonGroupId?>";
