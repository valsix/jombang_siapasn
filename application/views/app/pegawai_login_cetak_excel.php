...
header("Content-Disposition: attachment; filename=\"cek_login_pegawai_".$tempPeriode.".xls\"");
...
{
	$statement.= " AND P.STATUS_PEGAWAI_ID = ".$reqStatusPegawaiId;
}
...
$judulfield= array("No.", "NIP Baru", "Nama", "Satuan Kerja", "Waktu Login Terakhir");
...
$field= array("NO", "NIP_BARU", "NAMA", "SATUAN_KERJA", "WAKTU_LOGIN");

// $statement.= " AND A.PEGAWAI_ID= 13478";

$sOrder = " ORDER BY SATUAN_KERJA ASC, X.WAKTU_LOGIN DESC";
$set= new Pegawai();
// $allRecord= $set->getCountByParamsCetakPegawai(array(), $statement.$searchJson);
$set->selectByParamsCetakPegawaiLogin(array(), -1, -1, $statement.$searchJson, $sOrder);
//echo $set->query;exit;
?>
<!DOCTYPE html>
<html lang="en">
...
<table style="width:100%">
        ...
        <tr>
            <td colspan="<?=count($judulfield)-1?>" style="font-size:13px;font-weight:bold; text-align: center;">LOGIN PEGAWAI ASN</td>	
        </tr>
        <tr>
