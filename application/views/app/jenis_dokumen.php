    ...
    <script type="text/javascript" charset="utf-8">
      ...
      $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
          ...
          "bProcessing": true,
          "bServerSide": true,
          "sAjaxSource": "jenis_dokumen_json/json",			  
        ...
        $("#btnCari").on("click", function () {
        	tempJsonParsing= "";
			  ...
			  oTable.fnReloadAjax("jenis_dokumen_json/json?"+tempJsonParsing);
			});

        $('#btnAdd').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/jenis_dokumen_add");
        ...
        $('#btnEdit').on('click', function () {
        	if(anSelectedData == "")
        		return false;				
        	window.parent.openPopup("app/loadUrl/app/jenis_dokumen_add/?reqId="+anSelectedId);
        ...
        $('#btnDelete').on('click', function () {
        	...
        	$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
        		if (r){
        			$.getJSON("jenis_dokumen_json/delete/?reqId="+anSelectedId,
        				function(data){
        ...
        $('#btnLog').on('click', function () {
            window.parent.openPopup("app/loadUrl/app/informasi_data_log?reqjson=jenis_dokumen_json/log&reqjudul=Jenis Dokumen Log");
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m12 l12">
                            ...
                            <h5 class="breadcrumbs-title">Jenis Dokumen</h5>
                        </div>
                    </div>
                </div>
            </div>
