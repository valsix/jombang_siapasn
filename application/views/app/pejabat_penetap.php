...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "pejabat_penetap_json/json",			  
        ...
        $('#btnAdd').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/pejabat_penetap_add");
        ...
        $("#btnCari").on("click", function () {
        	tempJsonParsing= "";
					  ...
					  oTable.fnReloadAjax("pejabat_penetap_json/json?"+tempJsonParsing);
					});

        $('#btnEdit').on('click', function () {
        	if(anSelectedData == "")
        		return false;				
        	window.parent.openPopup("app/loadUrl/app/pejabat_penetap_add/?reqId="+anSelectedId);
...
$('#btnLog').on('click', function () {
       window.parent.openPopup("app/loadUrl/app/informasi_data_log?reqjson=pejabat_penetap_json/log&reqjudul=Pejabat Penetap Log");
					...
					<div class="container">
						<div class="row">
							<div class="col s12 m12 l12">
								...
								<h5 class="breadcrumbs-title">Pejabat Penetap</h5>
							</div>
						</div>
					</div>
				</div>
