				...
				<table class="table">
					<thead>
						<tr>           
							...
							<td>:</td>
							<td>
								<input name="reqMasaKerja" class="easyui-validatebox" type="text" required value="<?=$reqMasaKerja?>" />
							</td>			
						</tr>  
						<tr>           
							<td>Kode</td>
							<td>:</td>
							<td>
								<input name="reqPangkatId" class="easyui-validatebox" type="text" required value="<?=$reqPangkatId?>" />
							</td>			
						</tr>  
					</table>
				</thead>
