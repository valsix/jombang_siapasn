...
header("Content-Disposition: attachment; filename=\"kualifikasi_".$tempPeriode.".xls\"");
...
$arrtabledata= array(
  ...
  , array("label"=>"RIWAYAT PENDIDIKAN FORMAL", "field"=> "REKAM_JEJAK_DETIL", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
...
<table style="width:100%">
	...
	<tr>
		<td colspan="<?=$jumlahrowhead?>" style="font-size:13px;font-weight:bold; text-align: center;">TABEL PENILAIAN KUALIFIKASI</td>	
	</tr>
</table>
<br/>
<br/>
