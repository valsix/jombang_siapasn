...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        $('#btnLog').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/eselon_log");
...
<body style="overflow:hidden;">
	...
	<div id="wadah">
		<div class="judul-halaman">Data Eselon</div>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
			<thead>
				<tr>
					...
					<th width="400px">Pangkat Minimal</th>                                       
					<th width="400px">Pangkat Maksimal</th>                                       
