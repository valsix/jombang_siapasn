...
<script type="text/javascript" charset="utf-8">
  ...
  $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 50,
         ...
         "bProcessing": true,
         "bServerSide": true,
         "sAjaxSource": "kgb_peraturan_json/json",
         "sScrollX": "100%",								  
         "sScrollXInner": "100%",
   ...
   $("#btnCari").on("click", function () {
      ...
      oTable.fnReloadAjax("kgb_peraturan_json/json?"+tempJsonParsing);
    });

   $('#btnAdd').on('click', function () {
       window.parent.openPopup("app/loadUrl/app/kgb_peraturan_add");
   ...
   $('#btnEdit').on('click', function () {
       if(anSelectedData == "")
          return false;				
        window.parent.openPopup("app/loadUrl/app/kgb_peraturan_add/?reqId="+anSelectedId);
   ...
   $('#btnDelete').on('click', function () {
      ...
      $.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
          if (r){
             $.getJSON("kgb_peraturan_json/delete/?reqId="+anSelectedId,
                function(data){
                   $.messager.alert('Info', data.PESAN, 'info');
                   oTable.fnReloadAjax("kgb_peraturan_json/json");
               });
   ...
   $('#btnLog').on('click', function () {
       window.parent.openPopup("app/loadUrl/app/informasi_data_log?reqjson=kgb_peraturan_json/log&reqjudul=Tanda Tangan Log");
...
function hapusData(id, statusaktif)
{
    ...
    $.messager.confirm('Konfirmasi', infoMode+" ?",function(r){
        if (r){
            var s_url= "kgb_peraturan_json/delete/?reqMode="+reqmode+"&reqId="+id;
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <h5 class="breadcrumbs-title">KGB Peraturan</h5>
                            </div>
                        </div>
                    </div>
                </div>
