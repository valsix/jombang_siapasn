        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			...
			/* Click event handler */
						...
						if (r){
							$.getJSON("bank_json/delete/?reqId="+anSelectedId,
							  function(data){
									  ...
									  oTable.fnReloadAjax("gaji_pokok_json/json");
							});
			  ...
			  $('#btnLog').on('click', function () {
	        	window.parent.openPopup("app/loadUrl/app/gaji_pokok_log");
...
<div id="wadah">
    <div class="judul-halaman">GAJI POKOK</div>
