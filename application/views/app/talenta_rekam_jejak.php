...
$arrtabledata= array(
  array("label"=>"", "field"=> "", "display"=>"",  "width"=>"2", "colspan"=>"", "rowspan"=>"")
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <h5 class="breadcrumbs-title">Rekam Jejak</h5>
...
<script type="text/javascript">
    ...
    $("#btncetak").on("click", function () {
      ...
      newWindow = window.open("app/loadUrl/app/talenta_rekam_jejak_excel?reqBulan=<?=date('m')?>&reqTahun=<?=date('Y')?>&reqPencarian="+reqCariFilter+"&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqStatusPegawaiId="+reqStatusPegawaiId+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqEselonGroupId="+reqEselonGroupId, 'Cetak');
      newWindow.focus();
    });
    ...
    $('#btnCari').on('click', function () {
      ...
      jsonurl= "json/talenta_json/jsonrekamjejak?reqPencarian="+reqCariFilter+"&reqSatuanKerjaId="+reqSatuanKerjaId+"&reqStatusPegawaiId="+reqStatusPegawaiId+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqEselonGroupId="+reqEselonGroupId+"&reqGlobalValidasiCheck="+reqGlobalValidasiCheck;
    ...
    jQuery(document).ready(function() {
      var jsonurl= "json/talenta_json/jsonrekamjejak";
