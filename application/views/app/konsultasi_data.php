...
<script type="text/javascript" charset="utf-8">
  ...
  $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
           ...
           "bProcessing": true,
           "bServerSide": true,
           "sAjaxSource": "konsultasi_json/json",			  
        ...
        $("#btnCari").on("click", function () {
            tempJsonParsing= "";
              ...
              oTable.fnReloadAjax("konsultasi_json/json?"+tempJsonParsing);
          });

        $('#btnAdd').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/konsultasi_data_add");
        ...
        $('#btnEdit').on('click', function () {
        	if(anSelectedData == "")
        		return false;				
        	window.parent.openPopup("app/loadUrl/app/konsultasi_data_add/?reqId="+anSelectedId);
        ...
        $('#btnDelete').on('click', function () {
        	...
        	$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
        		if (r){
        			$.getJSON("konsultasi_json/delete/?reqId="+anSelectedId,
        				function(data){
        					$.messager.alert('Info', data.PESAN, 'info');
        					oTable.fnReloadAjax("konsultasi_json/json");
        				});
        ...
        $('#btnLog').on('click', function () {
            window.parent.openPopup("app/loadUrl/app/konsultasi_data_log?reqjson=konsultasi_json/log&reqjudul=Pangkat Log");
...
function hapusData(id, statusaktif)
{
    ...
    if(statusaktif == "")
    {
        ...
        $.messager.confirm('Konfirmasi', infoMode+" ?",function(r){
            if (r){
                var s_url= "konsultasi_json/delete/?reqMode="+reqmode+"&reqId="+id;
                ...
                <div id="breadcrumbs-wrapper">
                    <div class="container">
                        <div class="row">
                            ...
                            <h5 class="breadcrumbs-title">Konsultasi</h5>
                            </div>
                        </div>
                    </div>
                </div>
