...
{
	$reqMode = "update";	
	$set->selectByParams(array("INFORMASI_KATEGORI_ID"=>$reqId));
	$set->firstRow();
...
<head>
	...
	<script type="text/javascript">	
		$(function(){
			$('#ff').form({
				url:'informasi_kategori_json/add',
				onSubmit:function(){
         			...
         			else
         			{
         				mbox.alert(infodata, {open_speed: 500}, interval = window.setInterval(function() 
         				{
							clearInterval(interval);
         					mbox.close();
         					document.location.href= "app/loadUrl/app/informasi_kategori_add/?reqId="+rowid;
         				}, 1000));
