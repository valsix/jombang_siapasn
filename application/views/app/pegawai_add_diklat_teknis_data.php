...
{
  $reqMode = 'update';
  $statement= " AND A.DIKLAT_TEKNIS_ID = ".$reqRowId." AND A.PEGAWAI_ID = ".$reqId;
        ...
        onSubmit:function(){
          ...
          else
          {
            mbox.alert(infodata, {open_speed: 500}, interval = window.setInterval(function() 
            {
              ...
              mbox.close();
              document.location.href= "app/loadUrl/app/pegawai_add_diklat_teknis_data/?reqId=<?=$reqId?>&reqRowId="+rowid;
            }, 1000));
    ...
    <div class="row">
     <div class="col s12 m10 offset-m1">
       ...
       <ul class="collection card">
         <li class="collection-item ubah-color-warna">EDIT DIKLAT TEKNIS</li>
                ...
                <div class="input-field col s12">
                  ...
                  <script type="text/javascript">
                    $("#kembali").click(function() { 
                      document.location.href = "app/loadUrl/app/pegawai_add_diklat_teknis_monitoring?reqId=<?=$reqId?>";
                    });
                  </script>
