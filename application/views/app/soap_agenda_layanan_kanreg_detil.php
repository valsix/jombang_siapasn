...
$reqJudulBreadCrum= "Detail List Agenda PNS di Wilayah Kantor Regional II BKN Surabaya";
...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "soap/soap_agenda_layanan_kanreg_json/json_detil?reqAgenda=<?=$reqAgenda?>",
        	"sScrollX": "100%",								  
        	"sScrollXInner": "100%",
		...
		$('#btnEdit').on('click', function () {
			...
			document.location.href="app/loadUrl/app/soap_agenda_layanan_kanreg?reqBidang=<?=$reqBidang?>";
		...
		$("#btnCari").on("click", function () {
			...
			oTable.fnReloadAjax("surat/soap_agenda_layanan_kanreg_json/json?sSearch="+reqCariFilter);
		});
                ...
                <div id="bluemenu" class="bluetabs">
                    <ul>
                        <li>
                            ...
                            <a id="btnEdit" title="Kembali"><img src="images/icon-edit.png" /> Kembali</a>
                        </li>
                    </ul>
                </div>
