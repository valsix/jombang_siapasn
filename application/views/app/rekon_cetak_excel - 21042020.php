...
$judulfield= array("No.", "NIP Lama / Baru", "Nama", "Status", "Gol./TMT", "Tipe Pegawai", "Eselon", "Jabatan / TMT", "Satuan Kerja", "TMT Pensiun", "Pendidikan");
...
$field= array("NO", "NIP_LAMA_BARU", "NAMA", "STATUS_PEGAWAI", "GOL_RUANG_TMT_PANGKAT", "TIPE_PEGAWAI", "ESELON", "JABATAN_TMT_JABATAN", "NAMA_SATKER", "TMT_PENSIUN", "PENDIDIKAN");
            ...
            <tbody>
				...
				?>
                	...
                	for($i=0; $i<count($field); $i++)
					{
						...
						elseif($field[$i] == "PENDIDIKAN_NAMA" || $field[$i] == "UNIT_KERJA_INDUK")
						{
