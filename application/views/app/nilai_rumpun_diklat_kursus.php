...
$arrtabledata= array(
  ...
  , array("label"=>"Tipe Kursus", "field"=> "NAMA", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")

  // untuk dua ini kunci, data akhir id, data sebelum akhir untuk order
  , array("label"=>"sorderdefault", "field"=> "SORDERDEFAULT", "display"=>"1", "width"=>"")
  , array("label"=>"fieldid", "field"=> "TIPE_KURSUS_ID", "display"=>"1", "width"=>"")
);
...
<body>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <h5 class="breadcrumbs-title">Nilai Diklat/Kursus</h5>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $('#btnCari').on('click', function () {
          ...
          jsonurl= "json/rumpun_nilai_json/jsondiklatkursus?reqPencarian="+reqPencarian+"&reqGlobalValidasiCheck="+reqGlobalValidasiCheck;
        ...
        jQuery(document).ready(function() {
          var jsonurl= "json/rumpun_nilai_json/jsondiklatkursus";
