  ...
  $(document).ready( function () {
    ...
    if($reqBreadCrum == ""){}
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
          ...
          "bProcessing": true,
          "bServerSide": true,
          "sAjaxSource": "jenis_pegawai_json/json",			  
        ...
        $("#btnCari").on("click", function () {
            tempJsonParsing= "";
              ...
              oTable.fnReloadAjax("jenis_pegawai_json/json?"+tempJsonParsing);
          });

        $('#btnAdd').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/jenis_pegawai_add");
        ...
        $('#btnEdit').on('click', function () {
        	if(anSelectedData == "")
        		return false;				
        	window.parent.openPopup("app/loadUrl/app/jenis_pegawai_add/?reqId="+anSelectedId);
        ...
        $('#btnDelete').on('click', function () {
        	...
        	$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
        		if (r){
        			$.getJSON("jenis_pegawai_json/delete/?reqId="+anSelectedId,
        				function(data){
        					$.messager.alert('Info', data.PESAN, 'info');
        					oTable.fnReloadAjax("jenis_pegawai_json/json");
        				});
        ...
        $('#btnLog').on('click', function () {
            window.parent.openPopup("app/loadUrl/app/informasi_data_log?reqjson=jenis_pegawai_json/log&reqjudul=Jenis Pegawai Log");
...
function hapusData(id, statusaktif)
{
    ...
    if(statusaktif == "")
    {
        ...
        $.messager.confirm('Konfirmasi', infoMode+" ?",function(r){
            if (r){
                var s_url= "jenis_pegawai_json/delete/?reqMode="+reqmode+"&reqId="+id;
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <h5 class="breadcrumbs-title">Jenis Pegawai</h5>
                            </div>
                        </div>
                    </div>
                </div>
