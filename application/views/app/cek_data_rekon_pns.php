...
$arrData= array("NIP BARU", "NAMA", "REKAP CEK", "NAMA UNIT KERJA", "STATUS SK CPNS / PNS", "PANGKAT GAJI", "CEK JURUSAN DIAKUI", "NILAI PPK", "NAMA SATUAN KERJA");
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
<html>
<head>
	<meta http-equiv="Content-type" content="text/html; charset=UTF-8">
	<title>Cek Data Rekon PNS</title>
	<base href="<?=base_url()?>" />
	...
	<script type="text/javascript" charset="utf-8">
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
        	...
        	"bProcessing": true,
        	"bServerSide": true,
        	"sAjaxSource": "cek_data_rekon_pns_json/json?reqSatuanKerjaId=<?=$reqSatuanKerjaId?>&reqTipePegawaiId=<?=$reqTipePegawaiId?>",
        	"sScrollX": "100%",								  
        	"sScrollXInner": "100%",
        ...
        $('#btnCetakCekDataRekon').on('click', function () {
        	...
        	newWindow = window.open("app/loadUrl/app/cek_data_rekon_cetak_excel?reqBulan=<?=date('m')?>&reqTahun=<?=date('Y')?>&reqStatusPegawaiId=12&reqSatuanKerjaId="+reqSatuanKerjaId+"&sSearch="+reqCariFilter, 'Cetak');
			newWindow.focus();

        });

        $('#btnCetakCekDataRekonDinas').on('click', function () {
        	...
        	newWindow = window.open("app/loadUrl/app/cek_data_rekon_cetak_excel?reqModeDinas=1&reqBulan=<?=date('m')?>&reqTahun=<?=date('Y')?>&reqStatusPegawaiId=12&reqSatuanKerjaId="+reqSatuanKerjaId+"&sSearch="+reqCariFilter, 'Cetak');
			newWindow.focus();
		...
		<div class="wrapper">
			...
			<section id="content-full">
				...
				<div id="breadcrumbs-wrapper">
					<div class="container">
						<div class="row">
							...
							<h5 class="breadcrumbs-title">Rekap Data Rekon PNS</h5>
                ...
                <div id="bluemenu" class="bluetabs">
                    ...
                    ?>                            
                    		<a id="btnCetakCekDataRekonDinas" title="Ubah"><img src="images/icon-excel.png" />Cetak Data Rekon Dinas</a> 
                    <?
                    }
                    ?>
                         	<a id="btnCetakCekDataRekon" title="Ubah"><img src="images/icon-excel.png" />Cetak Data Rekon</a>
