    ...
    <script type="text/javascript" charset="utf-8">
      ...
      $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
          ...
          "bProcessing": true,
          "bServerSide": true,
          "sAjaxSource": "kualitas_file_json/json",			  
        ...
        $("#btnCari").on("click", function () {
        	tempJsonParsing= "";
			  ...
			  oTable.fnReloadAjax("kualitas_file_json/json?"+tempJsonParsing);
			});

        $('#btnAdd').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/kualitas_file_add");
        ...
        $('#btnEdit').on('click', function () {
        	if(anSelectedData == "")
        		return false;				
        	window.parent.openPopup("app/loadUrl/app/kualitas_file_add/?reqId="+anSelectedId);
        ...
        $('#btnDelete').on('click', function () {
        	...
        	$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
        		if (r){
        			$.getJSON("kualitas_file_json/delete/?reqId="+anSelectedId,
        				function(data){
        ...
        $('#btnLog').on('click', function () {
            window.parent.openPopup("app/loadUrl/app/informasi_data_log?reqjson=kualitas_file_json/log&reqjudul=Kualitas File Log");
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m12 l12">
                            ...
                            <h5 class="breadcrumbs-title">Kualitas File</h5>
                        </div>
                    </div>
                </div>
            </div>
