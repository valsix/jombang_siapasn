              ...
              <div class="row">
                ...
                <div class="input-field col s12 m6">
                  <select id="reqPegawaiJenisJabatan" name="reqPegawaiJenisJabatan" >
                    ...
                    <option value="4" <? if($reqPegawaiJenisJabatan==3) echo 'selected';?>>Pelaksana / Staf / Fungsional Umum</option>
                  </select>
              ...
              <div class="row">
                <div class="col s12 m10 offset-m2">
                  ...
                  <div class="input-field col s12 m3 offset-m1">
                    ...
                    <input placeholder="" type="text" class="easyui-validatebox" data-options="validType:'nilaiKurangSamaDengan[100]'" id="reqKepemimpinanNilai" name="reqKepemimpinanNilai" <?=$read?> value="<?=$reqKepemimpinanNilai?>" onkeypress='kreditvalidate(event, this)' />
                  </div>
                </div>
              </div>
...
-->
              ...
              <div class="row">
                ...
                <div class="input-field col s12 m6">
                  ...
                  <input placeholder type="text" class="easyui-validatebox" required id="reqPenilaianSkpPenilaiNip2" name="reqPenilaianSkpPenilaiNip2" <?=$read?> value="<?=$reqPenilaianSkpPenilaiNip2?>"/>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="input-field col s12 m6">
                  ...
                  <input placeholder type="text" class="color-disb" id="reqPenilaianSkpAtasanNama2" name="reqPenilaianSkpAtasanNama2" value="<?=$reqPenilaianSkpAtasanNama2?>" readonly />
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col s12 m10">
                  ...
                  <div class="input-field col s12 m3">
                    ...
                    <input type="text" placeholder name="reqSkpHasil2" id="reqSkpHasil2" value="<?=maybePrefixZero($reqSkpHasil2)?>" readonly="readonly"/>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="input-field col s12 m3 offset-m3">
                  ...
                  <div class="input-field col s12 m3 offset-m1">
                    ...
                    <input placeholder="" type="text" class="easyui-validatebox" data-options="validType:'nilaiKurangSamaDengan[120]'" id="reqKepemimpinanNilai2" name="reqKepemimpinanNilai2" <?=$read?> value="<?=$reqKepemimpinanNilai2?>" onkeypress='kreditvalidate(event, this)' />
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="input-field col s12 m3 offset-m3">
                    ...
                    <input type="text" class="easyui-validatebox" data-options="validType:'nilaiKurangSamaDengan[120]'" id="reqInisiatifkerjaNilai2" name="reqInisiatifkerjaNilai2" <?=$read?> value="<?=$reqInisiatifkerjaNilai2?>" onkeypress='kreditvalidate(event, this)' />
                  </div>                  
                </div>
              </div>
<!--
