                ...
                <div class="card white">
                    <div class="card-content black-text" style="padding: 0">
                        ...
                        <div class="body-list white" style="padding-bottom: 2em; background-image:url(images/bg-kon2.png)">
                            <div class="row">
                                <div class="col s12 m10 offset-m1">
                                    <div class="content-list white z-depth-2" style="margin-top: -180px !important">
                                        <div class="row">
                                        ...
                                        <div class="list-wrap">
                                            <table class="table striped">
                                            	<tr>
                                                	<td>
                                                        <button class="btn pink waves-effect waves-light" style="font-size:9pt" type="button" onClick="tambahData()">Tanya
                                                ...
                                                <tr>
                                                    <td>
                                                         <a href="app/loadUrl/app/konsultasi_detil?reqId=<?=$mailbox->getField("MAILBOX_ID")?>">
