      ...
      success:function(data){
        ...
        else
        {
          mbox.alert(infodata, {open_speed: 500}, interval = window.setInterval(function() 
          {
            ...
            {
            ?>
            document.location.href= "app/loadUrl/app/pegawai_add_sk_pns/?reqId=<?=$reqId?>&reqPeriode=<?=$reqPeriode?>";
            <?
            }
            else
            {
            ?>
            document.location.href= "app/loadUrl/app/pegawai_add_sk_pns/?reqId=<?=$reqId?>&reqPeriode=<?=$reqPeriode?>&reqStatusFile=<?=$reqStatusFile?>";
            <?
            }
            ?>
              ...
              <form id="ff" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="input-field col s12 m6">
                    <label for="reqNoSuratKeputusan">No. Surat Keputusan</label>
                ...
                <div class="row">
                  <div class="input-field col s12 m6">
                    <label for="reqNoDiklatPrajabatan">No. Diklat Prajabatan</label>
                    <input placeholder <?=$disabled?> type="text" id="reqNoDiklatPrajabatan" name="reqNoDiklatPrajabatan" value="<?=$reqNoDiklatPrajabatan?>" />
                  </div>
                  <div class="input-field col s12 m6">
                    <label for="reqTanggalDiklatPrajabatan">Tanggal Diklat Prajabatan</label>
                ...
                <div class="row">
                  <div class="input-field col s12 m6">
                    <label for="reqNoSuratUjiKesehatan">No. Surat Uji Kesehatan</label>
                    <input placeholder <?=$disabled?> type="text" id="reqNoSuratUjiKesehatan" name="reqNoSuratUjiKesehatan" value="<?=$reqNoSuratUjiKesehatan?>" />
                  </div>
                  <div class="input-field col s12 m6">
                    <label for="reqTanggalSuratUjiKesehatan">Tanggal Surat Uji Kesehatan</label>
                ...
                <div class="row">
                  <div class="input-field col s12 m4">
                    ...
                    <label for="reqJenisJabatanId">Jenis Jabatan</label>
                  </div>
                  <div class="input-field col s12 m2">
                    ...
                    <label for="reqStatusCalonJft">Status Calon JFT</label>
                  </div>
                  <div class="input-field col s12 m6">
                    ...
                    <label for="reqJabatanCariTugas">Nama Jabatan</label>
                ...
                <div class="row">
                  ...
                  <div class="input-field col s12 m3">
                    <label for="reqNamaPejabatPenetap">Nama Pejabat Penetapan</label>
                  ...
                  <div class="input-field col s12 m3">
                    <label for="reqNipPejabatPenetap">NIP Pejabat Penetap</label>
                ...
                <div class="row">
                  <div class="input-field col s12 m6">
                    ...
                    <label for="reqJalurPengangkatan">Jalur Pengangkatan PNS</label>
                  </div>
                </div>
