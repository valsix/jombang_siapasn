            ...
            <form id="ff" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="input-field col s6 m6">
                  <select name="reqJenisJabatan" id="reqJenisJabatan">
              ...
              <div class="row">
                ...
                <div class="input-field col s12 m3">
                  ...
                  <input type="text" class="easyui-validatebox"  id="reqTmtTugas" name="reqTmtTugas" <?=$disabled?> value="<?=$reqTmtTugas?>" />
                </div>
                <div class="input-field col s12 m3">
                  <input type="checkbox" id="req" name="req" value="1" <? if($req == 1) echo 'checked'?> />
                  <label for="req"></label>
                </div>
              </div>
              ...
              <div class="row">
                <div class="input-field col s12 m12">
                  ...
                  <input type="text" id="reqSatker"  name="reqSatker" <?=$read?> value="<?=$reqSatker?>" class="easyui-validatebox" required readonly="readonly"/>
              ...
              <div class="row">
                ...
                <div class="input-field col s12 m6">
                  ...
                  <input type="text" class="easyui-validatebox"  id="reqTglPelantikan" name="reqTglPelantikan" <?=$disabled?> value="<?=$reqTglPelantikan?>" />
                </div>
              </div>
              ...
              <div class="row">
                <div class="input-field col s12 m6">
                  ...
                  <input type="text" class="easyui-validatebox"  id="reqTunjangan" name="reqTunjangan" <?=$disabled?> value="<?=$reqTunjangan?>" />
                </div>
                <div class="input-field col s12 m6">
                  <label for="reqBlnDibayar">Bln. Dibayar</label>
                  <input type="text" class="easyui-validatebox"  id="reqBlnDibayar" name="reqBlnDibayar" <?=$disabled?> value="<?=$reqBlnDibayar?>" />
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="input-field col s12 m3" id="TmtSelesai">
                  <label for="reqTmtSelesai">TMT Selesai Tugas</label>
                  <input type="text" class="easyui-validatebox"  id="reqTmtSelesai" name="reqTmtSelesai" <?=$disabled?> value="<?=$reqTmtSelesai?>" />
                </div>
              </div>
