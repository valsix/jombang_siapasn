						...
						<div class="form-group" >
							<div class="row">
								...
								<div class="col-md-4">
									...
									<input type="text" class="easyui-validatebox form-control" required  id="reqTMTGol" name="reqTMTGol" maxlength="10" title="Tmt Gol harus diisi" onkeydown="return format_date(event,'reqTMTGol');" <?=$read?> value="<?=$tempTMTGol?>" />
								</div>
							</div>
						</div>
						...
						<div class="form-group" >
							<div class="row">
								<div class="col-md-4">
									...
									<textarea <?=$disabled?> name="reqKeterangan" style="padding:0" class="required form-control"> <?=$tempKeterangan?></textarea>
								</div>
							</div>
						</div>
