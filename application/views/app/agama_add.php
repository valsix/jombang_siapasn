...
{
	$reqMode = "update";	
	$set->selectByParams(array("AGAMA_ID"=>$reqId));
	$set->firstRow();
         			...
         			else
         			{
         				mbox.alert(infodata, {open_speed: 500}, interval = window.setInterval(function() 
         				{
							clearInterval(interval);
         					mbox.close();
         					document.location.href= "app/loadUrl/app/agama_add/?reqId="+rowid;
         				}, 1000));
	...
	<div class="container-fluid full-height">
		<div class="row full-height">
			<div class="col-md-12 area-form full-height">
				...
				<div class="ubah-color-warna white-text" style="padding: 1em">Tambah Agama</div>
