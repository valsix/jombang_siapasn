    ...
    <script type="text/javascript" charset="utf-8">
      ...
      $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
          ...
          "bProcessing": true,
          "bServerSide": true,
          "sAjaxSource": "mailbox_kategori_json/json",			  
        ...
        $("#btnCari").on("click", function () {
        	tempJsonParsing= "";
			  ...
			  oTable.fnReloadAjax("mailbox_kategori_json/json?"+tempJsonParsing);
			});

        $('#btnAdd').on('click', function () {
        	window.parent.openPopup("app/loadUrl/app/konsultasi_kategori_add");
        ...
        $('#btnEdit').on('click', function () {
        	if(anSelectedData == "")
        		return false;				
        	window.parent.openPopup("app/loadUrl/app/konsultasi_kategori_add/?reqId="+anSelectedId);
        ...
        $('#btnDelete').on('click', function () {
        	...
        	$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
        		if (r){
        			$.getJSON("mailbox_kategori_json/delete/?reqId="+anSelectedId,
        				function(data){
        ...
        $('#btnLog').on('click', function () {
            window.parent.openPopup("app/loadUrl/app/informasi_data_log?reqjson=mailbox_kategori_json/log&reqjudul=Informasi Kategori Log");
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m12 l12">
                            ...
                            <h5 class="breadcrumbs-title">Konsultasi Kategori</h5>
                        </div>
                    </div>
                </div>
            </div>
