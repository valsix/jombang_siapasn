...
// echo $reqPenilaianSkpAtasanId;exit;
$reqPenilaianSkpAtasanNama = $set->getField('PEGAWAI_ATASAN_PEJABAT_NAMA');
// echo $reqPenilaianSkpAtasanNama;exit;
...
// if(empty($reqPenilaianSkpPenilaiId) && !empty($reqPenilaianSkpPenilaiNama))
// untuk kalau kosong maka checklist otomatis tercentang
$reqPejabatPenilaiIsManual= "1";
if
(
	// bila nid kosong dan nama kosong
	(empty($reqPenilaianSkpPenilaiId) && empty($reqPenilaianSkpPenilaiNama))
	// bila nid tidak kosong dan nama kosong
	||
	(!empty($reqPenilaianSkpPenilaiId) && empty($reqPenilaianSkpPenilaiNama))
  ||
  (!empty($reqPenilaianSkpPenilaiId) && !empty($reqPenilaianSkpPenilaiNama))
...
{
	$reqPejabatPenilaiIsManual= "";
}


// if(empty($reqPenilaianSkpPenilaiId2) && !empty($reqPenilaianSkpPenilaiNama2))
// untuk kalau kosong maka checklist otomatis tercentang
$reqPejabatPenilaiIsManual2= "1";
if
(
	// bila nid kosong dan nama kosong
	(empty($reqPenilaianSkpPenilaiId2) && empty($reqPenilaianSkpPenilaiNama2))
	// bila nid tidak kosong dan nama kosong
	||
	(!empty($reqPenilaianSkpPenilaiId2) && empty($reqPenilaianSkpPenilaiNama2))
  // bila nid tidak kosong dan nama tidak kosong
  ||
	(!empty($reqPenilaianSkpPenilaiId2) && !empty($reqPenilaianSkpPenilaiNama2))
)
{
	$reqPejabatPenilaiIsManual2= "";
}

// if(empty($reqPenilaianSkpAtasanId) && !empty($reqPenilaianSkpAtasanNama))
// untuk kalau kosong maka checklist otomatis tercentang
$reqAtasanPejabatPenilaiIsManual= "1";
if
(
	// bila nid kosong dan nama kosong
	(empty($reqPenilaianSkpAtasanId) && empty($reqPenilaianSkpAtasanNama))
	// bila nid tidak kosong dan nama kosong
	||
	(!empty($reqPenilaianSkpAtasanId) && empty($reqPenilaianSkpAtasanNama))
  // bila nid tidak kosong dan nama tidakkosong
	||
	(!empty($reqPenilaianSkpAtasanId) && !empty($reqPenilaianSkpAtasanNama))
)
{
	$reqAtasanPejabatPenilaiIsManual= "";
}


// if(empty($reqPenilaianSkpAtasanId2) && !empty($reqPenilaianSkpAtasanNama2))
// untuk kalau kosong maka checklist otomatis tercentang
$reqAtasanPejabatPenilaiIsManual2= "1";
if
(
	// bila nid kosong dan nama kosong
	(empty($reqPenilaianSkpAtasanId2) && empty($reqPenilaianSkpAtasanNama2))
	// bila nid tidak kosong dan nama kosong
	||
	(!empty($reqPenilaianSkpAtasanId2) && empty($reqPenilaianSkpAtasanNama2))
	// bila nid tidak kosong dan nama tidak kosong
	...
	(!empty($reqPenilaianSkpAtasanId2) && !empty($reqPenilaianSkpAtasanNama2)))
{
	$reqAtasanPejabatPenilaiIsManual2= "";
}
...
-->
              ...
              <div class="row">
                ...
                <div class="input-field col s12 m6">
                  ...
                  *centang jika Pejabat Penilai Non-PNSx
                  <?echo $reqPejabatPenilaiIsManual2;?>
                </div>
              </div>
