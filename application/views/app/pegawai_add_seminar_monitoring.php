 ...
 <style type="text/css">
  ...
  (min-device-width: 768px) and (max-device-width: 1024px)  {
    table.tabel-responsif thead th{ display:none; }
      ...
      */
      <?
      $arrData= array("Nama", "Tempat", "Penyelenggara", "Tgl Mulai", "Tgl Selesai", "No Piagam", "Tgl Piagam", "Status", "Aksi");
  ...
  <script type="text/javascript">
    function hapusdata(id, statusaktif, pegawai_id)
    {
      ...
      $.messager.confirm('Konfirmasi', infoMode+" ?",function(r){
       if (r){
        var s_url= "seminar_json/delete/?reqMode="+reqmode+"&reqId="+id;
        ...
        $.ajax({'url': s_url,'success': function(msg){
          if(msg == ''){}
            else
            {
              ...
              document.location.href= "app/loadUrl/app/pegawai_add_seminar_monitoring/?reqId="+pegawai_id;
            }
          }});
      }
    });  
  ...
  <div class="row">
    <div class="col s12 m10 offset-m1 ">
      ...
      <ul class="collection card">
        <li class="collection-item ubah-color-warna">RIWAYAT SEMINAR</li>
        <li class="collection-item">
          <div class="row">
            ...
            {
            ?>
            <a style="cursor:pointer" onClick="parent.setload('pegawai_add_seminar_data?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>')"> <i class="mdi-content-add-circle-outline"> <span class=" material-font">Tambah</span></i></a>
            <?
            }
            ?>
          </div>
            ...
            <tbody>
              ...
              while($set->nextRow())
              {
                ...
                <tr>
                  ...
                  <td><?=$set->getField('NO_PIAGAM')?></td>
                  <td><?=dateToPageCheck($set->getField('TANGGAL_PIAGAM'))?></td>
                  <td>
                    <?
                  ...
                  <td width="90px">
                    ...
                    <span>
                        <a href="javascript:void(0)" class="round waves-effect waves-light purple white-text" title="Log"  onclick="parent.openModal('app/loadUrl/app/informasi_data_log?reqjson=seminar_json/log/<?=$reqRowId?>&reqjudul=Data Seminar Log')">
                        <i class="mdi-action-query-builder"></i>
                      </a>
                    </span>
                    <span>
                      <?if($set->getField('STATUS')!=1):?>
                      <a href="javascript:void(0)" class="round waves-effect waves-light blue white-text" title="Ubah" onClick="parent.setload('pegawai_add_seminar_data?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>')">
