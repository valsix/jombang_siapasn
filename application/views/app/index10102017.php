        ...
        <li class="treeview">
            <!-- MENU KIRI -->
                ...
                function getMenuByParent($id_induk, $arrMenu)
                {
                    ...
                    {
                ?>
                <?php /*?><div class="list-group collapse" id="<?=$id_induk?>" style="border:1px solid cyan;"><?php */?>
                <ul class="treeview-menu">
                <?
                ...
                ?>
                        <?php /*?><a href="app/loadUrl/app/<?=$tempLinkFile?>?reqStatus=1" target="mainFrame" class="list-group-item"><?=$tempNama?></a><?php */?>
                        <li><a href="app/loadUrl/app/<?=$tempLinkFile?>?reqStatus=1" target="mainFrame"><i class="fa fa-circle-o"></i> <?=$tempNama?></a></li>
                <?
                        }
                    }
                ?>
                ...
                else
                {
                    for($index_detil=0; $index_detil < count($arrayKey); $index_detil++)
                    {
                        ...
                        {
                ?>
                    <?php /*?><a href="#<?=$tempMenuId?>" class="list-group-item" data-toggle="collapse"><?=$tempNama?></a><?php */?>
