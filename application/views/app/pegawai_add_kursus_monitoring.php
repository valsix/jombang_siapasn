  ...
  <script type="text/javascript">
    function hapusdata(id, statusaktif, pegawai_id)
    {
      ...
      $.messager.confirm('Konfirmasi', infoMode+" ?",function(r){
       if (r){
        var s_url= "kursus_json/delete/?reqMode="+reqmode+"&reqId="+id;
        ...
        $.ajax({'url': s_url,'success': function(msg){
          if(msg == ''){}
            else
            {
              ...
              document.location.href= "app/loadUrl/app/pegawai_add_kursus_monitoring/?reqId="+pegawai_id;
            }
          }});
      }
    });  
  ...
  <div class="row">
    <div class="col s12 m10 offset-m1 ">
      ...
      <ul class="collection card">
        <li class="collection-item ubah-color-warna">RIWAYAT KURSUS</li>
        <li class="collection-item">
          <div class="row">
            <a style="cursor:pointer" onClick="parent.setload('pegawai_add_kursus_data?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>')"> <i class="mdi-content-add-circle-outline"> <span class=" material-font">Tambah</span></i></a>
          </div>
              ...
              while($set->nextRow())
              {
                ...
                <tr>
                  ...
                  <td width="90px">
                    ...
                    <span>
                        <a href="javascript:void(0)" class="round waves-effect waves-light purple white-text" title="Log"  onclick="parent.openModal('app/loadUrl/app/informasi_data_log?reqjson=kursus_json/log/<?=$reqRowId?>&reqjudul=Data Kursus Log')">
                        <i class="mdi-action-query-builder"></i>
                      </a>
                    </span>
                    <span>
                      <?if($set->getField('STATUS')!=1):?>
                      <a href="javascript:void(0)" class="round waves-effect waves-light blue white-text" title="Ubah" onClick="parent.setload('pegawai_add_kursus_data?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>')">
