...
header("Content-Disposition: attachment; filename=\"idpresensi_".$reqSatuanKerjaId."_".$tempPeriode.".xls\"");
...
$judulfield= array("No.", "ID Presensi", "NIP Baru", "Nama", "ID Unit Kerja", "Nama Unit Kerja", "Nama Area Unit Kerja", "Status Area Unit Kerja", "ID Atas", "Nama Unit Kerja Atas", "Nama Area Atas", "SQL Insert");

$field= "";

$field= array("NO", "ID_PRESENSI", "NIP_BARU", "NAMA", "id_Area_Unit_Kerja", "nama_Unit_Kerja", "nama_Area_Unit_Kerja", "status_mesin", "id_Area_Atas", "nama_Atas", "nama_Area_Atas", "SQL");
...
$set->selectByParamsCetakIdpresensi(array(), -1, -1, $statement.$searchJson, $sOrder);
// echo $set->query;exit;
?>
<!DOCTYPE html>
<html lang="en">
...
<table style="width:100%">
        ...
        <tr>
            <td colspan="<?=count($judulfield)-1?>" style="font-size:13px;font-weight:bold; text-align: center;">ID PRESENSI DAN DATA AREA PRESENSI ASN</td>	
        </tr>
        <tr>
            ...
            <tbody>
				...
				?>
                	...
                	for($i=0; $i<count($field); $i++)
					{
						...
						{
							$tempValue= "'".$set->getField("NIP_BARU");
						}
						elseif($field[$i] == "SQL")
						{

			//$field= array("NO", "ID_PRESENSI", "NIP_BARU", "NAMA", "id_Area_Unit_Kerja", "nama_Unit_Kerja", "nama_Area_Unit_Kerja", "status_mesin", "id_Area_Atas", "nama_Atas", "nama_Area_Atas", "SQL");
							$tempValue0= "insert into sync_employee (id, flag, emp_code, first_name, dept_code, dept_name, area_code, area_name, multi_area, active_status)";
							$tempValue1= " values(".$set->getField("ID_PRESENSI").", 0, '".$set->getField("ID_PRESENSI")."', '".$set->getField("NAMA")."', '1', 'Pemerintah Kabupaten Jombang', '".$set->getField("ID_AREA_ATAS")."', '".$set->getField("NAMA_AREA_ATAS")."', false, true);";
							$tempValue= $tempValue0.$tempValue1;
						}
						else {
