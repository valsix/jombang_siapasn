...
$judulfield= array("No", "NIP Baru", "Nama", "Hasil Cek", "Nama Satuan Kerja", "Nama Satuan Kerja Induk", "Keterangan Permasalahan");
...
sOrder = " ORDER BY NAMA_SATUAN_KERJA ASC, NAMA ASC, HASIL_CEK ASC";
$set= new Pegawai();
// $allRecord= $set->getCountByParamsCetakPegawai(array(), $statement.$searchJson);
$set->selectByParamsCetakCekDataRekon(array(), -1, -1, $statement.$searchJson, $sOrder);
// echo $set->query;exit;
?>
<!DOCTYPE html>
<html lang="en">
...
<table style="width:100%">
        ...
        <tr>
            <td colspan="<?=count($judulfield)-1?>" style="font-size:13px;font-weight:bold; text-align: center;">CEK REKON DATA ASN</td>	
        </tr>
        <tr>
    	...
    	<table style="width:100%" border="1" cellspacing="0" cellpadding="0">
            ...
            <tbody>
				...
				?>
                	...
                	// if($set->getField("HASIL_CEK"="Bermasalah")){
                	// 	$hasil_cek_bermasalah=1;
                	// }
