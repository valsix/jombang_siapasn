...
<script type="text/javascript" charset="utf-8">
  ...
  $(document).ready( function () {
   ...
   $('#btnAdd').on('click', function () {
       window.parent.openPopup("app/loadUrl/app/rekom_instansi_pembina_add");
   ...
   $('#btnEdit').on('click', function () {
       if(anSelectedData == "")
          return false;				
      window.parent.openPopup("app/loadUrl/app/rekom_instansi_pembina_add/?reqId="+anSelectedId);
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                ...
                                <h5 class="breadcrumbs-title">Rekom Instansi Pembina</h5>
                            </div>
                        </div>
                    </div>
                </div>
