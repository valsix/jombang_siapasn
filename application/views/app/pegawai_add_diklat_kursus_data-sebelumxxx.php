...
$tipekursus->selecttipekursus(array());
            ...
            <form id="ff" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="input-field col s12 m2">
                  ...
                  <input placeholder="" type="text" name="reqNoSertifikat" <?=$read?> value="<?=$reqNoSertifikat?>" id="reqNoSertifikat" />
                </div>
                <div class="input-field col s12 m2">
                  <label for="reqTglSertifikat">Tgl Sertifikat / Piagam</label>
                  <input placeholder="" class="easyui-validatebox" data-options="validType:'dateValidPicker'" type="text" name="reqTglSertifikat" id="reqTglSertifikat"  value="<?=$reqTglSertifikat?>" maxlength="10" onKeyDown="return format_date(event,'reqTglSertifikat');"/>
                </div>
                <div class="input-field col s12 m2">
                ...
                <div class="input-field col s12 m2">
                  ...
                  <input placeholder="" type="text" name="reqJumlahJam" id="reqJumlahJam" <?=$read?> value="<?=$reqJumlahJam?>" />
                </div>
                 <div class="input-field col s12 m2">
