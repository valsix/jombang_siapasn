...
$arrkolomdata= array(
    array("info"=>"NIP BARU<br/>NIP LAMA", "width"=>"")
    , array("info"=>"NAMA", "width"=>"")
    , array("info"=>"KINERJA<br/>KOMPETENSI", "width"=>"")
    , array("info"=>"CATATAN", "width"=>"")
    , array("info"=>"KESIMPULAN", "width"=>"")
);
...
<script type="text/javascript" charset="utf-8">
  ...
  $(document).ready(function(){
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
          ...
          "bProcessing": true,
          "bServerSide": true,
          "sAjaxSource": "jkinerja/penilaian_json/json/?reqKuadran=<?=$reqKuadran?>&reqTahun=<?=$reqTahun?>",
        ...
        $("#btnCari").on("click", function () {
            oTable.fnReloadAjax("jkinerja/penilaian_json/json/?reqKuadran=<?=$reqKuadran?>&reqTahun=<?=$reqTahun?>");
        });
  ...
  <div id="main">
    ...
    <div class="wrapper">
        ...
        <section id="content-full">
            ...
            <div id="bluemenu" class="bluetabs" style="background-color: inherit !important;">
                <ul>
                    <li>
