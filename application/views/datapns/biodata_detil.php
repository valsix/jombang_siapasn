...
// 1, 411, 359 admin
//376 kepalabkdpp, 338 kabidmutasi, 344 pipit, 390 kasubidmutasi, 518 mas ilham

if($tempUserLoginId == "1" || $tempUserLoginId == "411" || $tempUserLoginId == "359" || $tempUserLoginId == "376" || $tempUserLoginId == "338" || $tempUserLoginId == "337" || $tempUserLoginId == "344" || $tempUserLoginId == "390" || $tempUserLoginId == "518" ){}
else
{
  redirect('app/index');
  exit;
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <span class="text-white"><?=$infopegawainama?></span>
        </div>
            ...
            <div class="table-responsive">
              ...
              <thead>
                ...
                $arrdata= array(
                    ...
                    , array("field"=>"NAMA", "align"=>"", "format"=>"")
                    , array("field"=>"STATUS_PENDIDIKAN_NAMA", "align"=>"", "format"=>"")
          ...
          <div class="col-md-12">
            ...
            <div class="table-responsive">
              ...
              <thead>
                ...
                $arrdata= array(
                    array("field"=>"NAMA", "align"=>"", "format"=>"")
                    , array("field"=>"TEMPAT_LAHIR", "align"=>"center", "format"=>"")
