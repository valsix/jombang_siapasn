...
***************************************************************************************************** */
  ...
  ***/
  ...
  class MailboxKategori extends Entity{ 
    ...
    **/
	...
	function insert()
	{
		...
		$this->setField("MAILBOX_KATEGORI_ID", $this->getNextId("MAILBOX_KATEGORI_ID","MAILBOX_KATEGORI")); 

		$str = "
			INSERT INTO MAILBOX_KATEGORI (
				MAILBOX_KATEGORI_ID, NAMA, JENIS_PELAYANAN_ID, SATUAN_KERJA_ID, LAST_USER, LAST_DATE, USER_LOGIN_ID, USER_LOGIN_PEGAWAI_ID
			) 
			VALUES (
		...
		"; 	
		$this->id = $this->getField("MAILBOX_KATEGORI_ID");
		$this->query = $str;
    ...
    function update()
	{
		/*Auto-generate primary key(s) by next max value (integer) */
		$str = "		
				UPDATE MAILBOX_KATEGORI
				SET    
				   NAMA= '".$this->getField("NAMA")."',
				   JENIS_PELAYANAN_ID= ".$this->getField("JENIS_PELAYANAN_ID").",
				   SATUAN_KERJA_ID= ".$this->getField("SATUAN_KERJA_ID").",
				   LAST_USER= '".$this->getField("LAST_USER")."',
				   USER_LOGIN_ID= '".$this->getField("USER_LOGIN_ID")."',
				   USER_LOGIN_PEGAWAI_ID= ".$this->getField("USER_LOGIN_PEGAWAI_ID").",
				   LAST_DATE= ".$this->getField("LAST_DATE")."
				WHERE MAILBOX_KATEGORI_ID= ".$this->getField("MAILBOX_KATEGORI_ID")."
				"; 
		$this->query = $str;
		// echo $str;exit;
		return $this->execQuery($str);
    ...
    **/ 
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement='',$order=' ORDER BY A.MAILBOX_KATEGORI_ID ASC')
	{
		$str = "
				SELECT A.MAILBOX_KATEGORI_ID, A.NAMA, CASE A.STATUS WHEN '1' THEN 'Tidak Aktif' ELSE 'AKtif' END STATUS_NAMA
				, A.JENIS_PELAYANAN_ID, A.SATUAN_KERJA_ID
