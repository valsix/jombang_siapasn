  ...
  class Mertua extends Entity{ 
    ...
    **/
    ...
    function updatevalidasihapusdata()
	{
        ...
        AND HAPUS_NAMA= 'MERTUA' AND VALIDASI IS NULL
        ";
    ...
    function selectByPersonal($paramsArray=array(),$limit=-1,$from=-1, $pegawaiid, $rowid="", $statement='', $order='ORDER BY A.MERTUA_ID ASC')
	{
		$str = "
		SELECT A.MERTUA_ID, A.PEGAWAI_ID, A.JENIS_KELAMIN, A.NAMA, A.TEMPAT_LAHIR, A.TANGGAL_LAHIR, A.PEKERJAAN, A.ALAMAT, A.KODEPOS, A.TELEPON
