  ...
  class Tambahanmasakerja extends Entity{ 
    ...
    **/
    ...
    function updatevalidasihapusdata()
	{
        ...
        AND HAPUS_NAMA= 'TAMBAHAN_MASA_KERJA' AND VALIDASI IS NULL
        ";
    ...
    function selectByPersonal($paramsArray=array(),$limit=-1,$from=-1, $pegawaiid, $id="", $rowid="", $statement='', $order='ORDER BY A.TANGGAL_SK ASC')
	{
		...
		SELECT
			TAMBAHAN_MASA_KERJA_ID, PEGAWAI_ID, NO_SK, TANGGAL_SK, TMT_SK, TAHUN_TAMBAHAN, 
			BULAN_TAMBAHAN, TAHUN_BARU, BULAN_BARU,NO_NOTA,TANGGAL_NOTA,PANGKAT_ID,GAJI_POKOK,A.PEJABAT_PENETAP_ID
			, B.NAMA PEJABAT_PENETAP, TEMP_VALIDASI_ID, TEMP_VALIDASI_HAPUS_ID, VALIDASI, VALIDATOR, PERUBAHAN_DATA, TIPE_PERUBAHAN_DATA, TANGGAL_VALIDASI
