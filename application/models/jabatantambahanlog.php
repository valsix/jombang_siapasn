...
***************************************************************************************************** */
  ...
  ***/
  ...
  class JabatanTambahanLog extends Entity{ 
    ...
    **/ 
	...
	{
		$str = "
				SELECT A.JABATAN_TAMBAHAN_ID, PEGAWAI_ID, A.INFO_LOG, A.LAST_USER, A.LAST_DATE, 
				CASE A.STATUS WHEN '1' THEN 'Insert' WHEN '2' THEN 'Update' WHEN '3' THEN 'Delete' ELSE 'Activate' END STATUS_NAMA
				FROM JABATAN_TAMBAHAN_LOG A
				WHERE 1 = 1
		"; 
