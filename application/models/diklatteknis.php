	...
	function insert()
	{
		...
		$str = "
			INSERT INTO DIKLAT_TEKNIS (
				DIKLAT_TEKNIS_ID, PEGAWAI_ID, TEMPAT, PENYELENGGARA, ANGKATAN, TAHUN, TANGGAL_MULAI, TANGGAL_SELESAI, NO_STTPP,	TANGGAL_STTPP, JUMLAH_JAM, NAMA, LAST_USER, LAST_DATE, LAST_LEVEL, USER_LOGIN_ID, USER_LOGIN_PEGAWAI_ID
			) 
			VALUES (
