  ...
  class CutiUsulan extends Entity{ 
    ...
    **/
	...
	function insert()
	{
		...
		(
            CUTI_USULAN_ID, PEGAWAI_ID, JENIS_CUTI_ID, JABATAN_RIWAYAT_ID, PANGKAT_RIWAYAT_ID
    ...
    function selectmonitoring($paramsArray=array(),$limit=-1,$from=-1, $statement='',$order=' ORDER BY A.CUTI_USULAN_ID ASC')
	{
		...
		SELECT
			...
			, CASE WHEN A.STATUS_TMS = 1 THEN LG.INFO_PROSES ELSE MN.NAMA END POSISI_MENU_INFO
			, LG.INFO_PROSES
			, A.*
		FROM cuti_usulan A
