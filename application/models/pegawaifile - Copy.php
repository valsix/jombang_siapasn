  ...
  ***/
  ...
  class PegawaiFile extends Entity{ 
		...
		$this->setField("PEGAWAI_FILE_ID", $this->getNextId("PEGAWAI_FILE_ID","PEGAWAI_FILE")); 
     	...
     	$str = "
			INSERT INTO PEGAWAI_FILE (
				PEGAWAI_FILE_ID, PEGAWAI_ID, RIWAYAT_TABLE, RIWAYAT_FIELD, RIWAYAT_ID, FILE_KUALITAS_ID, KATEGORI_FILE_ID, PATH, KETERANGAN
    ...
    **/ 
	...
	function selectByParamsJenisDokumen($paramsArray=array(),$limit=-1,$from=-1, $statement='',$order=' ORDER BY A.PEGAWAI_ID ASC, NO_URUT, RIWAYAT_ID')
	{
		$str = "
    ...
    function selectByParamsFile($paramsArray=array(),$limit=-1,$from=-1, $statement='', $pegawaiid="", $order=' ORDER BY A.PEGAWAI_FILE_ID ASC')
	{
		$str = "
				SELECT A.PEGAWAI_FILE_ID, A.PEGAWAI_ID, A.RIWAYAT_TABLE, A.RIWAYAT_FIELD, A.RIWAYAT_ID, A.FILE_KUALITAS_ID, B.NAMA FILE_KUALITAS_NAMA, A.PATH, 
				A.STATUS_VERIFIKASI, A.KETERANGAN, A.STATUS,
