  ...
  class Hukuman extends Entity{ 
    ...
    **/ 
    ...
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement='',$order=' ORDER BY A.HUKUMAN_ID ASC')
	{
		$str = "
		SELECT
		B.NAMA TINGKAT_HUKUMAN_NAMA, C.NAMA JENIS_HUKUMAN_NAMA, B.NAMA TINGKAT_HUKUMAN_NAMA
		, C.NAMA JENIS_HUKUMAN_NAMA, D.NAMA PEJABAT_PENETAP_NAMA
		, B1.PERATURAN_ID, B1.NAMA PERATURAN_NAMA
		,
		...
		LEFT JOIN PERATURAN B1 ON B.PERATURAN_ID = B1.PERATURAN_ID
		...
		LEFT JOIN PEGAWAI E ON E.PEGAWAI_ID = A.PEGAWAI_ID
		WHERE 1 = 1
		"; 
