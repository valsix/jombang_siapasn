...
***************************************************************************************************** */
  ...
  ***/
  ...
  class PendidikanJurusanLog extends Entity{ 
    ...
    **/ 
	...
	{
		$str = "
				SELECT A.PENDIDIKAN_JURUSAN_ID, A.INFO_LOG, A.LAST_USER, A.LAST_DATE, 
				CASE A.STATUS WHEN '1' THEN 'Insert' WHEN '2' THEN 'Update' ELSE 'Delete' END STATUS_NAMA
				FROM PENDIDIKAN_JURUSAN_LOG A
				WHERE 1 = 1
		"; 
