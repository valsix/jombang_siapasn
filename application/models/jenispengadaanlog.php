...
***************************************************************************************************** */
  ...
  ***/
  ...
  class JenisPengadaanLog extends Entity{ 
    ...
    **/
    ...
    {
    	$str = "
    	SELECT A.JENIS_PENGADAAN_ID, A.INFO_LOG, A.LAST_USER, A.LAST_DATE, 
    	CASE A.STATUS WHEN '1' THEN 'Insert' WHEN '2' THEN 'Update' ELSE 'Delete' END STATUS_NAMA
    	FROM JENIS_PENGADAAN_LOG A
    	WHERE 1 = 1
    	"; 
