...
var flexdropdownmenu={
	arrowpath: 'lib/Flex-Level-Drop-Down-Menu-V2/arrow.gif', //full URL or path to right arrow image
	backarrowpath: 'lib/Flex-Level-Drop-Down-Menu-V2/left.gif', //full URL or path to back arrow image
	...
	hidemenuevent: navigator.userAgent.match(/(iPad)|(iPhone)|(iPod)/i)? 'click' : 'click', // Mac doesn't seem to support click on body
