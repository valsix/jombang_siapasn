...
fnStateSave:function(e,i){this.oApi._fnCreateCookie(e.sCookiePrefix+e.sInstance,this.oApi._fnJsonString(i),e.iCookieDuration,e.sCookiePrefix,e.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Awal",sLast:"Akhir",sNext:"Selanjutnya",sPrevious:"Sebelumnya"},sEmptyTable:"Data tidak ditemukan",
sInfo:"<span style='font-size:14px'>Menampilkan _START_ sampai _END_ dari _TOTAL_ data</span>",sInfoEmpty:"<span style='font-size:14px'>Menampilkan 0 sampai 0 dari 0 data</span>",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"<span style='font-size:12px'>Menampilkan _MENU_ data</span>",sLoadingRecords:"Loading...",sProcessing:"Sedang memproses...",sSearch:"<span style='font-size:12px'>Pencarian:</span>",sUrl:"",sZeroRecords:"No matching records found"},oSearch:i.extend({},j.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",
